                ...
                <div class="col-md-12 my-3">
                    <div class="card">
                        ...
                        <div class="card-content p-2">
                            <form name="frm" method="post" class="table-responsive" action="/store_psycho"
                                role="form">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="21%"><input name="checkbox" type="checkbox" disabled=""
                                ...
                                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="responsibility1" type="radio"
                                            ...
                                            <td align="middle">
                                                <input name="responsibility1" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_1" value="4" checked>
                                            </td>
                                            <td align="middle">
                                                <input name="responsibility1" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="responsibility2" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="responsibility3" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="responsibility4" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="responsibility5" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                ...
                                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="stability1" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="stability2" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="stability3" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="stability4" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="stability5" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                ...
                                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="objectivity1" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="objectivity2" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="objectivity3" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                ...
                                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="motivation1" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="motivation2" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="motivation3" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                ...
                                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="adjustment1" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="adjustment2" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="adjustment3" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="middle">
                                                <input name="adjustment4" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="remarks_status_0" value="1">
                                            </td>
                                            <td align="middle">
                                ...
                                <table width="80%" border="0" align="center" cellpadding="0"
                                    cellspacing="1" class="table table-bordered">
                                    <tbody>
                                        <tr>
