                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="246" align="left">
                                                <input name="medication" type="text" id="medication" value=""
                                                    size="30" class="form-control">
                                            </td>
                                            <td width="119" align="left"><b>Indication:</b></td>
                                            <td width="321" align="left">
                                                <input name="indication" type="text" id="indication" value=""
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="exercise_speed" type="text" id="exercise_speed"
                                                    value="" size="5" class="form-control">
                                            </td>
                                            ...
                                            <td width="7%" align="center">
                                                <input name="exercise_hr" type="text" id="exercise_hr" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="exercise_bp" type="text" id="exercise_bp" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="exercise_bp" type="text" id="exercise_bp" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%" align="center">
                                                <input name="stage1_mets" type="text" id="stage1_mets" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage1_hr" type="text" id="stage1_hr" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage1_bp" type="text" id="stage1_bp" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage1_bp" type="text" id="stage1_bp" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%" align="center">
                                                <input name="stage2_mets" type="text" id="stage2_mets" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage2_hr" type="text" id="stage2_hr" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage2_bp" type="text" id="stage2_bp" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage2_bp" type="text" id="stage2_bp" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%" align="center">
                                                <input name="stage3_mets" type="text" id="stage3_mets" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage3_hr" type="text" id="stage3_hr" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage3_bp" type="text" id="stage3_bp" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage3_bp" type="text" id="stage3_bp" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%" align="center">
                                                <input name="stage4_mets" type="text" id="stage4_mets" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage4_mets" type="text" id="stage4_mets" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%" align="center">
                                                <input name="stage5_mets" type="text" id="stage5_mets" value=""
                                                    size="5" l="" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage5_mets" type="text" id="stage5_mets" value=""
                                                    size="5" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%" align="center">
                                                <input name="stage6_mets" type="text" id="stage6_mets" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage6_mets" type="text" id="stage6_mets" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%" align="center">
                                                <input name="stage7_mets" type="text" id="stage7_mets" value=""
                                                    size="5" class="form-control">
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage7_mets" type="text" id="stage7_mets" value=""
                                ...
                                <table width="105%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                <textarea name="resting_ecg" cols="50" rows="2" maxlength="" class="form-control" id="resting_ecg">                          </textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="27" colspan="6">
                                                ...
                                                <input class="my-50" name="exercise_type" type="text"
                                                    id="exercise_type" value="" size="15">
                                                Patient <br> reached
