                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_stresstest_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                        ...
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="exercise_speed" type="text" id="exercise_speed"
                                                    value="{{ $exam->exercise_speed }}" size="5"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="exercise_grade" type="text" id="exercise_grade"
                                                    value="{{ $exam->exercise_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="exercise_mets" type="text" id="exercise_mets"
                                                    value="{{ $exam->exercise_mets }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="7%" align="center">
                                            ...
                                            <td width="15%" align="center">
                                                <input name="exercise_remarks" type="text" id="exercise_remarks"
                                                    value="{{ $exam->exercise_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="stage1_speed" type="text" id="stage1_speed"
                                                    value="{{ $exam->stage1_speed }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="10%" align="center">
                                                <input name="stage1_speed" type="text" id="stage1_speed"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="stage1_grade" type="text" id="stage1_grade"
                                                    value="{{ $exam->stage1_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            ...
                                            <td width="15%" align="center">
                                                <input name="stage1_remarks" type="text" id="stage1_remarks"
                                                    value="{{ $exam->stage1_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="stage2_speed" type="text" id="stage2_speed"
                                                    value="{{ $exam->stage2_speed }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="10%" align="center">
                                                <input name="stage2_speed" type="text" id="stage2_speed"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="stage2_grade" type="text" id="stage2_grade"
                                                    value="{{ $exam->stage2_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="9%" align="center">
                                            ...
                                            <td width="15%" align="center">
                                                <input name="stage2_remarks" type="text" id="stage2_remarks"
                                                    value="{{ $exam->stage2_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="stage3_speed" type="text" id="stage3_speed"
                                                    value="{{ $exam->stage3_speed }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="10%" align="center">
                                                <input name="stage3_speed" type="text" id="stage3_speed"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="stage3_grade" type="text" id="stage3_grade"
                                                    value="{{ $exam->stage3_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="9%" align="center">
                                            ...
                                            <td width="15%" align="center">
                                                <input name="stage3_remarks" type="text" id="stage3_remarks"
                                                    value="{{ $exam->stage3_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="stage4_speed" type="text" id="stage4_speed"
                                                    value="{{ $exam->stage4_speed }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="10%" align="center">
                                                <input name="stage4_speed" type="text" id="stage4_speed"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="stage4_grade" type="text" id="stage4_grade"
                                                    value="{{ $exam->stage4_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="9%" align="center">
                                            ...
                                            <td width="15%" align="center">
                                                <input name="stage4_remarks" type="text" id="stage4_remarks"
                                                    value="{{ $exam->stage4_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="stage5_speed" type="text" id="stage5_speed"
                                                    value="{{ $exam->stage5_speed }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="10%" align="center">
                                                <input name="stage5_speed" type="text" id="stage5_speed"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="stage5_grade" type="text" id="stage5_grade"
                                                    value="{{ $exam->stage5_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="9%" align="center">
                                                <input name="stage5_mets" type="text" id="stage5_mets"
                                                    value="{{ $exam->stage5_mets }}" size="5" l
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="7%" align="center">
                                                <input name="stage5_mets" type="text" id="stage5_mets"
                                            ...
                                            <td width="15%" align="center">
                                                <input name="stage5_remarks" type="text" id="stage5_remarks"
                                                    value="{{ $exam->stage5_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="stage6_speed" type="text" id="stage6_speed"
                                                    value="{{ $exam->stage6_speed }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="10%" align="center">
                                                <input name="stage6_speed" type="text" id="stage6_speed"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="stage6_grade" type="text" id="stage6_grade"
                                                    value="{{ $exam->stage6_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="9%" align="center">
                                            ...
                                            <td width="15%" align="center">
                                                <input name="stage6_remarks" type="text" id="stage6_remarks"
                                                    value="{{ $exam->stage6_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="8%" align="center">
                                                <input name="stage7_speed" type="text" id="stage7_speed"
                                                    value="{{ $exam->stage7_speed }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="10%" align="center">
                                                <input name="stage7_speed" type="text" id="stage7_speed"
                                            ...
                                            <td width="7%" align="center">
                                                <input name="stage7_grade" type="text" id="stage7_grade"
                                                    value="{{ $exam->stage7_grade }}" size="5"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                            <td width="9%" align="center">
                                            ...
                                            <td width="15%" align="center">
                                                <input name="stage7_remarks" type="text" id="stage7_remarks"
                                                    value="{{ $exam->stage7_remarks }}" size="10"
                                                    class="form-control" style="padding: .4rem;" />
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table width="105%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                <textarea name="resting_ecg" cols="50" rows="2" maxlength="" class="form-control"
                                                    style="padding: .4rem;" id="resting_ecg">{{ $exam->resting_ecg }}
                                      </textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="27" colspan="6">
                                                ...
                                                <input class="my-50" name="exercise_type" type="text"
                                                    id="exercise_type" value="{{ $exam->exercise_type }}"
                                                    size="15" />
                                                Patient <br> reached
                                                ...
                                                sec(s) of stage
                                                <input class="my-50" name="stage" type="text" id="stage"
                                                    value="{{ $exam->stage }}" size="2" />
                                                equivalent to
                                                <input class="my-50" name="mets" type="text" id="mets"
                                                    value="{{ $exam->mets }}" size="3" />
                                                mets. Baseline <br> heart rate was
                                                <input class="my-50" name="heart_rate" type="text"
                                                    id="heart_rate" value="{{ $exam->heart_rate }}"
                                                    size="3" />
                                                BPM and the patient attained a maximum heart rate of
                                                <input class="my-50" name="max_heartrate" type="text"
                                                    id="max_heartrate" value="{{ $exam->max_heartrate }}"
                                                    size="3" />
                                                bpm which was
                                                <input class="my-50" name="bpm_equiv" type="text" id="bpm_equiv"
                                                    value="{{ $exam->bpm_equiv }}" size="1" />
                                                %
                                                of that predicted <br> for maximal heart rate for the patient's age.
                                                Starting BP
                                                was
                                                <input class="my-50" name="starting_bp" type="text"
                                                    id="starting_bp" value="{{ $exam->starting_bp }}"
                                                    size="5" />
                                                and maximum BP during exercise <br> was
                                                <input class="my-50" name="max_bp" type="text" id="max_bp"
                                                    value="{{ $exam->max_bp }}" size="5" />
                                                Double product is equal to
                                                <input class="my-50" name="double_prod" type="text"
                                                    id="double_prod" value="{{ $exam->double_prod }}"
                                                    size="5" />
                                                . ECG response to exercise showed
                                                <input class="my-50" name="ecg" type="text" id="ecg"
                                                    value="{{ $exam->ecg }}" size="5" />
