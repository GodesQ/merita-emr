                                ...
                                <table width="100%" border="0" cellspacing="2" cellpadding="2"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="88%">
                                                <input name="otoscopy" type="text" id="otoscopy" value=""
                                                    size="15" class="form-control" placeholder="Otoscopy">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Heart:</b></td>
                                            <td>
                                                <input name="heart" type="text" id="heart" value=""
                                                    size="15" class="form-control" placeholder="Heart">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Lung:</b></td>
                                            <td>
                                                <input name="lung" type="text" id="lung" value=""
                                                    size="15" class="form-control" placeholder="Lung">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><input type="radio" name="ecg" id="radio"
                                            ...
                                            <td colspan="4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="practioner_comment"
                                                        id="practioner_comment" value="" class="form-control" />
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
