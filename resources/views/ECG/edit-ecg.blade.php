                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_ecg_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                ...
                                <table width="100%" border="0" cellspacing="2" cellpadding="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Heart:</b></td>
                                            <td>
                                                <input name="heart" type="text" id="heart"
                                                    value="{{ $exam->heart }}" size="15" class="form-control my-1"
                                                    placeholder="Heart">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Lung:</b></td>
                                            <td>
                                                <input name="lung" type="text" id="lung"
                                                    value="{{ $exam->lung }}" size="15" class="form-control my-1"
                                                    placeholder="Lung">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="radio" name="ecg" id="radio" value="Normal"
                                                    @php echo
                                        ...
                                        <tr>
                                            <td>
                                                <input type="radio" name="ecg" id="radio" value="Not Required"
                                                    @php echo  $exam->ecg == 'Not Required' ? 'checked' : '' @endphp>
                                                Not Required
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="practioner_comment"
                                                        id="practioner_comment" value="{{ $exam->practioner_comment }}"
                                                        class="form-control" />
                                                </div>
                                            </td>
                                        </tr>
                                                                    ...
                                                                    <select required name="technician2_id"
                                                                        ...
                                                                        @foreach ($physicians as $physician)
                                                                            <option value={{ $physician->id }}
                                                                                {{ $physician->id == $exam->technician2_id ? 'selected' : null }}>
                                                                                {{ $physician->firstname }}
