                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_cardiovascular_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="patientcode" id="patientcode" type="text"
                                                    value="{{ $exam->patientcode }}" class="form-control my-1"
                                                    readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <table class="table table-responsive" width="100%" border="0" cellpadding="2"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td colspan="6">
                                                <textarea name="pasthistory" id="pasthistory" cols="50" rows="4" class="form-control my-1">{{ $exam->pasthistory }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="21%" align="left"><b>Medications/Maintenance</b></td>
                                            <td colspan="6">
                                                <textarea name="medmaint" id="medmaint" cols="50" rows="2" class="form-control my-1">{{ $exam->medmaint }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><b>Height (cm)</b></td>
                                            <td><input onkeyup="computeBMI();" name="height" type="text"
                                                    id="height"
                                                    value="{{ $exam_physical ? $exam_physical->height : null }}"
                                                    class="form-control"></td>
                                            <td><b>Weight
                                                    (kg) </b></td>
                                            <td><input name="weight" type="text" id="weight"
                                                    value="{{ $exam_physical ? $exam_physical->weight : null }}"
                                                    class="form-control" onkeyup="computeBMI();"></td>
                                            <td><b>BMI</b></td>
                                            <td><input name="bmi" readonly type="text" id="bmi"
                                                    value="{{ $exam_physical ? $exam_physical->bmi : null }}"
                                                    class="form-control"></td>
                                        </tr>
                                        <tr>
                                            <td><b>Resting BP</b></td>
                                            <td><input name="bp" type="text" id="bp"
                                                    value="{{ $exam->bp }}" size="15"
                                                    class="form-control my-1"></td>
                                            <td><b>Respiratory Rate</b></td>
                                            <td><input name="rhythm" type="text" id="rhythm"
                                                    value="{{ $exam->rhythm }}" size="15"
                                                    class="form-control my-1"></td>
                                            <td><b>Heart Rate</b></td>
                                            <td><input name="hr" type="text" id="hr"
                                                    value="{{ $exam->hr }}" class="form-control my-1"></td>
                                        </tr>
                                        <tr>
                                            <td><b>HEENT</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="6"><input name="egc" id="egc" type="text"
                                                    value="{{ $exam->egc }}" class="form-control my-1"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><b>TSE</b></td>
                                            <td colspan="6"><input name="tse" id="tse" type="text"
                                                    value="{{ $exam->tse }}" class="form-control my-1"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="6"><input name="crf" id="crf" type="text"
                                                    value="{{ $exam->crf }}" class="form-control my-1"></td>
                                        </tr>
                                        <tr>
                                            <td><b>Impression</b></td>
                                            <td colspan="6">
                                                <textarea name="impression" id="impression" cols="50" rows="3" class="form-control my-1">{{ $exam->impression }}</textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
