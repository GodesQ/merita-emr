                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td colspan="6">
                                                <textarea name="pasthistory" id="pasthistory" cols="50" rows="2" class="form-control"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="21%" align="left"><b>Medications/Maintenance</b></td>
                                            <td colspan="6">
                                                <textarea name="medmaint" id="medmaint" cols="50" rows="2" class="form-control"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="17%"><input name="bp" type="text" id="bp"
                                                    value="" size="15" class="form-control"></td>
                                            <td><b>Respiratory Rate</b></td>
                                            <td><input name="rhythm" type="text" id="rhythm" value=""
                                                    size="15" class="form-control"></td>
                                            <td><b>Heart Rate</b></td>
                                            <td><input name="hr" type="text" id="hr" value=""
                                                    class="form-control"></td>
                                        </tr>
                                        <tr>
                                            <td><b>HEENT</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="6">
                                                <textarea name="impression" id="impression" cols="50" rows="2" class="form-control"></textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
