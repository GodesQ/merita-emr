...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <link
            ...
            href="../../../app-assets/images/logo/MeritaApp.png"
        />
        <link
            rel="shortcut icon"
            type="image/x-icon"
                    ...
                    <section class="row flexbox-container">
                        ...
                        >
                            <div class="box-shadow-2 p-0 loginwrapper">
                                <div
                                    class="card border-grey border-lighten-3 px-1 py-1 m-0 loginbox"
                                >
                                    <div class="card-header border-0">
                                        <div class="card-title text-center">
                                            <img
                                                src="../../../app-assets/images/logo/MeritaEMR_logo2.png"
                                                class="img-fluid"
                                                alt="branding logo"
                                            />
                                        </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                >
                                                    ...
                                                    <input type="hidden" name="classification" value="agency">
                                                    <button
                                                        type="submit"
