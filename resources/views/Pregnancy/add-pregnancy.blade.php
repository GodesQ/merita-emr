                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input name="specimen_type" type="radio" class="m-1"
                                                    id="specimen_type_0" value="Urine">Urine<input name="specimen_type"
                                                    type="radio" class="m-1" id="specimen_type_1"
                                                    value="Serum">Serum<input name="specimen_type" type="radio"
                                                    class="m-1" id="specimen_type_2" value="">Reset</td>
                                        </tr>
                                        <tr>
                                            <td width="18%" align="left"><b>RESULT</b></td>
                                            <td width="82%"><input name="result" type="radio" class="m-1"
                                                    id="result_0" value="Negative">Negative<input name="result"
                                                    type="radio" class="m-1" id="result_1"
                                                    value="Positive">Positive<input name="result" type="radio"
