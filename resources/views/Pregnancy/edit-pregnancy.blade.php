                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/examlab_pregnancy_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input name="specimen_type" type="radio" class="m-1"
                                                    id="specimen_type_0" value="Urine"
                                                    @php echo $exam->specimen_type == "Urine" ? "checked" : "" @endphp>Urine
                                                <input name="specimen_type" type="radio" class="m-1"
                                                    id="specimen_type_1" value="Serum"
                                                    @php echo $exam->specimen_type == "Serum" ? "checked" : "" @endphp>Serum
                                                <input name="specimen_type" type="radio" class="m-1"
                                                    id="specimen_type_2" value=""
                                                    @php echo $exam->specimen_type == "" ? "checked" : "" @endphp>Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="18%" align="left"><b>RESULT</b></td>
                                            <td width="82%"><input name="result" type="radio" class="m-1"
                                                    id="result_0" value="Negative"
                                                    @php echo $exam->result == "Negative" ? "checked" : "" @endphp>Negative
                                                <input name="result" type="radio" class="m-1" id="result_1"
                                                    value="Positive"
                                                    @php echo $exam->result == "Positive" ? "checked" : "" @endphp>

                                                <input name="result" type="radio" class="m-1" id="result_2"
                                                    value="" {{ $exam->result == '' ? 'checked' : '' }}>Reset
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
