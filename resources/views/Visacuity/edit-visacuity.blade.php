                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_visacuity_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <input name="ufvod" type="text" id="ufvod"
                                                    value="{{ $exam->ufvod }}" class="form-control" style="width:80px">
                                            </td>
                                            <td align="center">
                                                <input name="ufvos" type="text" id="ufvos"
                                                    value="{{ $exam->ufvos }}" class="form-control" style="width:80px">
                                            </td>
                                            <td align="center">
                                                <input name="unvodj" type="text" id="unvodj"
                                                    value="{{ $exam->unvodj }}" class="form-control" style="width:80px">
                                            </td>
                                            <td align="center">
                                                <input name="unvosj" type="text" id="unvosj"
                                                    value="{{ $exam->unvosj }}" class="form-control" style="width:80px">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center"><b>Corrected</b></td>
                                            <td align="center">
                                                <input name="cfvod" type="text" id="cfvod"
                                                    value="{{ $exam->cfvod }}" class="form-control" style="width:80px">
                                            </td>
                                            <td align="center">
                                                <input name="cfvos" type="text" id="cfvos"
                                                    value="{{ $exam->cfvos }}" class="form-control" style="width:80px">
                                            </td>
                                            <td align="center">
                                                <input name="cnvodj" type="text" id="cnvodj"
                                                    value="{{ $exam->cnvodj }}" class="form-control" style="width:80px">
                                            </td>
                                            <td align="center">
                                                <input name="cnvosj" type="text" id="cnvosj"
                                                    value="{{ $exam->cnvosj }}" class="form-control" style="width:80px">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                                                    ...
                                                                    <select required name="technician_id"
                                                                        ...
                                                                        @foreach ($optometrists as $optometrist)
                                                                            <option value={{ $optometrist->id }}
                                                                                {{ $optometrist->id == $exam->technician_id ? 'selected' : null }}>
                                                                                {{ $optometrist->firstname }}
                                                                                {{ $optometrist->lastname }},
                                                                                {{ $optometrist->title }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select required name="technician2_id"
                                                                        ...
                                                                        @foreach ($medical_directors as $medical_director)
                                                                            <option value={{ $medical_director->id }}
                                                                                {{ $medical_director->id == $exam->technician2_id ? 'selected' : null }}>
                                                                                {{ $medical_director->firstname }}
                                                                                {{ $medical_director->lastname }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </td>
