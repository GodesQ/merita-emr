                                            ...
                                            <form action="/save-info" class="steps-validation wizard-circle"
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group occupation_other_container"
                                                                    ...
                                                                    <label for="">Occupation : <span
                                                                            ...
                                                                            Specify</span></label>
                                                                    <input type="text" placeholder="Plese Specify"
                                                                        name="occupation_other" id="occupation_other"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="religion" id="religion"
                                                                    ...
                                                                    <option value="IGLESIA NI CRISTO">IGLESIA NI CRISTO
                                                                    </option>
                                                                    <option value="EVANGELICALS">EVANGELICALS</option>
                                                                    <option value="SEVENTH DAY ADVENTIST">SEVENTH DAY
                                                                        ADVENTIST</option>
                                                                ...
                                                                <div class="form-group religion_other_container"
                                                                    ...
                                                                    <label for="">Religion : <span
                                                                            ...
                                                                            Specify</span></label>
                                                                    <input type="text" placeholder="Plese Specify"
                                                                        name="religion_other" id="religion_other"
                                                                        class="form-control" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <input type="date" max="2050-12-31" name="date"
                                                            id="" hidden value="<?php echo date('Y-m-d'); ?>">
                                                </fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select required class="form-control select2"
                                                                    ...
                                                                    @foreach ($agencies as $row)
                                                                        <option
                                                                            {{ optional($referral)->agency_id == $row->id ? 'selected' : null }}
                                                                            value="{{ $row->id }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" id="address_of_agency"
                                                                    ...
                                                                    value="{{ optional($referral)->agency_address }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text" class="form-control"
                                                                    name="passportNo"
                                                                    value="{{ optional($referral)->passport }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text"
                                                                    ...
                                                                    value="{{ optional($referral)->position_applied }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="container-fluid ">
                                                                    <div
                                                                        ...
                                                                        <input type="radio" class="custom-control-input"
                                                                            ...
                                                                            value="Normal"
                                                                            {{ optional($referral)->admission_type == 'Normal' ? 'checked' : null }}>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="radio" class="custom-control-input"
                                                                            ...
                                                                            value="Rush"
                                                                            {{ optional($referral)->admission_type == 'Rush' ? 'checked' : null }}>
                                                                        <label class="custom-control-label"
                                                                ...
                                                                <div class="container-fluid ">
                                                                    <div
                                                                        ...
                                                                        <input type="radio" class="custom-control-input"
                                                                            ...
                                                                            {{ optional($referral)->payment_type == 'Applicant Paid' ? 'checked' : null }}>
                                                                        <label class="custom-control-label"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="radio" class="custom-control-input"
                                                                            ...
                                                                            value="Billed"
                                                                            {{ optional($referral)->payment_type == 'Billed' ? 'checked' : null }}>
                                                                        <label class="custom-control-label"
