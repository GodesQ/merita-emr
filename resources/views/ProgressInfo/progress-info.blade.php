                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="/save-info" class="steps-validation wizard-circle" id="patient-form" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" class="form-control to_upper"
                                                                name="homeAddress" value="{{ optional($referral)->address }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="date" max="2050-12-31" onchange="getAge(this)"
                                                                class="form-control" name="birthdate" value="{{ optional($referral)->birthdate }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input required readonly type="number" id="age" min="18"
                                                                class="form-control" name="age" value="{{ optional($referral)->age }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" placeholder="City, Country" class="form-control"
                                                                name="birthplace">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select required class="form-control" name="occupation" onchange="selectOccupation(this)">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="religion" id="religion" class="form-control" onchange="selectReligion(this)">
                                                                ...
                                                                <option value="UECFI">UECFI</option>
                                                            ...
                                                            <div class="form-group religion_other_container" style="display: none;">
                                                                ...
                                                                <input type="text" placeholder="Plese Specify" name="religion_other" id="religion_other" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="tel" maxlength="11" class="form-control"
                                                                name="phoneNumber">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select required class="form-control select2" onchange="getPackages(this)" name="agencyName">
                                                                <option value=" ">Select Agency</option>
                                                                @foreach($agencies as $row)
                                                                    <option {{ optional($referral)->agency_id == $row->id ? 'selected' : null }} value="{{$row->id}}"> {{$row->agencyname}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly type="text" id="address_of_agency" class="form-control"
                                                                name="address_of_agency" value="{{ optional($referral)->agency_address }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="lastName3">
                                                                Country of Destination : <span class="primary h6">(If not applicable, please write N/A)</span>
                                                            </label>
                                                            <input required type="text" class="form-control" name="countryDestination" value="{{ optional($referral)->country_destination }}">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" class="form-control"
                                                                name="passportNo" value="{{ optional($referral)->passport }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" class="form-control"
                                                                name="ssrb" value="{{ optional($referral)->ssrb }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" max="2050-12-31" class="form-control" name="srb_expdate" value="{{ optional($referral)->ssrb_expdate }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select required name="medicalPackage" class="form-control select2"
                                                                id="packages">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" class="form-control to_upper" name="positionApplied" value="{{ optional($referral)->position_applied }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="container-fluid ">
                                                                <div
                                                                    ...
                                                                    value="Normal" {{ optional($referral)->admission_type == 'Normal' ? 'checked' : null }}>
                                                                ...
                                                                <div
                                                                    ...
                                                                    value="Rush" {{ optional($referral)->admission_type == 'Rush' ? 'checked' : null }}>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="text-bold-600" for="projectinput2">Payment Type <span class="danger">*</span></label>
                                                            <div class="container-fluid ">
                                                                <div
                                                                    class="d-inline-block custom-control custom-radio mr-1">
                                                                    <input type="radio" class="custom-control-input"
                                                                        name="payment_type" id="payment_type1"
                                                                        value="Applicant Paid" {{ optional($referral)->payment_type == 'Applicant Paid' ? 'checked' : null }}>
                                                                    <label class="custom-control-label" for="payment_type1">Applicant Paid</label>
                                                                </div>
                                                                <div
                                                                    class="d-inline-block custom-control custom-radio mr-1">
                                                                    <input type="radio" class="custom-control-input" id="payment_type2" name="payment_type" value="Billed" {{ optional($referral)->payment_type == 'Billed' ? 'checked' : null }}>
                                                                    <label class="custom-control-label" for="payment_type2">Billed to Agency</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 table-responsive">
                                                        <table class="table table-striped col-md-12 medical-table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th>Sexually Transmitted <br> Disease (Syphilis)</th>
                                                                    <td>
                                                                        <fieldset>
                                                                            <div class="custom-control custom-radio">
                                                                                <input required type="radio" value="1"
                                                                ...
                                                                <tr>
                                                                    <th>Vaccination <br> <input type="date"
                                                                            placeholder="Specify..."
                                                                            name="vaccination_date" class="form-control vaccination_date d-none"></th>
                                                                    <td>
                                                                        <fieldset>
                                                                            <div class="custom-control custom-radio">
                                                                                <input required type="radio" value="1"
                                                                                    class="custom-control-input required" onchange="isVaccinated(this)"
                                                                                    name="vaccination"
                                                                                    id="vaccination1">
                                                                                <label class="custom-control-label"
