                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right"><input name="srt_right" type="number" max="999" 
                                                                class="form-control" id="srt_right" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="srt_left" type="number" max="999" 
                                                                class="form-control" id="srt_left" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="srt_ff" type="number" max="999" 
                                                                class="form-control" id="srt_ff" value="" size="5"></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">SD</td>
                                                        <td align="right"><input name="sd_right" type="number" max="999" 
                                                                class="form-control" id="sd_right" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="sd_left" type="number" max="999" 
                                                                class="form-control" id="sd_left" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="sd_ff" type="number" max="999" 
                                                                class="form-control" id="sd_ff" value="" size="5"></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">MCL</td>
                                                        <td align="right"><input name="mcl_right" type="number" max="999" 
                                                                class="form-control" id="mcl_right" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="mcl_left" type="number" max="999" 
                                                                class="form-control" id="mcl_left" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="mcl_ff" type="number" max="999" 
                                                                class="form-control" id="mcl_ff" value="" size="5"></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">TOL</td>
                                                        <td align="right"><input name="tol_right" type="number" max="999" 
                                                                class="form-control" id="tol_right" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="tol_left" type="number" max="999" 
                                                                class="form-control" id="tol_left" value="" size="5">
                                                        </td>
                                                        <td align="right"><input name="tol_ff" type="number" max="999" 
                                                                class="form-control" id="tol_ff" value="" size="5"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <label class="font-weight-bold">Findings</label>
                                                <textarea placeholder="Remarks" class="form-control" name="remarks"
                                                    id="" cols="30" rows="6">PURETONE AUDIOMETRY RESULTS SUGGEST NORMAL BILATERAL HEARING ACUITY</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label class="font-weight-bold">Recommendation</label>
                                                <textarea placeholder="Recommendation" class="form-control" name="recommendation"
