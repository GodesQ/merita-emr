      ...
      <div class="card">
        ...
        <div class="card-title">
          ...
          <div class="col-md-6 text-right">
            <a href="patient_edit?id={{ $exam->admission->patient->id }}&patientcode={{ $exam->admission->patient->patientcode }}"
      ...
      @endif
          ...
          <tbody>
            ...
            <td width="322">
              ...
              <input required name="admission_id" type="text" id="admission_id"
                value="{{ $exam->admission_id }}" class="form-control input required required-sm pull-left"
            ...
            <td><input required name="trans_date" type="text" id="trans_date"
              value="{{ date_format(new DateTime($exam->trans_date), 'F d, Y') }}" class="form-control"
              readonly="">
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            ...
            <td><input required name="patientcode" id="patientcode" type="text"
              value="{{ $exam->admission->patient->patientcode }}" class="form-control" readonly></td>
            </tr>
          </tbody>
          </table>
          ...
          <tr>
            ...
            <td align="center"><input name="air_right1" type="number" max="999" class="form-control"
              id="air_right1" value="{{ $exam->air_right1 }}" size="5" /></td>
            <td align="center"><input name="air_right2" type="number" max="999" class="form-control"
              id="air_right2" value="{{ $exam->air_right2 }}" size="5" />
            <td align="center"><input name="air_right3" type="number" max="999" class="form-control"
              id="air_right3" value="{{ $exam->air_right3 }}" size="5" /></td>
            <td align="center"><input name="air_right4" type="number" max="999" class="form-control"
              id="air_right4" value="{{ $exam->air_right4 }}" size="5" /></td>
            <td align="center"><input name="air_right5" type="number" max="999" class="form-control"
              id="air_right5" value="{{ $exam->air_right5 }}" size="5" /></td>
            <td align="center"><input name="air_right6" type="number" max="999" class="form-control"
              id="air_right6" value="{{ $exam->air_right6 }}" size="5" /></td>
            <td align="center"><input name="air_right7" type="number" max="999" class="form-control"
              id="air_right7" value="{{ $exam->air_right7 }}" size="5" /></td>
            <td align="center"><input name="air_right8" type="number" max="999" class="form-control"
              id="air_right8" value="{{ $exam->air_right8 }}" size="5" /></td>
            <td align="center"><input name="air_right9" type="number" max="999" class="form-control"
              id="air_right9" value="{{ $exam->air_right9 }}" size="5" /></td>
          </tr>
          <tr>
            <td><b>Left Ear:</b></td>
            <td align="center"><input name="air_left1" type="number" max="999" class="form-control" id="air_left1"
              value="{{ $exam->air_left1 }}" size="5" /></td>
            <td align="center"><input name="air_left2" type="number" max="999" class="form-control" id="air_left2"
              value="{{ $exam->air_left2 }}" size="5" /></td>
            <td align="center"><input name="air_left3" type="number" max="999" class="form-control" id="air_left3"
              value="{{ $exam->air_left3 }}" size="5" /></td>
            <td align="center"><input name="air_left4" type="number" max="999" class="form-control" id="air_left4"
              value="{{ $exam->air_left4 }}" size="5" /></td>
            <td align="center"><input name="air_left5" type="number" max="999" class="form-control" id="air_left5"
              value="{{ $exam->air_left5 }}" size="5" /></td>
            <td align="center"><input name="air_left6" type="number" max="999" class="form-control" id="air_left6"
              value="{{ $exam->air_left6 }}" size="5" /></td>
            <td align="center"><input name="air_left7" type="number" max="999" class="form-control" id="air_left7"
              value="{{ $exam->air_left7 }}" size="5" /></td>
            <td align="center"><input name="air_left8" type="number" max="999" class="form-control" id="air_left8"
              value="{{ $exam->air_left8 }}" size="5" /></td>
            <td align="center"><input name="air_left9" type="number" max="999" class="form-control" id="air_left9"
              value="{{ $exam->air_left9 }}" size="5" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <table width="80%" border="0" cellpadding="2" cellspacing="0" class="">
              ...
              <td align="right"><input name="srt_right" type="number" max="999" class="form-control"
                id="srt_right" value="{{ $exam->srt_right }}" size="5" /></td>
              <td align="right"><input name="srt_left" type="number" max="999" class="form-control"
                id="srt_left" value="{{ $exam->srt_left }}" size="5" /></td>
              <td align="right"><input name="srt_ff" type="number" max="999" class="form-control" id="srt_ff"
                value="{{ $exam->srt_ff }}" size="5" /></td>
              </tr>
              <tr>
              <td align="center">SD</td>
              <td align="right"><input name="sd_right" type="number" max="999" class="form-control"
                id="sd_right" value="{{ $exam->sd_right }}" size="5" /></td>
              <td align="right"><input name="sd_left" type="number" max="999" class="form-control"
                id="sd_left" value="{{ $exam->sd_left }}" size="5" /></td>
              <td align="right"><input name="sd_ff" type="number" max="999" class="form-control" id="sd_ff"
                value="{{ $exam->sd_ff }}" size="5" /></td>
              </tr>
              <tr>
              <td align="center">MCL</td>
              <td align="right"><input name="mcl_right" type="number" max="999" class="form-control"
                id="mcl_right" value="{{ $exam->mcl_right }}" size="5" /></td>
              <td align="right"><input name="mcl_left" type="number" max="999" class="form-control"
                id="mcl_left" value="{{ $exam->mcl_left }}" size="5" /></td>
              <td align="right"><input name="mcl_ff" type="number" max="999" class="form-control" id="mcl_ff"
                value="{{ $exam->mcl_ff }}" size="5" /></td>
              </tr>
              <tr>
              <td align="center">TOL</td>
              <td align="right"><input name="tol_right" type="number" max="999" class="form-control"
                id="tol_right" value="{{ $exam->tol_right }}" size="5" /></td>
              <td align="right"><input name="tol_left" type="number" max="999" class="form-control"
                id="tol_left" value="{{ $exam->tol_left }}" size="5" /></td>
              <td align="right"><input name="tol_ff" type="number" max="999" class="form-control" id="tol_ff"
            ...
            <table width="80%" border="0" cellpadding="2" cellspacing="0">
              ...
              <td align="right"><input name="type_right" type="number" max="999" class="form-control"
                id="type_right" value="{{ $exam->type_right }}" size="5" /></td>
              <td align="right"><input name="type_left" type="number" max="999" class="form-control"
                id="type_left" value="{{ $exam->type_left }}" size="5" /></td>
              </tr>
              <tr>
              <td align="center">ECV</td>
              <td align="right"><input name="ecv_right" type="number" max="999" class="form-control"
                id="ecv_right" value="{{ $exam->ecv_right }}" size="5" /></td>
              <td align="right"><input name="ecv_left" type="number" max="999" class="form-control"
                id="ecv_left" value="{{ $exam->ecv_left }}" size="5" /></td>
              </tr>
              <tr>
              <td align="center">COMPLIANCE</td>
              <td align="right"><input name="comp_right" type="number" max="999" class="form-control"
                id="comp_right" value="{{ $exam->comp_right }}" size="5" /></td>
              <td align="right"><input name="comp_left" type="number" max="999" class="form-control"
                id="comp_left" value="{{ $exam->comp_left }}" size="5" /></td>
              </tr>
              <tr>
              <td align="center">PRESSURE</td>
              <td align="right"><input name="press_right" type="number" max="999" class="form-control"
                id="press_right" value="{{ $exam->press_right }}" size="5" /></td>
              <td align="right"><input name="press_left" type="number" max="999" class="form-control"
                id="press_left" value="{{ $exam->press_left }}" size="5" /></td>
              </tr>
            </table>
            </td>
          </tr>
          ...
          <tbody>
            ...
            <td>
              ...
              <input name="hearing" type="radio" class="m-1" id="hearing_0" value="aided" {{ $exam->hearing == 'aided' ? 'checked' : null }}>Aided
              <input name="hearing" type="radio" class="m-1" id="hearing_1" value="unaided" {{ $exam->hearing == 'unaided' ? 'checked' : null }}>Unaided
              </div>
            </td>
            </tr>
            <tr>
            <td>
              ...
              <input name="left_ear_result" type="radio" class="m-1" id="left_ear_result_0" value="Inadequate"
            ...
            <td colspan="4">
              ...
              <input name="right_ear_result" type="radio" class="m-1" id="right_ear_result_1" value="Adequate"
              ...
              <input name="right_ear_result" type="radio" class="m-1" id="right_ear_result_0"
                value="Inadequate" {{ $exam->right_ear_result == 'Inadequate' ? 'checked' : null }}>Inadequate
              </div>
            </td>
            </tr>
            <tr>
            ...
            <td colspan="4" class="table-responsive">
              ...
              <tbody>
                ...
                <td>
                  <div class="form-group">
                  <input name="remarks_status" type="radio" class="m-1" id="remarks_status_0"
                    value="normal" {{ $exam->remarks_status == 'normal' ? 'checked' : null }}>Normal
                  <input name="remarks_status" type="radio" class="m-1" id="remarks_status_1"
                    value="findings" {{ $exam->remarks_status == 'findings' ? 'checked' : null }}>With
                  Findings
                  </div>
                </td>
                </tr>
