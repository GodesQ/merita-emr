                        ...
                        <div class="card-title">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <button onclick='window.open("/exam_audiometry_print?id={{$exam->admission_id}}", "width=800,height=650").print()' class="btn btn-dark btn-solid" title="Print">Print</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table width="80%" border="0" cellpadding="2" cellspacing="0" class="">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right"><input name="srt_left" type="number" max="999"  
                                                        class="form-control" id="srt_left" value="{{ $exam->srt_left }}"
                                                        size="5" /></td>
                                                <td align="right"><input name="srt_ff" type="number" max="999"   class="form-control"
                                                        id="srt_ff" value="{{ $exam->srt_ff }}" size="5" /></td>
                                            </tr>
                                            <tr>
                                                <td align="center">SD</td>
                                                <td align="right"><input name="sd_right" type="number" max="999"  
                                                        class="form-control" id="sd_right" value="{{ $exam->sd_right }}"
                                                        size="5" /></td>
                                                ...
                                                <td align="right"><input name="sd_ff" type="number" max="999"   class="form-control"
                                                        id="sd_ff" value="{{ $exam->sd_ff }}" size="5" /></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="right"><input name="mcl_left" type="number" max="999"  
                                                        class="form-control" id="mcl_left" value="{{ $exam->mcl_left }}"
                                                        size="5" /></td>
                                                <td align="right"><input name="mcl_ff" type="number" max="999"   class="form-control"
                                                        id="mcl_ff" value="{{ $exam->mcl_ff }}" size="5" /></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="right"><input name="tol_left" type="number" max="999"  
                                                        class="form-control" id="tol_left" value="{{ $exam->tol_left }}"
                                                        size="5" /></td>
                                                <td align="right"><input name="tol_ff" type="number" max="999"   class="form-control"
                                                        id="tol_ff" value="{{ $exam->tol_ff }}" size="5" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="50%" align="center">
                                        <table width="80%" border="0" cellpadding="2" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right"><input name="ecv_left" type="number" max="999"  
                                                        class="form-control" id="ecv_left" value="{{ $exam->ecv_left }}"
                                                        size="5" /></td>
                                            </tr>
                                            <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <input name="left_ear_result" type="radio" class="m-1" id="left_ear_result_1"
                                                    value="Adequate" {{$exam->left_ear_result == 'Adequate' ? 'checked' : null}}>Adequate
                                                <input name="left_ear_result" type="radio" class="m-1" id="left_ear_result_0"
                                                    value="Inadequate" {{$exam->left_ear_result == 'Inadequate' ? 'checked' : null}}>Inadequate
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <div class="form-group">
                                                ...
                                                <input name="right_ear_result" type="radio" class="m-1" id="right_ear_result_1"
                                                    value="Adequate" {{$exam->right_ear_result == 'Adequate' ? 'checked' : null}}>Adequate
                                                            ...
                                                            <div class="col-md-8">
                                                                <select name="technician_id" id="technician_id"
                                                                    ...
                                                                    @foreach($audiometricians as $audiometrician)
                                                                        <option value={{$audiometrician->id}}>{{$audiometrician->lastname}}, {{$audiometrician->firstname}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </td>
