<div class="row my-1">
    <div class="col-6">
        <a href="/edit_urinalysis?id={{ $examlab_urin->admission_id }}" class="btn btn-solid btn-primary">Edit</a>
        <a href="/delete_urinalysis/{{ $examlab_urin->id }}" class="btn btn-solid btn-warning">Reset</a>
        <button
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="table table-bordered">
            <tbody>
                <tr>
                    ...
                    <td width="387"><span class="brdBtm"><b>RESULTS</b></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="brdAll">
                        Color</td>
                    <td>
                        {{ $examlab_urin->color }}
                    </td>
                ...
                <tr>
                    <td height="30" valign="top" class="brdAll">
                        Sugar</td>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="table table-bordered">
            <tbody>
                <tr>
                    ...
                    <td><span class="brdLeftBtm"><b>RESULTS</b></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="brdLeft">Pus
                        Cells
                    </td>
                    <td>
                        {{ $examlab_urin->pus }}
                ...
                <tr>
                    <td valign="top" class="brdLeft">RBC
                    </td>
                    <td width="49%">
                        {{ $examlab_urin->rbc }}
                    </td>
                ...
                <tr>
                    <td height="30" valign="top" class="brdLeft">
                        Epithelial Cells</td>
                    <td>
                ...
                <tr>
                    <td height="30" valign="top" class="brdLeftTop">
                        Amorphous Urates</td>
                    <td>
                        {{ $examlab_urin->urates }}
                    </td>
