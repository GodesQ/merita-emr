...
<body>
            ...
            <tbody>
                <tr>
                    <td style="text-align: center;">
                        <span style="font-weight: bold; font-size: 20px; font-family: serif;">REFERRAL SLIP FOR MEDICAL
                            EXAMINATION</span>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center;">
                        <span style="font-weight: 400; font-size: 12px; font-family: sans-serif;">
                            Joint DOH-POEA-MARINA CONSULTATIVE COMMITTEE
                        </span>
                    </td>
                </tr>
            </tbody>
        ...
        <table width="100%" cellspacing="0" cellpadding="5" style="text-align: center; border: 1px solid #476434;">
            <tbody>
                <tr style="border: 1px solid black; text-align: center;">
                    ...
                    <td width="75%">
                        <h2 style="font-family: serif; font-size: 16px; font-weight: 600;">MERITA DIAGNOSTIC CLINIC INC.
                        </h2>
        ...
        <table width="100%" cellspacing="0" cellpadding="2">
            <tbody>
                ...
                <tr>
                    <td>1. Register to the Merita EMR: https://meritaclinic.app/register.</td>
                </tr>
                <tr>
                    <td>2. Fill up all the necessary information and schedule your appointment.</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">5. Non-Compliance of the above Instruction may cause delay of processing of your
                        application.</td>
                </tr>
                <tr style="margin-top: 15px;">
                    <td colspan="2"><b>I have read, understand and agree to comply with the above requirement.</b>
                    </td>
                </tr>
                <tr>
        ...
        <table width="100%" cellspacing="5" cellpadding="2">
            <tbody>
                ...
                <tr>
                    <td width="30%">&nbsp;</td>
                    <td width="40%" style="text-align: center;">Signature over Printed name of Authorized Official
                    </td>
                    <td width="30%">&nbsp;</td>
                </tr>
            </tbody>
