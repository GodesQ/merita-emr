                            ...
                            <tr>
                                <td>
                                    <div style='text-align: center;'>
                                        <h2 style="font-size: 25px; font-weight: 700; line-height: 0px;">MERITA
                                            DIAGNOSTIC CLINIC, INC </h2>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="border-bottom: 1px solid green;" width="83%">
                                                    <span style="color: black;">{{ $patient->firstname }}
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="border-bottom: 1px solid green;" width="81%">
                                                    <span
                                                        style="color: black;">{{ date_format(new DateTime($data->prescription_date), 'F d, Y') }}</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <tr>
                <td>
                    <div style="height: 360px;">
                        <div style="color: black; margin-left: 80px; font-size: 23px; line-height: 30px;">
                                    ...
                                    <table width="100%" cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td width="80%">
                                                    <div>
                                                        <img src="@php echo $doctor->signature @endphp"
                                                            style="width: 85%;object-fit:cover; transform: translateY(35px);"
                                                            alt="">
                                                    </div>
                                                    <div
