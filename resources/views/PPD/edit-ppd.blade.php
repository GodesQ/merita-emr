                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_ppd_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="83%">
                                                <input name="result" type="radio" id="result_0" value="Positive"
                                                    @php echo
                                                $exam->result == 'Positive' ? 'checked' : '' @endphp>&nbsp;&nbsp;Positive
                                                <input name="result" type="radio" id="result_1" value="Negative"
                                                    @php echo
                                                $exam->result == 'Negative' ? 'checked' : '' @endphp>&nbsp;&nbsp;Negative
                                                <input name="result" type="radio" id="result_2" value=""
                                                    @php echo
                                                            ...
                                                            <td>
                                                                <div class="col-md-8">
                                                                    <select required name="technician2_id"
                                                                        ...
                                                                        <option value="2" selected>Teresita F.
                                                                            Gonzales, MD</option>
                                                                    </select>
                                                                </div>
                                                            </td>
