<div class="row my-1">
    <div class="col-6">
        <a href="edit_bloodsero?id={{$exam_blood_serology->admission_id}}"
        ...
        <button
            ...
            title="Print">Print Blood Chemistry Only</button>
        <button
...
<table width="100%" cellpadding="2"
    ...
    <tbody>
        ...
        <tr>
            <td>HBA1C</td>
            <td
                class="{{$exam_blood_serology->hba1c < '4.0' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>FBS</td>
            <td
                class="{{$exam_blood_serology->fbs < '70' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>BUN</td>
            <td
                class="{{$exam_blood_serology->bun < '5' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>CREATININE</td>
            <td
                class="{{$exam_blood_serology->creatinine < '0.8' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>CHOLESTEROL</td>
            <td
                class="{{$exam_blood_serology->cholesterol < '125' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>HDL Chole</td>
            <td
                class="{{$exam_blood_serology->hdl < '40' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>LDL Chole</td>
            <td
                class="{{$exam_blood_serology->ldl > '100' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>URIC ACID</td>
            <td
                class="{{$exam_blood_serology->uricacid < '140' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>SGOT (AST)</td>
            <td
                class="{{$exam_blood_serology->sgot < '0' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>SGPT (ALT)</td>
            <td
                class="{{$exam_blood_serology->sgpt < '0' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>GGT</td>
            <td
                class="{{$exam_blood_serology->ggt < '7' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>ALK. PHOS.</td>
            <td
                class="{{$exam_blood_serology->alkphos < '35' ? 'text-danger' : null }}">
        ...
        <tr>
            ...
            <td
                class="{{$exam_blood_serology->ttlbilirubin < '0' ? 'text-danger' : null }}">
        ...
        <tr>
            ...
            <td
                class="{{$exam_blood_serology->dirbilirubin < '0' ? 'text-danger' : null }}">
        ...
        <tr>
            ...
            <td
                class="{{$exam_blood_serology->indbilirubin < '0' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>TOTAL PROTEIN</td>
            <td
                class="{{$exam_blood_serology->ttlprotein < '66' ? 'text-danger' : null }}">
        ...
        <tr>
            ...
            <td
                class="{{$exam_blood_serology->albumin < '35' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>GLOBULIN</td>
            <td
                class="{{$exam_blood_serology->globulin < '31' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>SODIUM</td>
            <td
                class="{{$exam_blood_serology->sodium < '135' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>POTASSIUM</td>
            <td
                class="{{$exam_blood_serology->potassium < '3.5' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>CHLORIDE</td>
            <td
                class="{{$exam_blood_serology->chloride < '96' ? 'text-danger' : null }}">
        ...
        <tr>
            <td>CALCIUM</td>
            <td
                class="{{$exam_blood_serology->calcium < '2.10' ? 'text-danger' : null }}">
