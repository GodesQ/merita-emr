                        ...
                        <form name="frm" method="post" action="/update_bloodsero" role="form">
                                ...
                                <tr>
                                    ...
                                    <td width="247">
                                        <input name="peme_date" type="text" id="peme_date"
                                            value="{{ $admission->trans_date ? $admission->trans_date : null }}" class="form-control" readonly />
                                    </td>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="2" class="table table-bordered">
                                ...
                                <tr>
                                    <td>HBA1C</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'HBA1C', '4.0', '6.4', '{{$exam->hba1c}}')" name="hba1c" type="text" class="form-control" id="hba1c"
                                            value="{{ $exam->hba1c }}" />
                                    </td>
                                    <td class="">4.0-6.4%</td>
                                    <td><input name="hba1c_findings" type="text" class="form-control" style="width:350px"
                                        id="hba1c_findings" value="{{ $exam->hba1c_findings }}"></td>
                                    <td><input name="hba1c_recommendation" type="text" class="form-control" style="width:350px"
                                            id="hba1c_recommendation" value="{{ $exam->hba1c_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>2hrs. PPBG</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'PPBG', '', '200', '{{ $exam->hba1c }}')" name="ppbg" type="text" class="form-control" id="ppbg" value="{{ $exam->ppbg }}">
                                    </td>
                                    <td class=""> &lt; 200 mg/dL</td>
                                    <td><input name="ppbg_findings" type="text" class="form-control" style="width:350px"
                                        id="ppbg_findings" value="{{ $exam->ppbg_findings }}"></td>
                                    <td><input name="ppbg_recommendation" type="text" class="form-control" style="width:350px"
                                            id="ppbg_recommendation" value="{{ $exam->ppbg_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>FBS</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'FBS', '70', '110', '{{$exam->fbs}}')" name="fbs" type="text" class="form-control" id="fbs"
                                            value="{{ $exam->fbs }}" />
                                    </td>
                                    <td class=""> 70-110 mg/dL </td>
                                    <td><input name="fbs_findings" type="text" class="form-control" style="width:350px"
                                        id="fbs_findings" value="{{ $exam->fbs_findings }}"></td>
                                    <td><input name="fbs_recommendation" type="text" class="form-control" style="width:350px"
                                            id="fbs_recommendation" value="{{ $exam->fbs_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>BUN</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'BUN', '5', '20','{{$exam->bun}}')" name="bun" type="text" class="form-control" id="bun"
                                            value="{{ $exam->bun }}" />
                                    </td>
                                    <td class=""> 5-20 mg/dL </td>
                                    <td><input name="bun_findings" type="text" class="form-control" style="width:350px"
                                        id="bun_findings" value="{{ $exam->bun_findings }}"></td>
                                    <td><input name="bun_recommendation" type="text" class="form-control" style="width:350px"
                                            id="bun_recommendation" value="{{ $exam->bun_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>CREATININE</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'CREATININE', '0.8', '1.2', '{{$exam->creatinine}}')" name="creatinine" type="text" class="form-control" id="creatinine"
                                    ...
                                    <td><input name="creatinine_findings" type="text" class="form-control" style="width:350px"
                                        id="creatinine_findings" value="{{ $exam->creatinine_findings }}"></td>
                                    <td><input name="creatinine_recommendation" type="text" class="form-control" style="width:350px"
                                            id="creatinine_recommendation" value="{{ $exam->creatinine_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>CHOLESTEROL</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'CHOLESTEROL', '125', '200', '{{$exam->cholesterol}}')" name="cholesterol" type="text" class="form-control" id="cholesterol"
                                    ...
                                    <td><input name="cholesterol_findings" type="text" class="form-control" style="width:350px"
                                        id="cholesterol_findings" value="{{ $exam->cholesterol_findings }}"></td>
                                    <td><input name="cholesterol_recommendation" type="text" class="form-control" style="width:350px"
                                            id="cholesterol_recommendation" value="{{ $exam->cholesterol_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>TRIGLYCERIDES</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'TRIGLYCERIDES', '35', '130', '{{$exam->triglycerides}}')" name="triglycerides" type="text" class="form-control" id="triglycerides"
                                            value="{{ $exam->triglycerides }}" />
                                    </td>
                                    <td class=""> M:40-160 F:35-130 </td>
                                    <td><input name="triglycerides_findings" type="text" class="form-control" style="width:350px"
                                        id="triglycerides_findings" value="{{ $exam->triglycerides_findings }}"></td>
                                    <td><input name="triglycerides_recommendation" type="text" class="form-control" style="width:350px"
                                            id="triglycerides_recommendation" value="{{ $exam->triglycerides_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>HDL Chole</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'HDL Chole', '40', '', '{{$exam->hdl}}')" name="hdl" type="text" class="form-control" id="hdl"
                                            value="{{ $exam->hdl }}" />
                                    </td>
                                    <td class=""> &gt;40 mg/dL </td>
                                    <td><input name="hdl_findings" type="text" class="form-control" style="width:350px"
                                        id="hdl_findings" value="{{ $exam->hdl_findings }}"></td>
                                    <td><input name="hdl_recommendation" type="text" class="form-control" style="width:350px"
                                            id="hdl_recommendation" value="{{ $exam->hdl_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>LDL Chole</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'HDL Chole', '', '100', '{{$exam->ldl}}')" name="ldl" type="text" class="form-control" id="ldl" value="{{ $exam->ldl }}" />
                                    </td>
                                    <td class=""> &lt;100 mg/dL </td>
                                    <td><input name="ldl_findings" type="text" class="form-control" style="width:350px"
                                        id="ldl_findings" value="{{ $exam->ldl_findings }}"></td>
                                    <td><input name="ldl_recommendation" type="text" class="form-control" style="width:350px"
                                            id="ldl_recommendation" value="{{ $exam->ldl_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>VLDL Chole</td>
                                    <td>
                                    ...
                                    <td><input name="vldl_findings" type="text" class="form-control" style="width:350px"
                                        id="vldl_findings" value="{{ $exam->vldl_findings }}"></td>
                                    <td><input name="vldl_recommendation" type="text" class="form-control" style="width:350px"
                                            id="vldl_recommendation" value="{{ $exam->vldl_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>URIC ACID</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'URIC ACID', '140', '430', '{{$exam->uricacid}}')" name="uricacid" type="text" class="form-control" id="uricacid"
                                            value="{{ $exam->uricacid }}" />
                                    </td>
                                    <td class=""> 140-430 umol/L </td>
                                    <td><input name="uricacid_findings" type="text" class="form-control" style="width:350px"
                                        id="uricacid_findings" value="{{ $exam->uricacid_findings }}"></td>
                                    <td><input name="uricacid_recommendation" type="text" class="form-control" style="width:350px"
                                            id="uricacid_recommendation" value="{{ $exam->uricacid_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>SGOT (AST)</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'SGOT', '0', '40', '{{$exam->sgot}}')" name="sgot" type="text" class="form-control" id="sgot"
                                            value="{{ $exam->sgot }}" />
                                    </td>
                                    <td class=""> 0-40 u/L </td>
                                    <td><input name="sgot_findings" type="text" class="form-control" style="width:350px"
                                        id="sgot_findings" value="{{ $exam->sgot_findings }}"></td>
                                    <td><input name="sgot_recommendation" type="text" class="form-control" style="width:350px"
                                            id="sgot_recommendation" value="{{ $exam->sgot_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>SGPT (ALT)</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'SGPT', '0', '41', '{{$exam->sgpt}}')" name="sgpt" type="text" class="form-control" id="sgpt"
                                            value="{{ $exam->sgpt }}" />
                                    </td>
                                    <td class="">0-41 u/L</td>
                                    <td><input name="sgpt_findings" type="text" class="form-control" style="width:350px"
                                        id="sgpt_findings" value="{{ $exam->sgpt_findings }}"></td>
                                    <td><input name="sgpt_recommendation" type="text" class="form-control" style="width:350px"
                                            id="sgpt_recommendation" value="{{ $exam->sgpt_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>GGT</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'GGT', '0', '55', '{{$exam->ggt}}')" name="ggt" type="text" class="form-control" id="ggt"
                                            value="{{ $exam->ggt }}" />
                                    </td>
                                    <td class=""> 0-55 u/L </td>
                                    <td><input name="ggt_findings" type="text" class="form-control" style="width:350px"
                                        id="ggt_findings" value="{{ $exam->ggt_findings }}"></td>
                                    <td><input name="ggt_recommendation" type="text" class="form-control" style="width:350px"
                                            id="ggt_recommendation" value="{{ $exam->ggt_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>ALK. PHOS.</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'ALK. PHOS.', '35', '129', '{{$exam->alkphos}}')" name="alkphos" type="text" class="form-control" id="alkphos"
                                            value="{{ $exam->alkphos }}" />
                                    </td>
                                    <td class=""> 35-129 u/L </td>
                                    <td><input name="alkphos_findings" type="text" class="form-control" style="width:350px"
                                        id="alkphos_findings" value="{{ $exam->alkphos_findings }}"></td>
                                    <td><input name="alkphos_recommendation" type="text" class="form-control" style="width:350px"
                                            id="alkphos_recommendation" value="{{ $exam->alkphos_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>TOTAL BILIRUBIN</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'TOTAL BILIRUBIN', '5', '21', '{{$exam->ttlbilirubin}}')" name="ttlbilirubin" type="text" class="form-control" id="ttlbilirubin"
                                            value="{{ $exam->ttlbilirubin }}" />
                                    </td>
                                    <td class="">5-21 umol/L</td>
                                    <td><input name="ttlbilirubin_findings" type="text" class="form-control" style="width:350px"
                                        id="ttlbilirubin_findings" value="{{ $exam->ttlbilirubin_findings }}"></td>
                                    <td><input name="ttlbilirubin_recommendation" type="text" class="form-control" style="width:350px"
                                            id="ttlbilirubin_recommendation" value="{{ $exam->ttlbilirubin_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>DIRECT BILIRUBIN</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'DIRECT BILIRUBIN', '0', '5.1', '{{$exam->dirbilirubin}}')" name="dirbilirubin" type="text" class="form-control" id="dirbilirubin"
                                            value="{{ $exam->dirbilirubin }}" />
                                    </td>
                                    <td class=""> 0-5.1 umol/L </td>
                                    <td><input name="dirbilirubin_findings" type="text" class="form-control" style="width:350px"
                                        id="dirbilirubin_findings" value="{{ $exam->dirbilirubin_findings }}"></td>
                                    <td><input name="dirbilirubin_recommendation" type="text" class="form-control" style="width:350px"
                                            id="dirbilirubin_recommendation" value="{{ $exam->dirbilirubin_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>INDIRECT BILIRUBIN</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'INDIRECT BILIRUBIN', '0', '16', '{{$exam->indbilirubin}}')" name="indbilirubin" type="text" class="form-control" id="indbilirubin"
                                            value="{{ $exam->indbilirubin }}" />
                                    </td>
                                    <td class=""> 0-16 umol/L </td>
                                    <td><input name="indbilirubin_findings" type="text" class="form-control" style="width:350px"
                                        id="indbilirubin_findings" value="{{ $exam->indbilirubin_findings }}"></td>
                                    <td><input name="indbilirubin_recommendation" type="text" class="form-control" style="width:350px"
                                            id="indbilirubin_recommendation" value="{{ $exam->indbilirubin_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>TOTAL PROTEIN</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'TOTAL PROTEIN', '66', '87', '{{$exam->ttlprotein}}')" name="ttlprotein" type="text" class="form-control" id="ttlprotein"
                                    ...
                                    <td><input name="ttlprotein_findings" type="text" class="form-control" style="width:350px"
                                        id="ttlprotein_findings" value="{{ $exam->ttlprotein_findings }}"></td>
                                    <td><input name="ttlprotein_recommendation" type="text" class="form-control" style="width:350px"
                                            id="ttlprotein_recommendation" value="{{ $exam->ttlprotein_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td width="24%">ALBUMIN</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'ALBUMIN', '35', '52', '{{$exam->albumin}}')" name="albumin" type="text" class="form-control" id="albumin"
                                            value="{{ $exam->albumin }}" />
                                    </td>
                                    <td width="50%" class=""> 35-52 g/L </td>
                                    <td><input name="albumin_findings" type="text" class="form-control" style="width:350px"
                                        id="albumin_findings" value="{{ $exam->albumin_findings }}"></td>
                                    <td><input name="albumin_recommendation" type="text" class="form-control" style="width:350px"
                                            id="albumin_recommendation" value="{{ $exam->albumin_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>GLOBULIN</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'GLOBULIN', '31', '35', '{{$exam->globulin}}')" name="globulin" type="text" class="form-control" id="globulin"
                                            value="{{ $exam->globulin }}" />
                                    </td>
                                    <td class=""> 31-35 g/L </td>
                                    <td><input name="globulin_findings" type="text" class="form-control" style="width:350px"
                                        id="globulin_findings" value="{{ $exam->globulin_findings }}"></td>
                                    <td><input name="globulin_recommendation" type="text" class="form-control" style="width:350px"
                                            id="globulin_recommendation" value="{{ $exam->globulin_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>SODIUM</td>
                                    <td>
                                        <input oninput="getBloodRemarks(this, 'SODIUM', '135', '148', '{{$exam->sodium}}')" name="sodium" type="text" class="form-control" id="sodium"
                                            value="{{ $exam->sodium }}" />
                                    </td>
                                    <td class="">135.0-148 mmol/L</td>
                                    <td><input name="sodium_findings" type="text" class="form-control" style="width:350px"
                                        id="sodium_findings" value="{{ $exam->sodium_findings }}"></td>
                                    <td><input name="sodium_recommendation" type="text" class="form-control" style="width:350px"
                                            id="sodium_recommendation" value="{{ $exam->sodium_recommendation }}"></td>
                                </tr>
                                <tr>
                                    <td>POTASSIUM</td>
                                    <td>
                                        <input name="potassium" type="text" class="form-control" id="potassium" oninput="getBloodRemarks(this, 'POTASSIUM', '3.5', '5.3', '{{$exam->potassium}}')"
                            ...
                            <!-- <table width="100%" border="0" cellpadding="2" cellspacing="2" class="table table-bordered table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input name="tpha_result" type="radio" style="width: 20px; height: 20px;" class="m-1 serology" id="tpha_result_1" onchange="getSerologyRemarks('TPHA', this)"
                                            value="Positive" @php echo $exam->tpha_result == 'Positive' ? "checked" : ""
                                        @endphp>Positive
                                        <input name="tpha_result" type="radio" style="width: 20px; height: 20px;" class="m-1 serology" id="tpha_result_2" value=""  onchange="getSerologyRemarks('TPHA', this)" @php echo $exam->tpha_result == '' ? "checked" : ""
                                        @endphp>Reset
                                    </td>
                                    </td>
                                    <td>&nbsp;</td>
                                ...
                                <tr class="table no-border">
                                    ...
                                    <td class="brdLeft">
                                        ...
                                        "" @endphp>Reactive
                                        <input name="hbeag_result" type="radio" style="width: 20px; height: 20px;" class="m-1 serology" id="hbeag_result_2" value="" onchange="getSerologyRemarks('HBeAg', this)" @php echo $exam->hbeag_result == '' ? "checked" : ""
                                        @endphp>Reset
                                    </td>
                                    </td>
                                    <td class="brdLeft">
                                ...
                                <tr>
                                    ...
                                    <td valign="bottom"><span class="brdLeft">
                                            ...
                                            <input name="sothers_result" type="radio" style="width: 20px; height: 20px;" class="m-1 serology" id="sothers_result_2"
                                                value="" @php echo $exam->sothers_result == 'Reactive' ? "checked" : ""
                                            @endphp>Reset </span>
                                    </td>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div class="form-group">
                                                ...
                                                <input name="remarks_status" type="radio" style="width: 20px; height: 20px;" class="m-1 serology"
                                                id="remarks_status_0" value="normal" @php echo $exam->remarks_status == "normal" ? "checked" : null @endphp>Normal
                                                <input name="remarks_status" type="radio" style="width: 20px; height: 20px;" class="m-1 serology" id="remarks_status_1" value="findings" @php echo $exam->remarks_status == "findings" ? "checked" : null @endphp>With Findings
                                            </div>
                                            <div class="form-group">
                                                <textarea placeholder="Remarks" class="form-control" name="remarks" id="remarks" cols="30" rows="6">{{$exam->remarks}} </textarea>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
