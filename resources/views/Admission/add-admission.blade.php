                            ...
                            <div class="form-group">
                                ...
                                <select id="admission_category" onchange="isOtherServices(this)" name="category"
                                    ...
                                    <option value="DECK SERVICES"
                                        {{ $patientInfo->category == 'DECK SERVICES' ? 'selected' : null }}>DECK
                                        SERVICES</option>
                                    <option value="ENGINE SERVICES"
                                        {{ $patientInfo->category == 'ENGINE SERVICES' ? 'selected' : null }}>ENGINE
                                        SERVICES</option>
                                    <option value="CATERING SERVICES"
                                        {{ $patientInfo->category == 'CATERING SERVICES' ? 'selected' : null }}>
                                        CATERING SERVICES</option>
                                    <option value="OTHER SERVICES"
                                        {{ $patientInfo->category == 'OTHER SERVICES' ? 'selected' : null }}>OTHER
                                        SERVICES</option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $patient->position_applied }}" id="position"
                                        class="form-control" placeholder="Position" name="position">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="container-fluid ">
                                    <div class="d-inline-block custom-control custom-radio mr-1">
                                        <input type="radio" class="custom-control-input" id="admit_type1"
                                            ...
                                            {{ $patientInfo->admission_type == 'Normal' ? 'checked' : '' }}>
                                    ...
                                    <div class="d-inline-block custom-control custom-radio mr-1">
                                        <input type="radio" class="custom-control-input" id="admit_type2"
                                            ...
                                            {{ $patientInfo->admission_type == 'Rush' ? 'checked' : '' }}>
                                ...
                                <div class="container-fluid">
                                    <div class="d-inline-block custom-control custom-radio mr-1">
                                        <input type="radio" class="custom-control-input" name="payment_type"
                                            ...
                                            {{ $patientInfo->payment_type == 'Applicant Paid' ? 'checked' : '' }}>
                                    ...
                                    <div class="d-inline-block custom-control custom-radio mr-1">
                                        <input type="radio" class="custom-control-input" id="payment_type4"
                                            ...
                                            {{ $patientInfo->payment_type == 'Billed' ? 'checked' : '' }}>
