                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/examlab_fecalysis_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="trans_date" type="text" id="trans_date"
                                                    value="{{ $exam->trans_date }}" class="form-control move"
                                                    readonly=""></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="patientcode" id="patientcode" type="text"
                                                    value="{{ $exam->patientcode }}" class="form-control move"
                                                    readonly="">
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="consistency" class="form-control move">
                                                    <option {{ $exam->consistency == 'Formed' ? 'selected' : null }}
                                                        value="Formed">Formed</option>
                                                    <option {{ $exam->consistency == 'Semi Formed' ? 'selected' : null }}
                                                        value="Semi Formed">Semi Formed</option>
                                                    <option {{ $exam->consistency == 'Mucold' ? 'selected' : null }}
                                                        value="Mucold">Mucold</option>
                                                    <option {{ $exam->consistency == 'Soft' ? 'selected' : null }}
                                                        value="Soft">Soft</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="bacteria" class="form-control move">
                                                    <option {{ $exam->bacteria == 'RARE' ? 'selected' : null }}
                                                        value="RARE">RARE</option>
                                                    <option {{ $exam->bacteria == 'FEW' ? 'selected' : null }}
                                                        value="FEW">FEW</option>
                                                    <option {{ $exam->bacteria == 'MODERATE' ? 'selected' : null }}
                                                        value="MODERATE">MODERATE</option>
                                                    <option {{ $exam->bacteria == 'MANY' ? 'selected' : null }}
                                                        value="MANY">MANY</option>
                                                    <option {{ $exam->bacteria == 'None' ? 'selected' : null }}
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="pus" type="text" class="form-control move"
                                                    id="pus" value="{{ $exam->pus }}"></td>
                                        </tr>
                                        <tr>
                                            <td align="left">&nbsp;</td>
                                            <td align="left"><b>RBC</b></td>
                                            <td><input name="rbc" type="text" class="form-control move"
                                                    id="rbc" value="{{ $exam->rbc }}"></td>
                                        </tr>
                                        <tr>
                                            <td width="5%" align="left">&nbsp;</td>
                                            <td width="19%" align="left"><b>Yeast Cells</b></td>
                                            <td><input name="yeast" type="text" class="form-control move"
                                                    id="yeast" value="{{ $exam->yeast }}"></td>
                                        </tr>
                                        <tr>
                                            <td align="left">&nbsp;</td>
                                            <td align="left"><strong>Mucus Threads</strong></td>
                                            <td><input name="mucus" type="text" class="form-control move"
                                                    id="mucus" value="{{ $exam->mucus }}"></td>
                                        </tr>
                                        <tr>
                                            <td align="left">&nbsp;</td>
                                            <td align="left"><b>Epithelial Cells</b></td>
                                            <td><input name="epithelial" type="text" class="form-control move"
                                                    id="epithelial" value="{{ $exam->epithelial }}"></td>
                                        </tr>
                                        <tr>
                                            <td align="left">&nbsp;</td>
                                            <td align="left"><b>Ova / Parasite</b></td>
                                            <td><input name="ova" type="ova" class="form-control move"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" valign="center">
                                                <input name="stool_culture" type="text" class="form-control move"
                                                    id="stool_culture" value="{{ $exam->stool_culture }}">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
