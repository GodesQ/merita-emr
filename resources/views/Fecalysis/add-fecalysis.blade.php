                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="center">
                                                ...
                                                <input name="stool_status" type="radio" class="m-1 move"
                                                    id="stool_status_1" value="findings">Findings
                                                <input name="stool_status" type="radio" class="m-1 move"
                                                    id="stool_status_2" value="">Reset
                                            </td>
                                            <td align="left" valign="center">
                                                <input name="stool_culture" type="text" class="form-control move"
                                                    id="stool_culture"
                                                    value="No Salmonella, Shigella and Cholera isolated.">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea placeholder="Remarks" class="form-control move" name="remarks" id="" cols="30"
                                                        rows="6"></textarea>
                                                </div>
                                                @if (!in_array(session()->get('position'), ["Cashier", "Releasing", "Human Resource / Documentation Officer", """", "Information Clerk", "Nurse",  "Asst accounant"]))
                                                    <div class="form-group">
                                                        ...
                                                        <textarea placeholder="Recommendation" class="form-control move" name="recommendation" id=""
