                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/examlab_hiv_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                            ...
                            <form name="frm" method="post" action="/update_hiv" role="form">
                                ...
                                <table id="tblExam" width="100%" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="patientcode" id="patientcode"
                                ...
                                <table width="100%" border="0" class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <input name="exam" type="radio" class="m-1" id="exam_2"
                                                    value="enzyme" /> EIA/CMIA/ELFA&nbsp
                                                <input name="exam" type="radio" class="m-1" id="exam_0"
                                                    value="rapid"
                                                    @php echo $exam->exam == "rapid" ? "checked" : "" @endphp>
                                                RAPID &nbsp;
                                                <input name="exam" type="radio" class="m-1" id="exam_1"
                                                    value="particle" {{ $exam->exam == 'particle' ? 'checked' : null }}>
                                                Particle Agglutination
                                                <input name="exam" type="radio" class="m-1" id="exam_3"
                                                    value="others"
                                                    @php
echo $exam->exam == "others" ? "checked" : "" @endphp>
                                            ...
                                            <td width="45%">
                                                <input name="others" type="text" id="others"
                                                    value="{{ $exam->others }}" placeholder="Others..."
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input name="result" type="radio" id="result_0" class="m-1"
                                                    value="Non Reactive"
                                                    {{ $exam->result == 'Non Reactive' ? 'checked' : '' }}>Non Reactive
                                                <input name="result" type="radio" id="result_1" class="m-1"
                                                    value="Reactive"
                                                    @php echo $exam->result == "Reactive" ? "checked" : "" @endphp>
                                                Reactive
                                                <input name="result" type="radio" id="result_2" class="m-1"
                                                    value=""
                                                    @php echo $exam->result == "" ? "checked" : "" @endphp>Reset
                                            </td>
                                            <td>
                                                <div class="d-flex align-center justify-content-around">
                                                    <div class="form-group">
                                                        <label><b>COV</b></label>
                                                        <input name="result_cov" type="text" id="result_cov"
                                                            value="{{ $exam->result_cov }}" class="form-control"
                                                            style="width:200px">
                                                    </div>
                                                    <div class="form-group">
                                                        <label><b>PV</b></label>
                                                        <input name="result_pv" type="text" id="result_pv"
                                                            value="{{ $exam->result_pv }}" class="form-control"
                                                            style="width:200px">
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><input name="expiry_date" type="date" max="2050-12-31"
                                                    id="expiry_date" value="{{ $exam->expiry_date }}"
                                                                    ...
                                                                    <select required name="technician3_id"
                                                                        ...
                                                                        @foreach ($physicians as $physician)
                                                                            <option value={{ $physician->id }}
                                                                                {{ $physician->id == $exam->technician3_id ? 'selected' : null }}>
                                                                                {{ $physician->firstname }}
                                                                                {{ $physician->lastname }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </td>
