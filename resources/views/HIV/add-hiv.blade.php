                                ...
                                <table width="100%" border="0" class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="45%">
                                                <input name="others" type="text" id="others" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input name="result" type="radio" class="m-1" id="result_0"
                                                    value="Non Reactive" checked>Non Reactive
                                                <input name="result" type="radio" class="m-1" id="result_1"
                                                    value="Reactive">Reactive
                                                <input name="result" type="radio" class="m-1" id="result_2"
                                                    value="">Reset
                                            </td>
                                            <td width="45%">
                                                <div class="d-flex align-center">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="result_cov" type="text" id="result_cov"
                                                            value="" class="form-control" style="width:200px">
                                                    </div>
                                                    <div class="form-group">
                                                        <label><b>PV</b></label>
