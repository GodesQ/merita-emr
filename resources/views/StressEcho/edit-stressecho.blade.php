                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_stress_echo_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="tri_vti" id="tri_vti" type="text"
                                                    value="{{ $exam->tri_vti }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            ...
                                            <td align="center"><input name="tri_rja" id="tri_rja" type="text"
                                                    value="{{ $exam->tri_rja }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="pul_vti" id="pul_vti" type="text"
                                                    value="{{ $exam->pul_vti }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            ...
                                            <td align="center"><input name="pul_rja" id="pul_rja" type="text"
                                                    value="{{ $exam->pul_rja }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="interpretation" id="interpretation" cols="50" rows="2" class="form-control">{{ $exam->interpretation }}</textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="conclusion" id="conclusion" cols="50" rows="2" class="form-control">{{ $exam->conclusion }}</textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
