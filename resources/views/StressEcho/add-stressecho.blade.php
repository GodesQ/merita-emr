                ...
                <div class="col-md-12 my-3">
                    <div class="card">
                        ...
                        <div class="card-content p-2">
                            <form name="frm" method="post" action="/store_stressecho" role="form">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="lvedv_simp" type="text"
                                                    id="lvedv_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="lvesv_simp" type="text"
                                                    id="lvesv_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                            <td colspan="3" align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="sv_simp" type="text"
                                                    id="sv_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                            <td colspan="3" align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="co_simp" type="text"
                                                    id="co_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                            <td colspan="3" align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="ef_simp" type="text"
                                                    id="ef_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="fs_simp" type="text"
                                                    id="fs_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="vcf_simp" type="text"
                                                    id="vcf_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><input name="lmv_simp" type="text"
                                                    id="lmv_simp" value="" class="form-control"
                                                    style="width:50px"></td>
                                            <td colspan="3" align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="interpretation" id="interpretation" cols="50" rows="5"class="form-control">
...
No intracardiac thombus nor pericardial effusion.
                                                                </textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table width="100%" border="0" cellspacing="2" cellpadding="3">
                                                    <tbody>
                                                        <tr>
                                                            <td width="15%"><b>TSE</b></td>
                                                            <td width="85%">
                                                                <textarea name="tse" id="tse" cols="50" rows="2" class="form-control"></textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="conclusion" id="conclusion"cols="50" rows="5" class="form-control">
Abnormal color flow display across the pulmonic valve.
Mitral E/A ratio of 0.8
Normal decelaration time of
Normal pulmonary arterial pressure by accelaration time.
                                                                </textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
