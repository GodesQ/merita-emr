                    ...
                    <div class="card">
                        ...
                        <div class="card-content p-2">
                            <form name="frm" method="post" action="/store_drug" role="form">
                                ...
                                @endif
                                @csrf
                                <input required required required type="hidden" name="id"
                                    value="{{ $admission->id }}">
                                ...
                                <table id="tblExam" width="100%" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Exam Date</b></td>
                                            <td><input required name="trans_date" type="date" id="trans_date"
                                                    value="<?php echo date('Y-m-d'); ?>" class="form-control"></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                ...
                                <table width="100%" border="0" class="table table-bordered table-responsive">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="methamphetamine" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="methamphetamine_0" value="Negative"
                                                    onchange="addRemarks('Methamphetamine', this)">
                                                Negative
                                                <input name="methamphetamine" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                            ...
                                            <td>
                                                <input name="barbiturates" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="barbiturates_0"
                                                    value="Negative" onchange="addRemarks('Barbiturates', this)">
                                                Negative
                                                <input name="barbiturates" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="barbiturates_1"
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="tetrahydrocannabinol" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                                    id="tetrahydrocannabinol_0" value="Negative"
                                                    onchange="addRemarks('Tetrahydrocannabinol', this)">
                                                Negative
                                                <input name="tetrahydrocannabinol" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                            ...
                                            <td>
                                                <input name="ecstacy" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="ecstacy_0" value="Negative"
                                                    onchange="addRemarks('Ecstacy', this)">
                                                Negative
                                                <input name="ecstacy" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="ecstacy_1" value="Positive"
                                                    onchange="addRemarks('Ecstacy', this)">
                                                Positive
                                                <input name="ecstacy" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="ecstacy_1" value=""
                                                    onchange="addRemarks('Ecstacy', this)">
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input name="morphine" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="morphine_0" value="Negative"
                                                    onchange="addRemarks('Morphine', this)">
                                                Negative
                                                <input name="morphine" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="morphine_1" value="Positive"
                                                    onchange="addRemarks('Morphine', this)">
                                                Positive
                                                <input name="morphine" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="morphine_1" value=""
                                                    onchange="addRemarks('Morphine', this)">
                                                Reset
                                            </td>
                                            <td width="18%" colspan="-2" align="right"><b> Benzodiazepine </b></td>
                                            <td width="32%" colspan="-2">
                                                <input name="benzodiazepine" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="cocaine" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="cocaine_0" value="Negative"
                                                    onchange="addRemarks('Cocaine', this)">
                                                Negative
                                                <input name="cocaine" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="cocaine_1" value="Positive"
                                                    onchange="addRemarks('Cocaine', this)">
                                                Positive
                                                <input name="cocaine" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="cocaine_1" value=""
                                                    onchange="addRemarks('Cocaine', this)">
                                                Reset
                                            </td>
                                            <td align="right"><b>Propoxyphene</b></td>
                                            <td>
                                                <input name="propoxyphene" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="propoxyphene_0"
                                                    value="Negative" onchange="addRemarks('Propoxyphene', this)">
                                                Negative
                                                <input name="propoxyphene" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="propoxyphene_1"
                                                    onchange="addRemarks('Propoxyphene', this)" value="Positive">
                                                Positive
                                                <input name="propoxyphene" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="propoxyphene_1"
                                        ...
                                        <tr>
                                            ...
                                            <td width="32%" colspan="-2">
                                                <input name="methadone" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="methadone_0" value="Negative"
                                                    onchange="addRemarks('Methadone', this)">
                                                Negative
                                                <input name="methadone" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="methadone_1" value="Positive"
                                                    onchange="addRemarks('Methadone', this)">
                                                Positive
                                                <input name="methadone" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="methadone_1"
                                                    onchange="addRemarks('Methadone', this)">
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input name="alcohol" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="alcohol_0" value="Negative"
                                                    onchange="addRemarks('Alcohol', this)">
                                                Negative
                                                <input name="alcohol" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="alcohol_1" value="Positive"
                                                    onchange="addRemarks('Alcohol', this)">
                                                Positive
                                                <input name="alcohol" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="alcohol_1" onchange="addRemarks('Alcohol', this)">
                                                Reset
                                            </td>
                                            <td width="18%" colspan="-2" align="right"><b> Metaqualone</b></td>
                                            <td width="32%" colspan="-2">
                                                <input name="metaqualone" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="metaqualone_0"
                                                    value="Negative" onchange="addRemarks('Metaqualone', this)">
                                                Negative
                                                <input name="metaqualone" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="metaqualone_1"
                                                    onchange="addRemarks('Metaqualone', this)" value="Positive">
                                                Positive
                                                <input name="metaqualone" type="radio"
                                                    style="width: 20px; height: 20px;" class="m-1" id="metaqualone_1"
                                                    onchange="addRemarks('Metaqualone', this)">
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right"><b>Opium</b></td>
                                            <td><input name="opium" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="opium_0" value="Negative"
                                                    onchange="addRemarks('Opium', this)">
                                                Negative
                                                <input name="opium" type="radio" style="width: 20px; height: 20px;"
                                                    class="m-1" id="opium_1" value="Positive"
                                                    onchange="addRemarks('Opium', this)">
                                                Positive
                                                <input name="opium" type="radio" style="width: 20px; height: 20px;"
