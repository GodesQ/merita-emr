                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/examlab_drug_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                        ...
                                        <tr>
                                            ...
                                            <td width="31%">
                                                <select type="menu" name="purpose" id="purpose" class="form-control">
                                                    <option value="" {{ $exam->purpose == '' ? 'selected' : '' }}>
                                                        --SELECT--</option>
                                                    <option value="Not Required"
                                                        {{ $exam->purpose == 'Not Required' ? 'selected' : '' }}>Not
                                                        Required</option>
                                                    <option value="Pre-Employment"
                                                        {{ $exam->purpose == 'Pre-Employment' || $exam->purpose == 'Pre-Employement' ? 'selected' : '' }}>
                                                        Pre-Employment
                                                    </option>
                                                    <option
                                                        value="Student"{{ $exam->purpose == 'Student' ? 'selected' : '' }}>
                                                        Student</option>
                                                    <option
                                                        value="Licensing"{{ $exam->purpose == 'Licensing' ? 'selected' : '' }}>
                                                        Licensing</option>
                                                    <option
                                                        value="Random Drug Testing"{{ $exam->purpose == 'Random Drug Testing' ? 'selected' : '' }}>
                                                        Random Drug Testing
                                                    </option>
                                                    <option
                                                        value="Others"{{ $exam->purpose == 'Others' ? 'selected' : '' }}>
                                                        Others</option>
                                                </select>
                                            </td>
                                            ...
                                            <td width="32%" align="right">
                                                <select type="menu" name="method" id="method" class="form-control">
                                                    <option value="" {{ $exam->method == '' ? 'selected' : '' }}>
                                                        --SELECT--</option>
                                                    <option value="Not Required"
                                                        {{ $exam->method == 'Not Required' ? 'selected' : '' }}>Not
                                                        Required</option>
                                                    <option value="Instrumented"
                                                        {{ $exam->method == 'Instrumented' ? 'selected' : '' }}>
                                                        Instrumented</option>
                                                    <option value="Test Kit"
                                                        {{ $exam->method == 'Test Kit' ? 'selected' : '' }}>Test Kit
                                                    </option>
                                                    <option value="Random Drug Test"
                                                        {{ $exam->method == 'Random Drug Test' ? 'selected' : '' }}>Random
                                                        Drug Test</option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="methamphetamine" type="radio" class="m-75"
                                                    ...
                                                    onchange="addRemarks('Methamphetamine', this)">Negative

                                                <input name="methamphetamine" type="radio" class="m-75"
                                                    {{ $exam->methamphetamine == 'Positive' ? 'checked' : '' }}
                                                    id="methamphetamine_1" value="Positive"
                                                    onchange="addRemarks('Methamphetamine', this)">Positive

                                                <input name="methamphetamine" type="radio" class="m-75"
                                                    {{ $exam->methamphetamine == '' ? 'checked' : '' }}
                                                    id="methamphetamine_2" value=""
                                                    onchange="addRemarks('Methamphetamine', this)">Reset
                                            </td>
                                            <td align="right"><b>Barbiturates</b></td>
                                            <td>
                                                <input name="barbiturates" type="radio" class="m-75"
                                                    id="barbiturates_0" value="Negative"
                                                    onchange="addRemarks('Barbiturates', this)"
                                                    {{ $exam->barbiturates == 'Negative' ? 'checked' : '' }}>Negative

                                                <input name="barbiturates" type="radio" class="m-75"
                                                    id="barbiturates_1" value="Positive"
                                                    onchange="addRemarks('Barbiturates', this)"
                                                    {{ $exam->barbiturates == 'Positive' ? 'checked' : '' }}>Positive

                                                <input name="barbiturates" type="radio" class="m-75"
                                                    id="barbiturates_2" value=""
                                                    onchange="addRemarks('Barbiturates', this)"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="tetrahydrocannabinol" type="radio" class="m-75"
                                                    id="tetrahydrocannabinol_0" value="Negative"
                                                    onchange="addRemarks('Tetrahydrocannabinol', this)"
                                                    {{ $exam->tetrahydrocannabinol == 'Negative' ? 'checked' : '' }}>Negative

                                                <input name="tetrahydrocannabinol" type="radio" class="m-75"
                                                    id="tetrahydrocannabinol_1" value="Positive"
                                                    onchange="addRemarks('Tetrahydrocannabinol', this)"
                                                    {{ $exam->tetrahydrocannabinol == 'Positive' ? 'checked' : '' }}>Positive

                                                <input name="tetrahydrocannabinol" type="radio" class="m-75"
                                                    id="tetrahydrocannabinol_1" value=""
                                                    onchange="addRemarks('Tetrahydrocannabinol', this)"
                                            ...
                                            <td>
                                                <input name="ecstacy" type="radio" class="m-75" id="ecstacy_0"
                                                    ...
                                                    @php echo $exam->ecstacy == "Negative" ? "checked" : "" @endphp>
                                                Negative
                                                <input name="ecstacy" type="radio" class="m-75" id="ecstacy_1"
                                                    value="Positive" onchange="addRemarks('Ecstacy', this)"
                                                    @php echo $exam->ecstacy == "Positive" ? "checked" : "" @endphp>
                                                Positive
                                                <input name="ecstacy" type="radio" class="m-75" id="ecstacy_1"
                                                    value="" onchange="addRemarks('Ecstacy', this)"
                                                    @php echo $exam->ecstacy == "" ? "checked" : "" @endphp>
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input name="morphine" type="radio" class="m-75" id="morphine_0"
                                                    ...
                                                    @php echo $exam->morphine == "Negative" ? "checked" :
                                            "" @endphp>
                                                Negative
                                                <input name="morphine" type="radio" class="m-75" id="morphine_1"
                                                    value="Positive" onchange="addRemarks('Morphine', this)"
                                                    @php echo $exam->morphine == "Positive" ? "checked" :
                                            "" @endphp>
                                                Positive
                                                <input name="morphine" type="radio" class="m-75" id="morphine_1"
                                                    value="" onchange="addRemarks('Morphine', this)"
                                                    @php echo $exam->morphine == "" ? "checked" : "" @endphp>
                                                Reset
                                            </td>
                                            <td width="18%" colspan="-2" align="right"><b> Benzodiazepine </b></td>
                                            <td width="32%" colspan="-2">
                                                <input name="benzodiazepine" type="radio" class="m-75"
                                                    id="benzodiazepine_0" value="Negative"
                                                    onchange="addRemarks('Benzodiazepine', this)"
                                                    @php echo $exam->benzodiazepine == "Negative" ?
                                            "checked" : "" @endphp>
                                                Negative
                                                <input name="benzodiazepine" type="radio" class="m-75"
                                                    id="benzodiazepine_1" value="Positive"
                                                    onchange="addRemarks('Benzodiazepine', this)"
                                                    @php echo $exam->benzodiazepine == "Positive" ?
                                            "checked" : "" @endphp>
                                                Positive
                                                <input name="benzodiazepine" type="radio" class="m-75"
                                                    id="benzodiazepine_1" value=""
                                                    onchange="addRemarks('Benzodiazepine', this)"
                                                    @php echo $exam->benzodiazepine == "" ? "checked" : "" @endphp>
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input name="propoxyphene" type="radio" class="m-1"
                                                    id="propoxyphene_0" value="Negative"
                                                    @php echo $exam->propoxyphene == "Negative" ? "checked" : null @endphp
                                                    onchange="addRemarks('Propoxyphene', this)">
                                                Negative
                                                <input name="propoxyphene" type="radio" class="m-1"
                                                    id="propoxyphene_1" onchange="addRemarks('Propoxyphene', this)"
                                                    value="Positive"
                                                    @php echo $exam->propoxyphene == "Positive" ? "checked" : null @endphp>
                                                Positive
                                                <input name="propoxyphene" type="radio" class="m-1"
                                                    id="propoxyphene_1" value=""
                                                    onchange="addRemarks('Propoxyphene', this)"
                                                    @php echo $exam->propoxyphene == "" ? "checked" : null @endphp>
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="-2">
                                                <input name="phencyclidine" type="radio" class="m-75"
                                                    id="phencyclidine_0" value="Negative"
                                                    onchange="addRemarks('Phencyclidine', this)"
                                                    @php echo $exam->phencyclidine == "Negative" ?
                                            "checked" : "" @endphp>
                                                Negative
                                                <input name="phencyclidine" type="radio" class="m-75"
                                                    id="phencyclidine_1" value="Positive"
                                                    onchange="addRemarks('Phencyclidine', this)"
                                                    @php echo $exam->phencyclidine == "Positive" ?
                                            "checked" : "" @endphp>
                                                Positive
                                                <input name="phencyclidine" type="radio"
                                                    onchange="addRemarks('Phencyclidine', this)" class="m-75"
                                                    id="phencyclidine_1" value=""
                                                    @php echo $exam->phencyclidine == "" ? "checked" : "" @endphp>
                                                Reset
                                            </td>
                                            <td width="18%" colspan="-2" align="right"><b>Methadone</b></td>
                                            <td width="32%" colspan="-2">
                                                <input name="methadone" type="radio"
                                                    onchange="addRemarks('Methadone', this)" class="m-75"
                                                    id="methadone_0" value="Negative"
                                                    @php echo $exam->methadone == "Negative" ? "checked" :
                                            "" @endphp>
                                                Negative
                                                <input name="methadone" type="radio"
                                                    onchange="addRemarks('Methadone', this)" class="m-75"
                                                    id="methadone_1" value="Positive"
                                                    @php echo $exam->methadone == "Positive" ? "checked" :
                                            "" @endphp>
                                                Positive
                                                <input name="methadone" type="radio"
                                                    onchange="addRemarks('Methadone', this)" class="m-75"
                                                    id="methadone_1"
                                                    value=""@php echo $exam->methadone == "" ? "checked" : "" @endphp>
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right"><b>Alcohol</b></td>
                                            <td><input name="alcohol" type="radio"
                                                    onchange="addRemarks('Alcohol', this)" class="m-75" id="alcohol_0"
                                                    value="Negative"
                                                    @php echo $exam->alcohol == "Negative" ? "checked" : "" @endphp>
                                                Negative
                                                <input name="alcohol" type="radio"
                                                    onchange="addRemarks('Alcohol', this)" class="m-75" id="alcohol_1"
                                                    value="Positive"
                                                    @php echo $exam->alcohol == "Positive" ? "checked" : "" @endphp>
                                                Positive
                                                <input name="alcohol" type="radio"
                                                    onchange="addRemarks('Alcohol', this)" class="m-75" id="alcohol_1"
                                                    value=""
                                            ...
                                            <td width="32%" colspan="-2">
                                                <input name="metaqualone" type="radio"
                                                    onchange="addRemarks('Metaqualone', this)" class="m-75"
                                                    id="metaqualone_0" value="Negative"
                                                    @php echo $exam->metaqualone == "Negative" ? "checked"
                                            : "" @endphp>
                                                Negative
                                                <input name="metaqualone" type="radio"
                                                    onchange="addRemarks('Metaqualone', this)" class="m-75"
                                                    id="metaqualone_1" value="Positive"
                                                    @php echo $exam->metaqualone == "Positive" ? "checked"
                                            : "" @endphp>
                                                Positive
                                                <input name="metaqualone" type="radio"
                                                    onchange="addRemarks('Metaqualone', this)" class="m-75"
                                                    id="metaqualone_1" value=""
                                                    @php echo $exam->metaqualone == "" ? "checked" : "" @endphp>
                                                Reset
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input name="opium" type="radio" class="m-1" id="opium_0"
                                                    value="Negative"
                                                    @php echo $exam->opium == "Negative" ? "checked" : null @endphp
                                                    onchange="addRemarks('Opium', this)">
                                                Negative
                                                <input name="opium" type="radio" class="m-1" id="opium_1"
                                                    value="Positive"
                                                    @php echo $exam->opium == "Positive" ? "checked" : null @endphp
                                                    onchange="addRemarks('Opium', this)">
                                                Positive
                                                <input value="" name="opium"
                                                    @php echo $exam->opium == "" ? "checked" : null @endphp type="radio"
                                                    class="m-1" id="opium_1" onchange="addRemarks('Opium', this)">
                                                Reset
                                            </td>
