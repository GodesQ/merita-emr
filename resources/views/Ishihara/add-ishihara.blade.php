                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="83%"><input name="result" type="radio" class="m-1"
                                                    id="result_0" value="Adequate">Adequate<input name="result"
                                                    type="radio" class="m-1" id="result_1"
                                                    value="Defective">Defective<input name="result" type="radio"
                                                    class="m-1" id="result_2" value="">Not Required</td>
                                        </tr>
                                    </tbody>
                                </table>
