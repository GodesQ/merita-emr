                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_ishihara_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="83%">
                                                <input name="result" type="radio" id="result_0" value="Adequate"
                                                    @php echo
                                                $exam->result == 'Adequate' ? 'checked' : '' @endphp>&nbsp;&nbsp;Adequate
                                                <input name="result" type="radio" id="result_1" value="Defective"
                                                    @php echo
                                                $exam->result == 'Defective' ? 'checked' : '' @endphp>&nbsp;&nbsp;Defective
                                                <input name="result" type="radio" id="result_2" value=""
                                                    @php echo
                                                $exam->result == '' ? 'checked' : '' @endphp>&nbsp;&nbsp;Not
                                                Required
                                            </td>
                                        </tr>
                                    </tbody>
