                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input required required required name="patientcode" id="patientcode"
                                                    type="text" value="{{ $admission->patient->patientcode }}"
                                                    ...
                                                    @if (
                                                        ...
                                                        <tr>
                                                            <td colspan="6">
                                                                ...
                                                                <textarea name="pe1_recommendation" cols="20" rows="2" id="pe1_recommendation" class="form-control"></textarea>
                                                            </td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                            @else
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">Operations (Specify)
                                                            <br><input name="operations" type="input"
                                                                id="operations" value="">
                                                        </td>
                                                        <td align="center"><label for="checkbox">YES</label>
                                                            <input name="sick31" type="radio"
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td>Comments:
                                                                        <textarea name="comments" cols="40" rows="2" id="comments" class="form-control"></textarea>
                                                                    </td>
                                                                    <td align="center">&nbsp;</td>
                                                                    <td align="center">&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>8.Are you taking any non - prescription or
                                                                        ...
                                                                        dosage(s):<br>
                                                                        <textarea name="purpose" cols="40" rows="2" id="purpose" class="form-control"></textarea>
                                                                    </td>
                                                                    <td align="center" valign="top"><input
                                                                            name="question8" type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            id="question8" value="1"></td>
                                                                    <td align="center" valign="top"><input
                                                                            name="question8" type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            id="question8" value="0" checked>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td height="15">
                                                        ...
                                                        <textarea name="family_history" cols="10" rows="2" id="family_history" class="form-control"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="16">
                                                        ...
                                                        <p>
                                                            <textarea name="present_illness" cols="10" rows="2" id="present_illness" class="form-control"></textarea>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="31">
                                                        ...
                                                        <textarea name="social_history" cols="10" rows="2" id="social_history" class="form-control"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="31">
                                                ...
                                                <tr>
                                                    <td><b>OTHER PERTINENT INFORMATION:</b> To be filled up by the
                                                        ...
                                                        <p></p>
                                                        <textarea name="pertinent_info" cols="20" rows="2" id="pertinent_info" class="form-control"></textarea>
                                                    </td>
                                                    <td>
                                                    </td>
                                                </tr>
                                                                ...
                                                                @if (
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="7">
                                                                            ...
                                                                            <textarea name="vital_sign_recommendation" id="vital_sign_recommendation" cols="30" rows="3"
                                                                                class="form-control"></textarea>
                                                                        </td>
                                                                    </tr>
                                                                @endif
...
@endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="21"><input name="ecg" type="radio"
                                                            ...
                                                            value="normal"
                                                            @if ($exam_ecg) {{ $exam_ecg->remarks_status == 'normal' ? 'checked' : null }} @endif>
                                                        Normal</td>
                                                    <td height="21" colspan="2"><input name="ecg"
                                                            type="radio" style="width: 20px; height: 20px;"
                                                            id="radio91" value="findings"
                                                            @if ($exam_ecg) {{ $exam_ecg->remarks_status == 'findings' ? 'checked' : null }} @endif>
                                                        With Findings
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="203" style=""><input name="summary_medexam"
                                                            type="radio" style="width: 20px; height: 20px;"
                                                            id="summary_medexam" value="passed">
                                                        PASSED</td>
                                                    <td width="651" style=""><input name="summary_medexam"
                                                            type="radio" style="width: 20px; height: 20px;"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="203" style=""><input name="summary_labtest"
                                                            type="radio" style="width: 20px; height: 20px;"
                                                            id="summary_labtest" value="passed">
                                                        PASSED</td>
                                                    <td width="651" style=""><input name="summary_labtest"
                                                            type="radio" style="width: 20px; height: 20px;"
                                                ...
                                                <tr>
                                                    <td width="387" height="39" style="">Flag Host Medical
                                                        ...
                                                        Laboratory
                                                        Requirments:</td>
                                                    <td width="203" style=""><input
                                                            name="summary_labrequirements" type="radio"
                                                            style="width: 20px; height: 20px;"
                                                            id="summary_labrequirements" value="passed">
                                                        PASSED</td>
                                                    <td width="651" style=""><input
                                                            name="summary_labrequirements" type="radio"
                                                            style="width: 20px; height: 20px;"
