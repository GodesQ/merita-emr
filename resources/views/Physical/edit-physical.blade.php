                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick1" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick1"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick1 == "Yes" || $exam->sick1 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick1" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick1"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick1 == "No" || $exam->sick1 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Other Lung Disorders</td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick11" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick11"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick11 == "Yes" || $exam->sick11 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick11" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick11"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick11 == "No" || $exam->sick11 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick22" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick22 == "Yes" || $exam->sick22 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick22" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick22"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick22 == "No" || $exam->sick22 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="center"><label for="checkbox">YES</label>
                                                        <input name="sick2" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick2"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick2 == "Yes" || $exam->sick2 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick2" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick2"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick2 == "No" || $exam->sick2 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td align="center"><label for="checkbox">YES</label>
                                                        <input name="sick12" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick12"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick12 == "Yes" || $exam->sick12 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick12" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick12"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick12 == "No" || $exam->sick12 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick23" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick23 == "Yes" || $exam->sick23 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick23" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick23"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick23 == "No" || $exam->sick23 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="154" align="center">Frequency Dizziness</td>
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick3" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick3"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick3 == "Yes" || $exam->sick3 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick3" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick3"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick3 == "No" || $exam->sick3 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Heart Disease/Chest Pain</td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick13" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick13"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick13 == "Yes" || $exam->sick13 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick13" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick13"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick13 == "No" || $exam->sick13 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick24" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick24 == "Yes" || $exam->sick24 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick24" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick24"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick24 == "No" || $exam->sick24 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick4" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick4"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick4 == "Yes" || $exam->sick4 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick4" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick4"
                                                            value="0"
                                                    ...
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick14" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick14"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick14 == "Yes" || $exam->sick14 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick14" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick14"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick14 == "No" || $exam->sick14 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick25" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick25 == "Yes" || $exam->sick25 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick25" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick25"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick25 == "No" || $exam->sick25 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="154" align="center">Insomia Or Sleep Disorders</td>
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick5" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick5"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick5 == "Yes" || $exam->sick5 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick5" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick5"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick5 == "No" || $exam->sick5 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Diabetes Mellitus</td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick15" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick15"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick15 == "Yes" || $exam->sick15 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick15" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick15"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick15 == "No" || $exam->sick15 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick26" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick26 == "Yes" || $exam->sick26 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick26" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick26"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick26 == "No" || $exam->sick26 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick6" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick6"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick6 == "Yes" || $exam->sick6 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick6" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick6"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick6 == "No" || $exam->sick6 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Other Endocrine
                                                        Disorders(e.g.Goiter)
                                                    </td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick16" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick16"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick16 == "Yes" || $exam->sick16 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick16" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick16"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick16 == "No" || $exam->sick16 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick27" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick27 == "Yes" || $exam->sick27 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick27" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick27"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick27 == "No" || $exam->sick27 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="154" align="center">Trachoma,Other Eye Disorders</td>
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick7" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick7"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick7 == "Yes" || $exam->sick7 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick7" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick7"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick7 == "No" || $exam->sick7 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Cancer or Tumor</td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick17" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick17"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick17 == "Yes" || $exam->sick17 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick17" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick17"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick17 == "No" || $exam->sick17 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick30" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick30 == "Yes" || $exam->sick30 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick30" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick30"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick30 == "No" || $exam->sick30 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick8" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick8"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick8 == "Yes" || $exam->sick8 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick8" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick8"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick8 == "No" || $exam->sick8 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Blood Disorders</td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick18" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick18"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick18 == "Yes" || $exam->sick18 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick18" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick18"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick18 == "No" || $exam->sick18 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td align="center"><label for="checkbox">YES</label>
                                                        <input name="sick31" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick31"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick31 == "Yes" || $exam->sick31 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick31" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick31"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick31 == "No" || $exam->sick31 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="154" align="center">Nose or Throat Disorders</td>
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick9" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick9"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick9 == "Yes" || $exam->sick9 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick9" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick9"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick9 == "No" || $exam->sick9 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Stomach Pain, Gastritis or Ulcer
                                                    </td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick19" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick19"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick19 == "Yes" || $exam->sick19 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick19" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick19"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick19 == "No" || $exam->sick19 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center">
                                                        <input name="sick32" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick32"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick32 == "1" ?
                                                    "checked"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="90" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick10" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick10 == "Yes" || $exam->sick10 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick10" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick10"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick10 == "No" || $exam->sick10 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    <td width="154" align="center">Other Abdominal Disorders</td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick20" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick20"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick20 == "Yes" || $exam->sick20 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick20" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick20"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick20 == "No" || $exam->sick20 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick28" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick28 == "Yes" || $exam->sick28 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick28" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick28"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick28 == "No" || $exam->sick28 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick33" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick33"
                                                            value="1"
                                                            @php echo
                                                        $exam->sick33 == "Yes" || $exam->sick33 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick33" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick33"
                                                            value="0"
                                                    ...
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick21" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick21 == "Yes" || $exam->sick21 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick21" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick21"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick21 == "No" || $exam->sick21 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                    ...
                                                    <td width="146" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick29" type="radio"
                                                            ...
                                                            value="1"
                                                            @php echo
                                                        $exam->sick29 == "Yes" || $exam->sick29 == "1" ? "checked" : "" @endphp>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick29" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick29"
                                                            value="0"
                                                            @php echo
                                                        $exam->sick29 == "No" || $exam->sick29 == "0" ? "checked" : "" @endphp>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="154" align="center">Back Problems</td>
                                                    <td width="96" align="center"><label for="checkbox">YES</label>
                                                        <input name="sick34" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick34"
                                                            value="1"
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <input name="sick36" type="radio"
                                                            ...
                                                            value="1" {{ $exam->sick36 == 1 ? 'checked' : null }}>
                                                        <label for="checkbox">NO</label>
                                                        <input name="sick36" type="radio"
                                                            style="width: 20px; height: 20px;" id="sick36"
                                                            value="0" {{ $exam->sick36 == 0 ? 'checked' : null }}>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width="48" align="center" valign="bottom">
                                                                        <input name="question1" type="radio"
                                                                            ...
                                                                            id="question1" value="1"
                                                                            @php echo $exam->question1 == "Yes" || $exam->question1 == "1" ? "checked" : "" @endphp>
                                                                    </td>
                                                                    <td width="43" align="center" valign="bottom">
                                                                        <input name="question1" type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            id="question1" value="0"
                                                                            @php echo $exam->question1 == "No" || $exam->question1 == "0" ? "checked" : "" @endphp>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    ...
                                                                    <td align="center"><input name="question2"
                                                                            ...
                                                                            @php echo $exam->question2 == "Yes" || $exam->question2 == "1" ? "checked" : "" @endphp>
                                                                    </td>
                                                                    <td align="center"><input name="question2"
                                                                            type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question2 == "No" ||
                                                                    $exam->question2 == "0" ? "checked" : "" @endphp>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    ...
                                                                    <td align="center"><input name="question3"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question3 == "Yes" ||
                                                                    $exam->question3 == "1" ? "checked" : "" @endphp>
                                                                    </td>
                                                                    <td align="center"><input name="question3"
                                                                            type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question3 == "No" ||
                                                                    $exam->question3 == "0" ? "checked" : "" @endphp>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    ...
                                                                    <td align="center"><input name="question4"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question4 == "Yes" ||
                                                                    $exam->question4 == "1" ? "checked" : "" @endphp>
                                                                    </td>
                                                                    <td align="center"><input name="question4"
                                                                            type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question4 == "No" ||
                                                                    $exam->question4 == "0" ? "checked" : "" @endphp>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="15">&nbsp;</td>
                                                                    ...
                                                                    <td align="center"><input name="question5"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question5 == "Yes" ||
                                                                    $exam->question5 == "1" ? "checked" : "" @endphp>
                                                                    </td>
                                                                    <td align="center"><input name="question5"
                                                                            type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question5 == "No" ||
                                                                    $exam->question5 == "0" ? "checked" : "" @endphp>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    ...
                                                                    <td align="center"><input name="question6"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question6 == "Yes" ||
                                                                    $exam->question6 == "1" ? "checked" : "" @endphp>
                                                                    </td>
                                                                    <td align="center"><input name="question6"
                                                                            type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question6 == "No" ||
                                                                    $exam->question6 == "0" ? "checked" : "" @endphp>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    ...
                                                                    <td align="center"><input name="question7"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question7 == "Yes" ||
                                                                    $exam->question7 == "1" ? "checked" : "" @endphp>
                                                                    </td>
                                                                    <td align="center"><input name="question7"
                                                                            type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            ...
                                                                            @php echo
                                                                        $exam->question7 == "No" ||
                                                                    $exam->question7 == "0" ? "checked" : "" @endphp>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" valign="top"><input
                                                                            ...
                                                                            style="width: 20px; height: 20px;"
                                                                            id="question8" value="1"
                                                                            @php echo
                                                                        $exam->question8 == "Yes" ||
                                                                    $exam->question8 == "1" ? "checked" : ""; @endphp>
                                                                    </td>
                                                                    <td align="center" valign="top"><input
                                                                            name="question8" type="radio"
                                                                            style="width: 20px; height: 20px;"
                                                                            id="question8" value="0"
                                                                            @php echo
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <textarea name="bmi_recommendation" id="bmi_recommendation" cols="30" rows="2" class="form-control">{{ $exam->bmi_recommendation }}</textarea>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input name="systollic" type="text"
                                                                                    ...
                                                                                    placeholder="Systollic" value="{{ $exam->systollic }}"
                                                                                    size="10">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input name="diastollic" type="text"
                                                                                    ...
                                                                                    placeholder="Diastollic" value="{{ $exam->diastollic }}"
                                                                                    size="10">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input name="bp_sitting" type="text"
                                                                                    ...
                                                                                    placeholder="BP Sitting" value="{{ $exam->bp_sitting }}"
                                                                                    size="10">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input name="bp_laying_down" type="text"
                                                                                    ...
                                                                                    placeholder="BP Laying Down" value="{{ $exam->bp_laying_down }}"
                                                                                    size="10">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input name="rhythm" type="text" id="rhythm" value="NORMAL" size="10" class="form-control" value="{{ $exam->rhythm }}">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <label for="" class="form-label">Recommendation</label>
                                                                        <textarea name="pulse_rhythm_recommendation" id="pulse_rhythm_recommendation" cols="30" rows="2" class="form-control">{{ $exam->pulse_rhythm_recommendation }}</textarea>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <label for="" class="form-label">Recommendation</label>
                                                                        <textarea name="respiration_recommendation" id="respiration_recommendation" cols="30" rows="2" class="form-control">{{ $exam->respiration_recommendation }}</textarea>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        {{-- <table width="100%" border="0" cellspacing="2"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width="14%" align="center"><b>BLOOD
                                                                            PRESSURE</b>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="7">
                                                                        ...
                                                                        <textarea name="vital_sign_recommendation" id="vital_sign_recommendation" cols="10" rows="3"
                                                                            class="form-control">{{ $exam->vital_sign_recommendation }}</textarea>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table> --}}
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="203"><input name="summary_medexam" type="radio"
                                                            style="width: 20px; height: 20px;" id="summary_medexam"
                                                            value="passed"
                                                            @php echo
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="203"><input name="summary_labtest" type="radio"
                                                            style="width: 20px; height: 20px;" id="summary_labtest"
                                                            value="passed"
                                                            @php echo
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <select
                                                                                                                                        ...
                                                                                                                                        @foreach ($physicians as $physician)
                                                                                                                                            <option
                                                                                                                                                value={{ $physician->id }}
                                                                                                                                                {{ $physician->id == $exam->technician_id ? 'selected' : null }}>
                                                                                                                                                {{ $physician->firstname }}
                                                                                                                                                {{ $physician->lastname }}
                                                                                                                                            </option>
                                                                                                                                        @endforeach
