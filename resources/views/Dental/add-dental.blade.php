                                ...
                                <tbody>
                                    <tr>
                                        <td align="center"><input readonly onfocus="makeInput(this, 'dentition18')" class="upper-input" name="tooth18" type="text" id="tooth18"
                                                value="" style="width: 40px; font-size: 12px; font-weight: 600;"></td>
                                    ...
                                    <tr>
                                        <td align="center" valign="top"><img
                                                ...
                                                height="115" alt=""></td>
                                        <td align="center" valign="top"><img src="../../../app-assets/images/dental/tno17.jpg" width="29" height="110" alt=""></td>
                                        <td align="center" valign="top"><img
                                    ...
                                    <tr>
                                        <td align="center"><input readonly onfocus="makeInput(this, 'dentition48')" class="lower-input" name="tooth48" type="text" id="tooth21"
                                                value="" style="width: 30px; font-size: 12px; font-weight: 600;"></td>
                                    ...
                                    <div class="row table">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <input type="date" id="date" name="dates[]" class="form-control">
                                                    </td>
                                                    <td>
