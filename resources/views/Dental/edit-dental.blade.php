                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        @foreach ($errors->all() as $error)
                            ...
                            @endpush
                        @endforeach
                        <form action="/upload_dental" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_dental_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
...
echo $exam->hygiene == 'Fair' ? "checked" : "" @endphp>
                                            ...
                                            <td width="342" colspan="3"><input name="hygiene" type="radio"
                                                    id="radio3" value="Bad"
                                                    @php echo $exam->hygiene == 'Bad' ? "checked" : "" @endphp>
                                                Bad </td>
                                        </tr>
                                        <tr>
...
echo $exam->gingiva == 'Firm' ? "checked" : "" @endphp>
                                                Firm</td>
                                            <td><input name="gingiva" type="radio" id="radio5"
                                                    value="Hyper Plastic"
                                                    @php
echo $exam->gingiva == 'Hyper Plastic' ? "checked" : "" @endphp>
                                            ...
                                            <td colspan="3"><input name="gingiva" type="radio" id="radio6"
                                                    value="Smooth"
                                                    @php echo $exam->gingiva == 'Smooth' ? "checked" : "" @endphp>
                                                Smooth </td>
                                        </tr>
                                        <tr>
...
echo $exam->color == 'Pink' ? "checked" : "" @endphp>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><input name="tongue" type="radio" id="radio9"
                                                    value="Normal"
                                                    @php echo $exam->tongue == 'Normal' ? "checked" : "" @endphp>
                                                Normal</td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="date" name="dates[]" id=""
                                                                        value="{{ $dental_service->date }}"
                                                                        class="form-control">
                                                                </td>
                                                                <td>
                                                                    <select class="form-control" name="services[]">
                                                                        <option
                                                                            {{ $dental_service->service == 'OP' ? 'selected' : null }}
                                                                            value="OP">OP</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'restoration' ? 'selected' : null }}
                                                                            value="restoration">restoration</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'extraction' ? 'selected' : null }}
                                                                            value="extraction">extraction</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'RCT' ? 'selected' : null }}
                                                                            value="RCT">RCT</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'denture' ? 'selected' : null }}
                                                                            value="denture">denture</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'crown' ? 'selected' : null }}
                                                                            value="crown">crown</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'X-Ray' ? 'selected' : null }}
                                                                            value="X-Ray">X-Ray</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'Temporary Restoration' ? 'selected' : null }}
                                                                            value="Temporary Restoration">Temporary
                                                                            Restoration</option>
                                                                        <option
                                                                            {{ $dental_service->service == 'Cementation' ? 'selected' : null }}
                                                                            value="Cementation">Cementation</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control"
                                                                        value="{{ $dental_service->teeth }}"
                                                                        name="teeth[]">
                                                                </td>
                                                                <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-control" name="services[]">
                                                                    ...
                                                                    <option value="Temporary Restoration">Temporary
                                                                        Restoration</option>
