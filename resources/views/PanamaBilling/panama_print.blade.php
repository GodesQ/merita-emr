                                ...
                                <tbody>
                                    <tr>
                                        <td width="80%" style="font-size: 10px; text-decoration: underline;">
                                            {{$agency ? $agency->agencyname : 'All Agency'}} (PANAMA)
                                        </td>
                                ...
                                <table width="100%" cellpadding="2" cellspacing="0" class="brdBtm soa-table" border="0" style="margin-top: 1rem;">
                                    <tbody>
                                        ...
                                        <?php
                                            $total = 0;
                                            $patient_count = 1;
                                            $currency = optional($agency)->id == 22 ? 'Pesos' : 'Dollar';
                                        ?>
                                        @forelse($collected_patient as $patient)
                                            <tr>
                                                ...
                                                <td valign="top" align="left">{{ optional($patient->patient)->lastname }}</td>
                                                <td valign="top" align="left">{{ optional($patient->patient)->firstname }}</td>
                                                <td valign="top" align="left" class="brdRight">{{ optional($patient->patient)->middlename }}</td>
                                                <td valign="top" align="left" class="brdRight">{{ $patient->panama_certno }}</td>
                                                <td valign="top" align="left" class="brdRight">
                                                    <?php
                                                        $total += 20;
                                                        echo '$ 20.00';
                                        ...
                                        <tr>
                                            ...
                                            <td class="brdTop brdRight" colspan="1">
                                                ...
                                                @else
                                                    @if($currency == 'Pesos')
                                                        <div>$ {{ optional($agency)->id == 22 ? number_format($sub_amount, 2) : number_format($amount, 2) }}</div>
                                                        <div style="margin: 5px 0;">$ <?php echo number_format((float)59, 2); ?></div>
                                                        <hr>
                                                        {{ $currency == 'Pesos' ? '₱' : '$' }} <?php echo number_format((float)$total, 2); ?>
                                                    @else
                                                        {{ $currency == 'Pesos' ? '₱' : '$' }} <?php echo number_format((float)$total, 2); ?>
