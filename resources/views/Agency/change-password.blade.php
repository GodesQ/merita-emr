                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="/store_password" method="POST">
                                        @csrf
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="feather icon-user"></i>Change
                                                    Password</h4>
                                                <div class="row">
                                                    <div class="col-md-12">
                                            ...
                                            <div class="form-actions">
                                                <a href="/agency_logout" class="btn btn-warning mr-1">
