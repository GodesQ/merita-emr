                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <textarea name="findings" id="findings" cols="50" rows="3" class="form-control">No Active parenchymal infiltrates are seen.
...
Mediastinum, diaphragm, and bony thorax are unremarkable.</textarea>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <textarea name="impression" id="impression" cols="50" rows="3" class="form-control">Essentially Normal Chest.</textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="form-group skull_group">
                                                                    <input name="skull_remark_status" type="radio"
                                                                        class="m-1" id="skull_remark_status_0"
                                                                        value="normal">Normal
                                                                    <input name="skull_remark_status" type="radio"
                                                                        class="m-1" id="skull_remark_status_1"
                                                                        value="findings">With Findings
                                                                </div>
                                                                <div class="form-group nasal_group">
                                                                    <input name="nasal_remark_status" type="radio"
                                                                        class="m-1" id="nasal_remark_status_0"
                                                                        value="normal">Normal
                                                                    <input name="nasal_remark_status" type="radio"
                                                                        class="m-1" id="nasal_remark_status_1"
                                                                        value="findings">With Findings
                                                                </div>
                                                                <div class="form-group chest_group">
                                                                    <input name="chest_remark_status" type="radio"
                                                                        class="m-1" id="chest_remark_status_0"
                                                                        value="normal">Normal
                                                                    <input name="chest_remark_status" type="radio"
                                                                        class="m-1" id="chest_remark_status_1"
                                                                        value="findings">With Findings
                                                                </div>
                                                                <div class="form-group lumbosacral_group">
                                                                    <input name="lumbosacral_remark_status" type="radio"
                                                                        class="m-1" id="lumbosacral_remark_status_0"
                                                                        value="normal">Normal
                                                                    <input name="lumbosacral_remark_status" type="radio"
                                                                        class="m-1" id="lumbosacral_remark_status_1"
                                                                        value="findings">With Findings
                                                                </div>
                                                                <div class="form-group knees_group">
                                                                    <input name="knees_remark_status" type="radio"
                                                                        class="m-1" id="knees_remark_status_0"
                                                                        value="normal">Normal
                                                                    <input name="knees_remark_status" type="radio"
                                                                        class="m-1" id="knees_remark_status_1"
                                                                        value="findings">With Findings
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div class="form-group skull_group">
                                                                    ...
                                                                    <textarea placeholder="Findings" class="form-control" name="skull_findings" id="" cols="30"
                                                                        rows="6"></textarea>
                                                                </div>
                                                                <div class="form-group nasal_group">
                                                                    <label class="font-weight-bold">Nasal Findings</label>
                                                                    <textarea placeholder="Findings" class="form-control" name="nasal_findings" id="" cols="30"
                                                                        rows="6"></textarea>
                                                                </div>
                                                                <div class="form-group chest_group">
                                                                    <label class="font-weight-bold">Chest Findings</label>
                                                                    <textarea placeholder="Findings" class="form-control" name="chest_findings" id="" cols="30"
                                                                        rows="6"></textarea>
                                                                </div>
                                                                <div class="form-group lumbosacral_group">
                                                                    <label class="font-weight-bold">Lumbosacral
                                                                        Findings</label>
                                                                    <textarea placeholder="Findings" class="form-control" name="lumbosacral_findings" id="" cols="30"
                                                                        rows="6"></textarea>
                                                                </div>
                                                                <div class="form-group knees_group">
                                                                    <label class="font-weight-bold">Knees Findings</label>
                                                                    <textarea placeholder="Findings" class="form-control" name="knees_findings" id="" cols="30"
                                                                        rows="6"></textarea>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        @if (!in_array(session()->get('position'), [18, 17, 8, 6, 2]))
                                                            <tr>
                                                                <td>
                                                                    <div class="form-group skull_group">
                                                                        <label class="font-weight-bold">Skull
                                                                            Recommendation</label>
                                                                        <textarea placeholder="Skull Recommendation" class="form-control" name="skull_recommendations" id=""
                                                                            cols="30" rows="6"></textarea>
                                                                    </div>
                                                                    <div class="form-group nasal_group">
                                                                        <label class="font-weight-bold">Nasal
                                                                            Recommendation</label>
                                                                        <textarea placeholder="Nasal Recommendation" class="form-control" name="nasal_recommendations" id=""
                                                                            cols="30" rows="6"></textarea>
                                                                    </div>
                                                                    <div class="form-group chest_group">
                                                                        <label class="font-weight-bold">Chest
                                                                            Recommendation</label>
                                                                        <textarea placeholder="Chest Recommendation" class="form-control" name="chest_recommendations" id=""
                                                                            cols="30" rows="6"></textarea>
                                                                    </div>
                                                                    <div class="form-group lumbosacral_group">
                                                                        <label class="font-weight-bold">Lumbosacral
                                                                            Recommendation</label>
                                                                        <textarea placeholder="Lumbosacral Recommendation" class="form-control" name="lumbosacral_recommendations"
                                                                            id="" cols="30" rows="6"></textarea>
                                                                    </div>
                                                                    <div class="form-group knees_group">
                                                                        <label class="font-weight-bold">Knees
                                                                            Recommendation</label>
                                                                        <textarea placeholder="Knees Recommendation" class="form-control" name="knees_recommendations" id=""
                                                                            cols="30" rows="6"></textarea>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <td width="76%">
                                                                <div class="col-md-8">
                                                                    <select name="technician_id" id="technician_id"
                                                                        class="form-control">
                                                                        <option value="12">Missilie D. Dizon, RXT
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            </td>
...
@push('scripts')
    <script type="text/javascript">
        ...
        const arrExamCView = ["PA 11 X 14", "PA 14 X 14", "PA 14 X 14", "AP", "Lateral", "AP/LAT", "APL (Lordotic)",
            "Spot Film", "Lateral Decubitus"
        ];
        ...
        const arrExamUEType = ["Clavicle", "Scapula", "Shoulder", "Humerus", "Elbow Joint", "Forearm", "Wrist Joint",
            "Hands/Fingers"
        ]
