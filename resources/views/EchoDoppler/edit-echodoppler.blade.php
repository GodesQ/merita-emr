                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Edit 2D Echo Doppler</h3>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a href="patient_edit?id={{ $patient->id }}&patientcode={{ $exam->patientcode }}" class="btn btn-primary">Back to Patient</a>
                                    <button onclick='window.open("/exam_echodoppler_print?id={{$exam->admission_id}}", "width=800,height=650").print()' class="btn btn-dark btn-solid" title="Print">Print</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-content p-2">
                        <form name="frm" method="post" action="/update_echodoppler" role="form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><input name="rwt" type="text" id="rwt"
                                                value="{{ $exam->rwt }}" class="form-control" style="width:50px"></td>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="left">RV</td>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="85%"><textarea name="interpretation"
                                                                id="interpretation" cols="50" rows="4"
                                            ...
                                            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="85%"><textarea name="doppler"
                                                                id="doppler" cols="50" rows="4"
                                                                class="form-control">{{ $exam->doppler }}</textarea>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
