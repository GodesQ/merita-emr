                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_crf_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="sbp_result" type="text" class="form-control"
                                                    id="sbp_result" value="{{ $exam->sbp_result }}"></td>
                                            <td><input name="sbp_points" type="text" class="form-control"
                                                    id="sbp_points" value="{{ $exam->sbp_points }}"></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td><b>5. SMOKER</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="diabetes_result" type="radio" id="diabetes_result_0"
                                                    value="(-)"
                                                    @php echo $exam->diabetes_result == '(-)' ? 'checked' : '' @endphp>
                                                (-)
                                        ...
                                        <tr>
                                            <td><b>7. ECG-LVH</b></td>
                                            <td>
                                                <input name="ecg_result" type="radio" id="ecg_result_0" value="(-)"
                                                    @php
echo $exam->ecg_result == '(-)' ? 'checked' : '' @endphp>
                                                (-)
                                                <input name="ecg_result" type="radio" id="ecg_result_1" value="(+)"
                                                    @php
echo $exam->ecg_result == '(+)' ? 'checked' : '' @endphp>
                                                (+)
                                            </td>
                                            <td><input name="ecg_points" type="text" class="form-control"
                                                    id="ecg_points" value="{{ $exam->ecg_points }}"></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td><b>PROBABILITY</b></td>
                                            <td><input name="probability" type="text" class="form-control"
                                                    id="probability" value="{{ $exam->probability }}"></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="fev1_actual" type="text" class="form-control"
                                                    id="fev1_actual" value="{{ $exam->fev1_actual }}"></td>
                                            <td><input name="fev1_perc" type="text" class="form-control"
                                                    id="fev1_perc" value="{{ $exam->fev1_perc }}"></td>
                                            <td align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>FVC </td>
                                            ...
                                            <td><input name="fvc_actual" type="text" class="form-control"
                                                    id="fvc_actual" value="{{ $exam->fvc_actual }}"></td>
                                            <td><input name="fvc_perc" type="text" class="form-control"
                                                    id="fvc_perc" value="{{ $exam->fvc_perc }}"></td>
                                            <td align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>FEV1/ FVC % </td>
                                                                    ...
                                                                    <select required name="technician_id"
                                                                        ...
                                                                        @foreach ($nurses as $nurse)
                                                                            <option value={{ $nurse->id }}
                                                                                {{ $nurse->id == $exam->technician_id ? 'selected' : null }}>
                                                                                {{ $nurse->firstname }}
                                                                                {{ $nurse->lastname }} {{ $nurse->title }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select required name="technician2_id"
                                                                        ...
                                                                        <option
                                                                            ...
                                                                            value="2">Teresita F. Gonzales, MD
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            </td>
