                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group hartmann-group">
                                                <label for="">Hartmann Principals <span class="primary" style="font-size: 12px; font-style:italic;">(This is for Hartmann Agency Only)</span></label>
                                                <select name="hartmann_principal"  class="select2 hartmann-select-principals">
