                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input name="exam" id="exam" type="text"
                                                    value="{{ $exam->exam }}" class="form-control">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="12%" align="left"><b>RESULT</b></td>
                                            <td width="88%">
                                                <textarea name="result" id="result" cols="50" rows="4" class="form-control">{{ $exam->result }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="left">
                                                <table width="100%" border="0" cellspacing="2" cellpadding="4">
                                                    <tbody>
                                                        <tr>
                                                            <td width="34%"><b>Test</b></td>
                                                            <td width="34%"><b>Result</b></td>
                                                            <td width="32%"><b>Normal Value</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <textarea name="col1" id="result2" cols="38" rows="6" class="form-control">{{ $exam->col1 }}</textarea>
                                                            </td>
                                                            <td>
                                                                <textarea name="col2" id="col" cols="38" rows="6" class="form-control">{{ $exam->col2 }}</textarea>
                                                            </td>
                                                            <td>
                                                                <textarea name="col3" id="col2" cols="38" rows="6" class="form-control">{{ $exam->col3 }}</textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
