                    ...
                    <td>
                        ...
                        <table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                ...
                                <tr>
                                    <td height="100" align="center"><span class="lblReport">SPIROMETRY RESULTS
                                        </span></td>
                                </tr>
                                <tr>
                                    <td align="center">
                                        <table width="425" border="0" cellspacing="0" cellpadding="2">
                                            <tbody>
                                                <tr>
                                                    <td width="87">&nbsp;</td>
                                                    <td width="94" align="center" class="brdLeftTopBtm">
                                                        <b>Predicted</b>
                                                    </td>
                                                    <td width="107" align="center" class="brdLeftTopBtm">
                                                        <b>Actual</b>
                                                    </td>
                                                    <td width="95" align="center" class="brdLeftTopBtm"><b>%</b>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>FEV1/ FVC % </td>
                                                    <td height="60" align="center" class="brdLeftBtm">
                                                        {{ $exam->fev1fvc_predicted }}</td>
                                                    <td height="60" align="center" class="brdLeftBtm">
                                                        {{ $exam->fev1fvc_actual }}</td>
                                                    <td height="60" align="center" class="brdLeftBtm">
                                                        {{ $exam->fev1fvc_perc }}</td>
                                                    <td align="center" class="brdLeft">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
