                            ...
                            <tr>
                                <td align="center">
                                            ...
                                            <td width="78%">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" align="left"><b> INTELECTUAL LEVEL:</b>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td><b>II.</b></td>
                                                        <td colspan="4"><b>PERSONALITY TRAITS AND
                                                                CHARACTERISTICS</b></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="22%" align="center"><img
                                                    src="../../../app-assets/images/imgPsychoLegend.jpg"
                                                    alt="" width="102" height="134" class="brdAll" />
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" border="0" cellpadding="1" cellspacing="0"
                                        ...
                                        <tr>
                                            <td>Relationship with Superiors, Employers and Authority Figures(Deference)
                                            </td>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    @if (
                                                                        ...
                                                                        <img src="../../../app-assets/images/signatures/psychometrician_sig.png"
                                                                            width="220" height="60"
                                                                            style="object-fit: cover; transform: translate(0px, 30px);" />
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            <tr valign="bottom">
                                                                <td align="center" class="brdTop">
                                                                    {{ $technician1 ? $technician1->firstname . ' ' . $technician1->middlename[0] . '.' . ' ' . $technician1->lastname . ', ' . $technician1->title : '' }}<br>
                                                                    Psychometrician</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                                ...
                                                                <td align="center">
                                                                    @if (
                                                                        $admission->agency_id == 3 ||
                                                                            ...
                                                                            $admission->agency_id == 57 ||
                                                                            $admission->agency_id == 58)
                                                                        <img src="../../../app-assets/images/signatures/psychological_sig.png"
                                                                            width="220" height="60"
                                                                            style="object-fit: cover; transform: translate(0px, 10px);" />
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            <tr valign="bottom">
                                                                <td align="center" class="brdTop">
                                                                    {{ $technician2 ? $technician2->firstname . ' ' . $technician2->middlename[0] . '.' . ' ' . $technician2->lastname . ', ' . $technician2->title : '' }}<br>
                                                                    Psychologist</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
