                ...
                <tr>
                    <td>
                        ...
                        <table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
                                    ...
                                    <table width="100%" border="0" cellpadding="30" cellspacing="0">
                                        ...
                                        @if ($exam->exam_type == 'KUB')
                                            <tr>
                                                ...
                                                <td valign="top">{!! nl2br(e($exam->kidney)) !!}</td>
                                            </tr>
                                            <tr>
                                                <td valign="top"><b>URETER/URINARY BLADDER</b></td>
                                                <td valign="top">{!! nl2br(e($exam->urinary_bladder)) !!}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($exam->exam_type == 'HEPA')
                                            <tr>
                                                ...
                                                <td valign="top">{!! nl2br(e($exam->liver)) !!}</td>
                                            </tr>
                                            <tr>
                                                <td valign="top"><b>GALLBLADDER</b></td>
                                                <td valign="top">{!! nl2br(e($exam->gall_bladder)) !!}</td>
                                            </tr>
                                            <tr>
                                                <td valign="top"><b>PANCREAS</b></td>
                                                <td valign="top">{!! nl2br(e($exam->pancreas)) !!}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($exam->exam_type == 'THYROID')
                                            <tr>
                                                ...
                                                <td valign="top">{!! nl2br(e($exam->thyroid)) !!}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($exam->exam_type == 'BREAST')
                                            <tr>
                                                ...
                                                <td valign="top">{!! nl2br(e($exam->breast)) !!}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($exam->exam_type == 'WHOLE ABDOMEN')
                                            <tr>
                                                ...
                                                <td valign="top">{!! nl2br(e($exam->abdomen)) !!}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($exam->exam_type == 'GENITALS')
                                            <tr>
                                                ...
                                                <td valign="top">{!! nl2br(e($exam->genitals)) !!}</td>
                                            </tr>
                                        @endif

                                        <tr>
                                            <td valign="top"><b>IMPRESSION</b></td>
                                            <td valign="top">{!! nl2br(e($exam->impression)) !!}</td>
                                        </tr>
                            ...
                            <tr>
                                <td height="60"><span class="lblForm">FORM NO. 35<br>REV. 02 / 06-15-2022</span>
                                </td>
                            </tr>
                        </table>
