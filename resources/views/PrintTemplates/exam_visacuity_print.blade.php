                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="218" valign="top" class="brdLeftBtm"><b>NAME:</b><br>
                                        <span
                                            style="font-size:15px; text-transform: uppercase;">{{$admission->patient->lastname . " " . $admission->patient->suffix . ', ' . $admission->firstname . " " . $admission->patient->middlename}}</span>
                                    </td>
