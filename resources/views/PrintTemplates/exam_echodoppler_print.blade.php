                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="218" valign="top" class="brdLeftBtm"><b>NAME:</b><br>
                                        <span style="font-size:15px; text-transform: uppercase;">{{$admission->patient->lastname . " " . $admission->patient->suffix . ', ' . $admission->patient->firstname . " " . $admission->patient->middlename}}</span>
                                    </td>
                                        ...
                                        <table width="100%" cellpadding="2" cellspacing="0" class="brdTable">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="12%">L1</td>
                                                    <td>
                                                        <input name="l1" type="text" id="l1" value="{{$exam->l1}}" class="brdNone" style="width:50px;text-align:center;">
                                                    </td>
                                                    <td width="8%">LVMI</td>
                                                    <td align="center">
                                                        @if($exam->lvmi)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>L2</td>
                                                    <td>
                                                        <input name="l2" type="text" id="l2" value="{{$exam->l2}}" class="brdNone" style="width:50px;text-align:center;">
                                                    </td>
                                                    <td>RWT</td>
