  ...
  <center>
    <table width="760" border="0" cellspacing="0" cellpadding="0">
      <tbody>
                ...
                <tr>
                  ...
                  <td width="218" valign="top" class="brdLeftBtm"><b>NAME:</b><br>
                    <span style="font-size:15px; text-transform: uppercase;">
                      {{ $admission->patient->lastname . ' ' . $admission->patient->suffix . ', ' . $admission->patient->firstname . ' ' . $admission->patient->middlename }}</span>
                  </td>
        ...
        <tr>
          <td height="27" colspan="3" align="left" valign="top" class="brdLeftBtm"><b>REQUESTED
              BY:</b><br>
        ...
        <tr>
          ...
          <td colspan="2" align="left" valign="top" class="brdLeft"><b>PATIENT NO:</b><br><span
              style="font-size:15px">{{ $admission->patient->patientcode }}</span></td>
        </tr>
      </tbody>
    </table>
    </td>
                            ...
                            <tr>
                              <td width="300" valign="top">
                                <table width="260" border="0" cellspacing="2" cellpadding="2">
                                  <tbody>
                                    <tr>
                                      <td height="50" align="center" style="border-bottom: 1px solid black;"
                                        valign="bottom">
                                        @if ($technician1)
                                          @if ($technician1->signature)
                                            <img src="{{ $technician1->signature }}" width="97"
                                      ...
                                      <td height="50" align="center" style="border-bottom: 1px solid black;"
                                        ...
                                        @if ($technician2)
                                          @if ($technician2->signature)
                                            <img src="{{ $technician2->signature }}" width="70"
                                              style="object-fit: cover;" />
                                          @else
                                            <div style="width: 150px;height: 20px;">
                                            </div>
