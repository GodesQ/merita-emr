                                ...
                                <tr>
                                    <td height="26" align="left" valign="top" class="brdLeft"><b>PEME
                                        ...
                                        @if ($type == 'serology')
                                            @if ($exam_sero)
                                                <span
                                                    style="font-size:15px">{{ date_format(new DateTime($exam_sero->trans_date), 'd F Y') }}</span>
                                            @endif
                                        @endif
                                        ...
                                        @if ($type == 'blood')
                                            @if ($exam_blood)
                                                <span
                                                    style="font-size:15px">{{ date_format(new DateTime($exam_blood->trans_date), 'd F Y') }}</span>
                                            @endif
                                        @endif
                            ...
                            <tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (optional($exam_blood)->hba1c)
                                                        <tr>
                                                            <td>HBA1C</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->hba1c < 4.0 || optional($exam_blood)->hba1c > 6.5 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->ppbg)
                                                        <tr>
                                                            <td>2hrs. PPBG</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->ppbg > 200 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->fbs)
                                                        <tr>
                                                            <td>FBS</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->fbs < 70 || optional($exam_blood)->fbs > 110 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->bun)
                                                        <tr>
                                                            <td>BUN</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->bun < 5 || optional($exam_blood)->bun > 20 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->creatinine)
                                                        <tr>
                                                            <td>CREATININE</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->creatinine < 0.8 || optional($exam_blood)->creatinine > 1.2 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->cholesterol)
                                                        <tr>
                                                            <td>CHOLESTEROL</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->cholesterol < 125 || optional($exam_blood)->cholesterol > 200 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->triglycerides)
                                                        <tr>
                                                            <td>TRIGLYCERIDES</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->triglycerides < 35 || optional($exam_blood)->triglycerides > 160 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->hdl)
                                                        <tr>
                                                            <td>HDL Chole</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->hdl < 40 ? 'red-text' : null }}">
                                                                {{ optional($exam_blood)->hdl }}
                                                                {{ optional($exam_blood)->hdl < 40 ? 'L' : null }}
                                                            </td>
                                                            <td>
                                                                >40 mg/dL
                                                            </td>
                                                    ...
                                                    @if (optional($exam_blood)->ldl)
                                                        <tr>
                                                            <td>LDL Chole</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->ldl > 100 ? 'red-text' : null }}">
                                                                {{ optional($exam_blood)->ldl }}
                                                                {{ optional($exam_blood)->ldl > 100 ? 'H' : null }}
                                                            </td>
                                                            <td>
                                                                < 100 mg/dL </td>
                                                        </tr>
                                                    ...
                                                    @if (optional($exam_blood)->vldl)
                                                        <tr>
                                                            <td>VLDL Chole</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->vldl < 7 || optional($exam_blood)->vldl > 32 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->uricacid)
                                                        <tr>
                                                            <td>URIC ACID</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->uricacid < 140 || optional($exam_blood)->uricacid > 430 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->sgot)
                                                        <tr>
                                                            <td>SGOT (AST)</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->sgot < 0 || optional($exam_blood)->sgot > 40 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->sgpt)
                                                        <tr>
                                                            <td>SGPT (ALT) </td>
                                                            <td
                                                                class="{{ optional($exam_blood)->sgpt < 0 || optional($exam_blood)->sgpt > 41 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->ggt)
                                                        <tr>
                                                            <td>GGT</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->ggt < 0 || optional($exam_blood)->ggt > 55 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->alkphos)
                                                        <tr>
                                                            <td>ALK. PHOS.</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->alkphos < 35 || optional($exam_blood)->alkphos > 129 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->ttlbilirubin)
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="{{ optional($exam_blood)->ttlbilirubin < 5 || optional($exam_blood)->ttlbilirubin > 21 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->dirbilirubin)
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="{{ optional($exam_blood)->dirbilirubin < 0 || optional($exam_blood)->dirbilirubin > 5.1 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->indbilirubin)
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="{{ optional($exam_blood)->indbilirubin < 0 || optional($exam_blood)->indbilirubin > 16 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->ttlprotein)
                                                        <tr>
                                                            <td>TOTAL PROTEIN</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->ttlprotein < 66 || optional($exam_blood)->ttlprotein > 87 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->albumin)
                                                        <tr>
                                                            <td>ALBUMIN</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->albumin < 35 || optional($exam_blood)->albumin > 52 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->globulin)
                                                        <tr>
                                                            <td>GLOBULIN</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->globulin < 31 || optional($exam_blood)->globulin > 35 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->sodium)
                                                        <tr>
                                                            <td>SODIUM</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->sodium < 135 || optional($exam_blood)->sodium > 148 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->potassium)
                                                        <tr>
                                                            <td>POTASSIUM</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->potassium < 3.5 || optional($exam_blood)->potassium > 5.3 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->chloride)
                                                        <tr>
                                                            <td>CHLORIDE</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->chloride < 96 || optional($exam_blood)->chloride > 108 ? 'red-text' : null }}">
                                                    ...
                                                    @if (optional($exam_blood)->calcium)
                                                        <tr>
                                                            <td>CALCIUM</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->calcium < 2.1 || optional($exam_blood)->calcium > 2.9 ? 'red-text' : null }}">
                                                                {{ optional($exam_blood)->calcium }}
                                                                @if (optional($exam_blood)->calcium < 2.1)
                                                                    L
                                                                @endif
                                                                @if (optional($exam_blood)->calcium > 2.9)
                                                                    H
                                                                @endif
                                                            </td>
                                                            <td>
                                                    ...
                                                    @if (optional($exam_blood)->ag_ratio)
                                                        <tr>
                                                            <td>CALCIUM</td>
                                                            <td
                                                                class="{{ optional($exam_blood)->ag_ratio < 0.6 || optional($exam_blood)->ag_ratio > 1.7 ? 'red-text' : null }}">
                                ...
                                <tr>
                                    @if ($type == 'both' || $type == 'serology')
                                        <td height="15" align="center"><span class="lblReport">SEROLOGY</span>
                                        </td>
                                    @endif
                                </tr>
                                <tr>
                                    <td>
                                        @if ($type == 'both' || $type == 'serology')
                                            <table width="760" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width="196" align="left" class="">
                                                            <b>EXAMINATION</b></td>
                                                        <td width="191" align="left" class="">
                                                            <b>RESULTS</b></td>
                                                        <td width="172" align="center" class=""><b>CUT OFF
                                                                VALUE</b></td>
                                                        <td width="169" align="center" class=""><b>PATIENT'S
                                                                VALUE</b></td>
                                                    </tr>
                                                    ...
                                                    @if (optional($exam_sero)->hbsag_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->hbsag_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->hbsag_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->hbsag_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->antihcv_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->antihcv_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihcv_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihcv_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->antihavlgm_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->antihavlgm_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihavlgm_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihavlgm_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->antihavlgg_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->antihavlgg_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->aantihavlgg_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihavlgg_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->tpha_result)
                                                        <tr>
                                                            ...
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->tpha_cutoff }} </td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->tpha_value }} </td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->antihbs_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->antihbs_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbs_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbs_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->hbeag_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->hbeag_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->hbeag_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->hbeag_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->antihbe_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->antihbe_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbe_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbe_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->antihbclgm_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->antihbclgm_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbclgm_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbclgm_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->antihbclgg_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->antihbclgg_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbclgg_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->antihbclgg_value }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (optional($exam_sero)->sothers_result)
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                {{ $exam_sero->sothers_result }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->sothers_cutoff }}</td>
                                                            <td align="center" valign="top">
                                                                {{ $exam_sero->sothers_value }}</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                            </table>
                                                                        ...
                                                                        @if ($technician1)
                                                                            @if ($technician1->signature)
                                                                                <img src="{{ $technician1->signature }}"
                                                                                    width="170"
                                                                                    style="object-fit: cover; transform: translate(0px, 20px);" />
                                                                            @endif
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table width="260" border="0" cellspacing="2"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center">
                                                                        @if (
                                                                            $admission->agency_id == 3 ||
                                                                                $admission->agency_id == 55 ||
                                                                                $admission->agency_id == 57 ||
                                                                                $admission->agency_id == 58)
                                                                            <img src="../../../app-assets/images/signatures/noel_lab_sig.png"
                                                                                width="240" height="90"
                                                                                style="object-fit: cover; transform: translate(0px, 40px);" />
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                <tr valign="bottom">
