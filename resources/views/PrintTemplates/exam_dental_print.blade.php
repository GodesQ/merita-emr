@php
    function encircle($val, $num)
    {
        echo $val == ''
            ? $num
            : '<span style="border-radius:50%; border:solid black 1px;padding:5px">' . $num . '</span>';
    }
@endphp
                                    ...
                                    <td align="center">
                                        <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td align="center"></td>
                                                    <td colspan="2" align="center"><b><u>SHORT MEDICAL
                                                                HISTORY</u></b>
                                                    </td>
                                                    <td align="center"></td>
                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno18.jpg"
                                                                                            width="16"
                                                                                            height="105"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno17.jpg"
                                                                                            width="19"
                                                                                            height="100"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno15.jpg"
                                                                                            width="20"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    ...
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno14.jpg"
                                                                                            width="18"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno13.jpg"
                                                                                            width="20"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno12.jpg"
                                                                                            width="25"
                                                                                            height="136"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno11.jpg"
                                                                                            width="23"
                                                                                            height="124"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno21.jpg"
                                                                                            width="20"
                                                                                            height="115"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno22.jpg"
                                                                                            width="22"
                                                                                            height="115"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno23.jpg"
                                                                                            width="19"
                                                                                            height="106"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno24.jpg"
                                                                                            width="19"
                                                                                            height="102"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno25.jpg"
                                                                                            width="22"
                                                                                            height="105"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno26.jpg"
                                                                                            width="22"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno27.jpg"
                                                                                            width="20"
                                                                                            height="107"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno28.jpg"
                                                                                            width="22"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno48.jpg"
                                                                                            width="23"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno47.jpg"
                                                                                            width="20"
                                                                                            height="90"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno46.jpg"
                                                                                            width="23"
                                                                                            height="90"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno45.jpg"
                                                                                            width="18"
                                                                                            height="90"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno44.jpg"
                                                                                            width="22"
                                                                                            height="90"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno43.jpg"
                                                                                            width="20"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno42.jpg"
                                                                                            width="14"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno41.jpg"
                                                                                            width="21"
                                                                                            height="111"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno31.jpg"
                                                                                            width="18"
                                                                                            height="115"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno32.jpg"
                                                                                            width="23"
                                                                                            height="115"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno33.jpg"
                                                                                            width="21"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno34.jpg"
                                                                                            width="20"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno35.jpg"
                                                                                            width="23"
                                                                                            height="111"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno36.jpg"
                                                                                            width="17"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno37.jpg"
                                                                                            width="19"
                                                                                            height="110"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td align="center" valign="top">
                                                                                        <img src="../../../app-assets/images/dental/tno38.jpg"
                                                                                            width="24"
                                                                                            height="111"
                                                                                            alt="">
                                                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table width="80%" border="0" cellspacing="0"
                                                            cellpadding="0" style="border: solid 1px black">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center">
                                                                ...
                                                                @forelse($exam_services as $exam_service)
                                                                    <tr>
                                                                        <td width="21%" align="center"
                                                                            class="brdBtm">{{ $exam_service->date }}
                                                                        </td>
                                                                        <td width="59%" align="left"
                                                                            class="brdLeftBtm">
                                                                            {{ $exam_service->service }}</td>
                                                                        <td idth="20%" align="center"
                                                                            class="brdLeftBtm">
                                                                            {{ $exam_service->teeth }}</td>
                                                                    </tr>
                                                                @empty
                                                                    <tr>
