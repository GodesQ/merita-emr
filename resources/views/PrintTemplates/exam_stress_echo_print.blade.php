                      ...
                      <tbody>
                        <tr>
                          ...
                          <td width="8%" align="left"><input name="weight" type="text" id="weight"
                              value="{{ $exam->weight }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td width="7%" align="left"><b>BP</b></td>
                          <td colspan="3" align="left"><input name="bp" type="text" id="bp"
                              value="{{ $exam->bp }} size=" 15" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        </tr>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td colspan="2" align="center"><input name="lvedv_simp" type="text" id="lvedv_simp"
                              value="{{ $exam->lvedv_simp }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        ...
                        <tr>
                          ...
                          <td colspan="2" align="center"><input name="lvesv_simp" type="text" id="lvesv_simp"
                              value="{{ $exam->lvesv_simp }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td colspan="3" align="center">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td align="center"><input name="sv" type="text" id="sv" value="{{ $exam->sv }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        ...
                        <tr>
                          ...
                          <td align="center"><input name="co" type="text" id="co" value="{{ $exam->co }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        ...
                        <tr>
                          ...
                          <td align="center">(0.8 - 1.1)</td>
                          <td align="left">EF</td>
                          <td align="center"><input name="ef" type="text" id="ef" value="{{ $exam->ef }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        ...
                        <tr>
                          ...
                          <td align="center">&nbsp;</td>
                          <td align="left">FS</td>
                          <td align="center"><input name="fs" type="text" id="fs" value="{{ $exam->fs }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        ...
                        <tr>
                          ...
                          <td width="10%" colspan="2" align="center"><b>Normal</b>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>DT</td>
                          <td align="center"><input name="dt" type="text" id="dt" value="{{ $exam->dt }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td width="12%">L1</td>
                          <td width="8%">LVMI</td>
                        ...
                        <tr>
                          ...
                          <td>L2</td>
                          <td>RWT</td>
                          <td align="center"><input name="l2" type="text" id="l2" value="{{ $exam->l2 }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td colspan="2">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td>A1</td>
                          <td>&nbsp;</td>
                          <td align="center"><input name="a1" type="text" id="a1" value="{{ $exam->a1 }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td colspan="2">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td>A2</td>
                          <td>&nbsp;</td>
                          <td align="center"><input name="a2" type="text" id="a2" value="{{ $exam->a2 }}"
                              class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td colspan="2">&nbsp;</td>
                        </tr>
                    ...
                    <table width="100%" cellpadding="2" cellspacing="0" class="brdTable">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="14%" rowspan="2" align="center"><b>PEAK
                              GRADIENT<br>
                              mm Hg </b></td>
                          <td width="14%" rowspan="2" align="center"><b>ORIFIC
                              AREA<br>
                              cm2 </b></td>
                        ...
                        <tr>
                          ...
                          <td align="center"><input name="aortic_mv" id="aortic_mv" type="text"
                              value="{{ $exam->aortic_mv }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="aortic_pg" id="aortic_pg" type="text"
                              value="{{ $exam->aortic_pg }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="aortic_oa" id="aortic_oa" type="text"
                              value="{{ $exam->aortic_oa }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="aortic_vti" id="aortic_vti" type="text"
                              value="{{ $exam->aortic_vti }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="aortic_rr" id="aortic_rr" type="text"
                              value="{{ $exam->aortic_rr }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="aortic_rja" id="aortic_rja" type="text"
                              value="{{ $exam->aortic_rja }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="aortic_rg" id="aortic_rg" type="text"
                              value="{{ $exam->aortic_rg }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        </tr>
                        <tr>
                          <td align="left" valign="bottom">Mitral</td>
                          <td align="center"><input name="mitral_mv" id="mitral_mv" type="text"
                              value="{{ $exam->mitral_mv }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="mitral_pg" id="mitral_pg" type="text"
                              value="{{ $exam->mitral_pg }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="mitral_oa" id="mitral_oa" type="text"
                              value="{{ $exam->mitral_oa }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="mitral_vti" id="mitral_vti" type="text"
                              value="{{ $exam->mitral_vti }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="mitral_rr" id="mitral_rr" type="text"
                              value="{{ $exam->mitral_rr }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="mitral_rja" id="mitral_rja" type="text"
                              value="{{ $exam->mitral_rja }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                          <td align="center"><input name="mitral_rg" id="mitral_rg" type="text"
                              value="{{ $exam->mitral_rg }}" class="brdNone" style="width:50px;text-align:center;">
                          </td>
                        </tr>
                        <tr>
