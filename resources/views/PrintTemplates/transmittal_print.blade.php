    ...
    <tr>
      <td>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="11%" rowspan="2" align="left"><img src="../../../app-assets/images/logo/logo.jpg" width="116"
                height="104" alt="" /></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="left" valign="top">
                ...
                @php
                $shouldDisplayRemarks = optional($patient->exam_physical)->fit === 'Fit' || $patient->lab_status === 2;
                @endphp

                @if($shouldDisplayRemarks && $patient->medical_results->isNotEmpty())
                @foreach ($patient->medical_results->where('status', 2) as $result)
                <br /> {{ $result->remarks ?? '' }}
                @endforeach
                @endif
              </td>
              ...
              <td align="left" valign="top">
                ...
                <div style="text-align: center">
                  {{ $pe_status }} <br>
                  <b>{{ $pe_status == 'Fit to Work' ? '(' . date_format(new
                    DateTime($patient->patient->fit_to_work_date), 'M d, Y') . ')' : null }}</b>
                </div>
              </td>
              @if (in_array('vital_signs', $additional_columns))
              <td align="left">
            ...
            <tr>
              ...
              <td align="left" valign="top">
                {{-- @if (optional($patient->exam_physical)->recommendation) <b>ECG:</b> @endif {{
                optional($patient->exam_physical)->recommendation }} --}}
              </td>
              <td align="left" valign="top"></td>
              @if (in_array('vital_signs', $additional_columns))
              <td align="left"></td>
