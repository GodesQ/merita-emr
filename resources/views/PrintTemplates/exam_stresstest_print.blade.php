                            ...
                            <tr>
                                <td align="center">
                                    <table width="100%" border="1" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td width="9%" align="center"><span class="a"><b>Stage
                                                        Number</b></span></td>
                                            <td width="8%" align="center" class="table table-bordered"><b>Time
                                                    (min:sec)</b></td>
                                            <td width="8%" align="center" class="table table-bordered"><b>Speed
                                                    (km/h)</b></td>
                                            <td width="9%" align="center" class="table table-bordered"><b>Grade
                                                    (%)</b></td>
                                            <td width="8%" align="center" class="table table-bordered"><b>Workload
                                                    (METs)</b></td>
                                            <td width="9%" align="center" class="table table-bordered"><b>HR
                                                    (bpm)</b></td>
                                            <td width="9%" align="center" class="table table-bordered"><b>BP
                                                    (mmHg)</b></td>
                                            <td width="8%" align="center" class="table table-bordered"><b>RPP
                                                    (*100)</b></td>
                                            <td width="8%" align="center" class="table table-bordered"><b>VE</b>
                                            </td>
                                            <td width="8%" align="center" class="table table-bordered"><b>SVE</b>
                                            </td>
                                            <td width="8%" align="center" class="table table-bordered"><b>ST II
                                                    (mm)</b></td>
                                            <td width="8%" align="center" class="table table-bordered">
                                                <b>Comment</b></td>
                                        </tr>
                                        <tr>
                                            <td height="31" align="center"><span
                                                    class="a"><b>Pre-Exercise</b></span></td>
                                        ...
                                        <tr>
                                            <td height="31" align="center"><span class="a"><b>Stage
                                                        1</b></span></td>
                                            <td align="center"> <span class="a">
                                                    {{ $exam->stage1_speed }}
                                                </span></td>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="119" align="center"><span class="a"><b>Stage
                                                            Number</b></span></td>
                                                <td width="153" align="center"><span class="a"><b>Immediately
                                                            After</b></span></td>
                                                <td width="88" align="center"><span class="a"><b>1
                                                            minute</b></span></td>
                                                <td width="108" align="center"><span class="a"><b>3
                                                            minutes</b></span></td>
                                                <td width="92" align="center"><span class="a"><b>5
                                                            minutes</b></span></td>
                                                <td width="97" align="center"><span class="a"><b>8
                                                            minutes</b></span></td>
                                            </tr>
                                            <tr>
                                                <td height="30" colspan="0" align="center"><span
                                                        class="a"><b>BP</b></span></td>
                                                <td align="center"> <span class="a">
                                                        {{ $exam->bp_after }}
                                                    </span></td>
                                                <td align="center"> <span class="a">
                                            ...
                                            <tr>
                                                <td height="22" colspan="0" align="center"><span
                                                        class="a"><b>HR</b></span></td>
                                                <td align="center"> <span class="a">
                                                        {{ $exam->hr_after }}
                                                    </span></td>
                                                <td align="center"> <span class="a">
                                    ...
                                    <table width="100%" border="0" cellpadding="1" cellspacing="0"
                                        ...
                                        <tbody>
                                            ...
                                            {{ $exam->response }}
                                            <tr>
                                                <td height="27" colspan="2"><span class="a"><u><b>Response
                                                                Exercise:</b></u><br>
                                                        <u>
                                                            {{ $exam->symptoms }}
                                                        ...
                                                        of that predicted for maximal heart rate for the patient's age.
                                                        Starting BP was <u>
                                                            {{ $exam->starting_bp }}
