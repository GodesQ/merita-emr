...
<table width="100%" celspacing="0" cellpadding="5" align="center">
    <tbody>
        <tr>
            <td><span style="font-weight: bold; font-size: 20px; font-family: serif; text-align: center;">REFERRAL SLIP
                    FOR MEDICAL
                    EXAMINATION</span></td>
        </tr>
        <tr>
            <td><span
                    style="margin-top: -10px;text-align: center;font-weight: 400;font-size: 12px;font-family: sans-serif;">Joint
                    DOH-POEA-MARINA CONSULTATIVE
                    COMMITTEE</span></td>
        </tr>
    </tbody>
</table>
                        ...
                        <tr>
                            ...
                            <td width="60%">
                                <div style="border-bottom: 1px solid #178613; font-size: 12px;">
                                    {{ $referral ? optional($referral->agency)->agencyname : null }}</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="60%">
                                <div style="border-bottom: 1px solid #178613; font-size: 12px;">
                                    {{ $referral ? $referral->vessel : null }}</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="60%">
                                <div style="border-bottom: 1px solid #178613; font-size: 12px;">
                                    {{ $referral ? $referral->country_destination : null }}</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
            </td>
            <td style="text-align: center; border: 1px solid #178613; width: 100px; height: 110px;">
                <span>
                    @if ($referral)
                        @if ($referral->patient_image)
                            <img src="../../../app-assets/images/profiles/{{ $referral->patient_image }}"
                                alt="Patient Picture" width="100%" height="100%">
                        @endif
                    @endif
                </span>
            </td>
                        ...
                        <tr>
                            <td width="100%">
                                <div style="border-bottom: 1px solid #178613; margin-bottom: 1rem;">
                                    {{ $referral ? $referral->address : null }}
                                </div>
                ...
                <table width="100%" cellspacing="0" cellpadding="2">
                    <tbody>
                        <tr>
                            ...
                            <td style="font-weight: 400; border-bottom: 1px solid #178613;">
                                @if ($referral)
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 400; border-bottom: 1px solid #178613;">
                                {{ $referral ? $referral->passportno : null }}</td>
                        </tr>
                        <tr>
                            <td width="40%">SSRB:</td>
                            <td style="font-weight: 400; border-bottom: 1px solid #178613; ">
                                {{ $referral ? $referral->srbno : null }}</td>
                        </tr>
                        <tr>
                            <td width="40%">Cellphone #:</td>
                            <td style="font-weight: 400; border-bottom: 1px solid #178613; ">
                                {{ $referral ? $referral->contactno : null }}</td>
                        </tr>
                    </tbody>
                </table>
            </td>
    ...
    <tbody>
        <tr width="90%" style="border: 1px solid black; text-align: center;">
            ...
            <td width="75%">
                ...
                <p style="line-height: 10px;">5th floor Jettac Bldg. 920 Pres. Quirino Ave.cor. San Antonio, Malate,
                    Manila</p>
                <p style="line-height: 10px;">Tel: (02) 310-0595/404-3441 / Cell No. 0917-8576942 Email:
                    mdcinc2019@gmail.com</p>
...
<table width="100%" cellspacing="5" cellpadding="2">
    <tbody>
        ...
        <tr>
            <td width="22%">5.1 Medical Package/Test:</td>
            <td width="78%" style="text-align: left; border-bottom: 1px solid #178613;">
                {{ $referral ? optional($referral->package)->packagename : null }}</td>
        </tr>
        <tr>
            <td width="22%">5.2 Additional Request:</td>
            <td width="78%" style="text-align: left; border-bottom: 1px solid #178613;">
                {{ $referral ? $referral->custom_request : null }}</td>
        </tr>
    </tbody>
</table>
                ...
                @if ($referral)
                    @if ($referral->signature)
                        <img width="150px" height="45px" style="object-fit:cover;"
                            src="@php echo base64_decode($referral->signature) @endphp" alt="">
                    @else
                        <div></div>
                    @endif
                @else
