                ...
                <table width="100%" cellspacing="2" cellpadding="3">
                    <tbody>
                        <tr>
                            ...
                            <td width="60%">
                                <div style="border-bottom: 1px solid #467017; font-size: 12px;">{{$referral ? optional($referral->agency)->agencyname : null}}</div>
                            </td>
                        </tr>
                        <tr>
                            <td width="40%" style="font-size: 12px;">Vessel:</td>
                            <td width="60%">
                                <div style="border-bottom: 1px solid #467017; font-size: 12px;">{{$referral ? $referral->vessel : null}}</div>
                            </td>
                        </tr>
                        <tr>
                            <td width="40%" style="font-size: 12px;">Country of Destination:</td>
                            <td width="60%">
                                <div style="border-bottom: 1px solid #467017; font-size: 12px;">{{$referral ? $referral->country_destination : null}}</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
            </td>
            <td style="text-align: center; border: 1px solid #467017; width: 100px; height: 110px;">
                    <span>
                        @if($referral)
...
<table width="100%" celspacing="0" cellpadding="2" style="margin-top: 10px;">
    <tbody>
        <tr>
            <td width="33%">
                <div style="border-bottom: 1px solid #467017;  margin-bottom: 0.3rem; font-size: 12px;">
        ...
        <tr>
            <td width="71%">
                <table style="margin-top: 10px;" width="100%">
                    <tbody>
                        <tr>
                            <td width="100%">
                                <div style="border-bottom: 1px solid #467017; margin-bottom: 1rem;">{{$referral ? $referral->address : null}}
                                </div>
            ...
            <td width="29%">
                <table width="100%" cellspacing="0" cellpadding="2">
                    <tbody>
                                <tr>
                                    <td width="40%">Birthday:</td><td style="font-weight: 400; border-bottom: 1px solid #467017;">
                                        @if($referral)
                                            {{$referral->birthdate ? date_format(new DateTime($referral->birthdate), 'F d, Y') : null}}
                                        @endif
                                    </td>
                                </tr>
                                <tr><td width="40%">Passport:</td><td style="font-weight: 400; border-bottom: 1px solid #467017;">{{$referral ? $referral->passportno : null}}</td></tr>
                                <tr><td width="40%">SSRB:</td><td  style="font-weight: 400; border-bottom: 1px solid #467017; ">{{$referral ? $referral->srbno : null}}</td></tr>
                                <tr><td width="40%">Cellphone #:</td><td  style="font-weight: 400; border-bottom: 1px solid #467017; ">{{$referral ? $referral->contactno : null}}</td></tr>
                    </tbody>
                </table>
            </td>
        </tr>
...
@endphp
<table width="100%" celspacing="0" cellpadding="5" style="text-align: center; border: 1px solid #467017;" >
    <tbody>
...
<table width="100%" cellspacing="0" cellpadding="2">
    <tbody>
        ...
        <tr height="30px;">
            <td width="50%" style="text-align: center; border-bottom: 1px solid #467017">
...
<table width="100%" cellspacing="5" cellpadding="2" >
    <tbody>
        ...
        <tr>
            <td width="20%">5.1 Medical Package/Test:</td><td width="80%" style="text-align: left; border-bottom: 1px solid #467017;">{{$referral ? optional($referral->package)->packagename : null}}</td>
        </tr>
        <tr>
            <td width="20%">5.2 Additional Request:</td><td width="80%" style="text-align: left; border-bottom: 1px solid #467017;">{{$referral ? $referral->custom_request : null}}</td>
        </tr>
    </tbody>
</table>
...
<tbody>
    <tr height="30px">
        <td width="30%">&nbsp;</td>
        <td width="40%" style="text-align: center; border-bottom: 1px solid #467017;"> 
            @if($referral)
