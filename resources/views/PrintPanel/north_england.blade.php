          ...
          <table width="680" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                          <td width="87%" valign="middle">NO LIMITATIONS OR RESTRICTIONS
                            ...
                            <textarea name="co" type="text" id="co" value="" class="brdNone"
                              style="width:400px;height: 30px;font-size: 10px;text-align:left;border: none;">{{ $admission->exam_physical ? $admission->exam_physical->describe_restriction : null }}</textarea>
                          </td>
                          <td width="4%" valign="middle">YES</td>
                          <td width="3%" valign="middle">
                            @if ($admission->exam_physical)
            ...
            <tr>
              <td align="center">
                ...
                <img
                  src="../../../app-assets/images/profiles/{{ $admission->patient->patient_image . '?' . $admission->patient->updated_date }}"
              ...
              @endif
                  ...
                  @endif <br>
                                ...
                                <td><img width="130" src="../../../app-assets/images/logo/logoNOE.png">
                                </td>
                              </tr>
                            </table>
                          </td>
