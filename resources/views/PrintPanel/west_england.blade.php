                ...
                <tr>
                  ...
                  <td width="396" rowspan="3" align="center" valign="center">
                    <span class="lblCompName"
                      style="font-size: 30px; font-weight: 800;font-family: serif; color: #156f29">MERITA DIAGNOSTIC
                      CLINIC INC.</span><br style="margin-bottom: 20px">
                    <div style="color: #156f29; font-size: 10px;">5th Flr Jettac Building., #920 Pres. Quirino Ave.
                      ...
                      Accredited: DOH (RLS 13-026-2123-MF-2) &#8226; POEA &#8226; MARINA Global Group ISO
                      9001:2015<br>Skuld
                      P&amp;I &#8226; West of England P&amp;I &#8226; Oil &amp; Gas UK &#8226; Panama Maritime Authority
                    </div>
                  </td>
                </tr>
              </tbody>
                ...
                <tr>
                  <td align="center">
                    <table width="680" border="0" cellpadding="3" cellspacing="0" class="brdMLC">
                      <tbody>
                        <tr>
                          <td colspan="5" align="center" style="font-size:x-large; font-weight:bold;">MEDICAL
                            CERTIFICATE
                        ...
                        <tr>
                          ...
                          <td valign="top">
                            RELIGION:
                            &nbsp;&nbsp;{{$admission->patient->patientinfo->religion == 'OTHERS' ? $admission->patient->patientinfo->religion_other : $admission->patient->patientinfo->religion }}
                          </td>
                        </tr>
                        <tr>
                ...
                <tr>
                  <td align="center">
                    ...
                    <img
                      ...
                      alt="Patient Picture" width="140" height="120" class="brdAll">
                  @else
                    <img src="../../../app-assets/images/profiles/profilepic.jpg" alt="Patient Picture"
                      width="140" height="120" class="brdAll">
                  @endif<br>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td colspan="2">
                                            ...
                                            </span><span class="fontBoldLrg"><u>{{$admission->patient->lastname}},
                        ...
                        @endif
                          ...
                          width="120"
                          style="margin-bottom: -30px; margin-top: -25px; margin-left: -50px;" />
                        @endif
                        @endif
                                            </span><br>
                      ...
                      @endif <br>
                                ...
                                <tr>
                                  <td height="140" align="center" class="brdRight">
                                    <img src="../../../app-assets/images/logo/hologramWOE.jpg" width="100"
                                      height="100"><br><span
