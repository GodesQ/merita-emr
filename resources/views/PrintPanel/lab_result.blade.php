            ...
            <tr>
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td align="center" style="font-size: 25px; text-transform: uppercase;">MERITA DIAGNOSTIC
                                    CLINIC</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td></td>
                                <td align="right" width="5%" align="center" style="text-transform: uppercase;">
                                    Date: </td>
                                <td align="right" width="15%" align="center" class="fntBldLrg"
                                    style="border-bottom: 1px solid black;">
                                    {{ date_format(new DateTime($admission->trans_date), 'd F Y') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="20%" style="border-bottom: 1px solid black;">
                                    ...
                                    {{ $admission->patient->middlename }}</td>
                                <td width="8%">AGENCY</td>
                                <td width="25%" style="border-bottom: 1px solid black;">
                                    {{ $admission->agency->agencyname }}</td>
                            </tr>
                            <tr>
                                <td width="8%">Package</td>
                                <td width="20%" style="border-bottom: 1px solid black;">
                                    {{ $admission->package->packagename }}</td>
            ...
            <tr>
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td align="center" style="font-size: 17px; text-transform: uppercase;">LABORATORY
                                    RESULTS</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="2" class="brdAll">
                        <tbody>
                            ...
                            <tr>
                                <td width="2%">HGB</td>
                                <td width="22%"
                                    class="fntBldLrg {{ optional($admission->exam_hema)->hemoglobin < 120 || $admission->exam_hema->hemoglobin > 170 ? 'red-text' : '' }}"
                                    style="border-bottom: 1px solid black;">
                            ...
                            <tr>
                                <td width="10%">HCT</td>
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_hema)->hematocrit < 0.4 || $admission->exam_hema->hematocrit > 0.54 ? 'red-text' : '' }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_hema)
                                        {{ optional($admission->exam_hema)->hematocrit }}
                                        @if ($admission->exam_hema->hematocrit < 0.4)
                                            L
                                        @endif
                            ...
                            <tr>
                                <td width="10%">WBC</td>
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_hema)->wbc < 5 || $admission->exam_hema->wbc > 10 ? 'red-text' : '' }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_hema)
                            ...
                            <tr>
                                <td width="10%">RBC</td>
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_hema)->rbc < 3.5 || $admission->exam_hema->rbc > 5.5 ? 'red-text' : '' }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_hema)
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_hema)->platelet < 150 || $admission->exam_hema->platelet > 450 ? 'red-text' : '' }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_hema)
                                ...
                                <td>
                                    <table width="100%" cellpadding="2" cellspacing="0" class="brdNone">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="6" style="font-weight: bold;">Thromboplastin Time</td>
                                            </tr>
                                            <tr>
                                                <td width="25%">Control:</td>
                                                <td width="22%" style="border-bottom: 1px solid black;"></td>
                                                <td width="3%">&nbsp;</td>
                                                <td width="22%" style="border-bottom: 1px solid black;">secs</td>
                                                <td width="3%">&nbsp;</td>
                                                <td width="25%" style="border-bottom: 1px solid black;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td width="25%">Patient's Time:</td>
                                                <td width="22%" style="border-bottom: 1px solid black;"></td>
                                                <td width="3%">&nbsp;</td>
                                                <td width="22%" style="border-bottom: 1px solid black;">secs</td>
                                                <td width="3%">&nbsp;</td>
                                                <td width="25%" style="border-bottom: 1px solid black;">14.8 - 17.8
                                                    sec</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="22%" style="border-bottom: 1px solid black;">&nbsp;</td>
                                                <td width="3%">&nbsp;</td>
                                                <td width="25%" style="border-bottom: 1px solid black;">1.0</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6" style="font-weight: bold;">Partial Thromboplastin
                                                    Time</td>
                                            </tr>
                                            <tr>
                                                <td width="25%">Control:</td>
            ...
            <tr>
                <td>
                    <table width="100%" cellpadding="0" cellspacing="2" class="brdAll">
                        <tbody>
                            <tr>
                                <td colspan="6" style="text-transform: uppercase; font-weight: 600;">URINALYSIS
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="33%"
                                    class="fntBldLrg {{ str_contains(optional($admission->exam_urin)->pus, 'H') ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->blood != 'Negative' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                                ...
                                <td width="20%"
                                    class="fntBldLrg {{ str_contains(optional($admission->exam_urin)->rbc, 'H') ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->leukocyte != 'Negative' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                            ...
                            <tr>
                                ...
                                <td width="20%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->nitrite != 'Negative' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->ketone != 'Negative' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->urobilinogen != 'Normal' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->bilirubin != 'Negative' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                            ...
                            <tr>
                                ...
                                <td width="20%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->albumin != 'Negative' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_urin)->sugar != 'Negative' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_urin)
                            ...
                            <tr>
                                ...
                                <td width="15%" class="fntBldLrg" style="border-bottom: 1px solid black;">
                                    {{ optional($admission->exam_urin)->others }}</td>
                                <td width="12%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        ...
                                        & SENSITIVITY TEST: <span>
                                            @if ($admission->exam_feca->stool_status)
                                                <input style="width: 500px; border: none;  font-family: constantia;"
                                                    value="{{ $admission->exam_feca->stool_culture }}" />
                                            @endif
                                        </span></td>
                                </tr>
                            </tbody>
            ...
            <tr>
                <td>
                    <table width="100%" cellpadding="2" cellspacing="5" class="brdAll">
                        <tbody>
                            <tr>
                                <td colspan="6" style="text-transform: uppercase; font-weight: 600;">MALARIAL
                                    SMEAR: <span></span></td>
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml" style="border-bottom: 1px solid black;"></td>
                                                <td class="fntBldSml {{ optional($admission->exam_bloodsero)->vdrl_result == 'Reactive' ? 'red-text' : null }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->hbsag_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->antihcv_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"></td>
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->tpha_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->antihbs_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->hbeag_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->antihbe_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->antihbclgm_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->antihbclgg_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->antihavlgm_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldSml {{ optional($admission->exam_hepa)->antihavlgg_result == 'Reactive' ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black; text-transform: uppercase;">
                                                    @if ($admission->exam_hepa)
            ...
            <tr>
                <td>
                    <table width="100%" cellpadding="0" cellspacing="2" class="brdAll">
                        <tbody>
                            <tr>
                                <td colspan="6" style="text-transform: uppercase; font-weight: 600;">BLOOD
                                    CHEMISTRY</td>
                            </tr>
                            <tr>
                                <td valign="top">
                                    <table width="100%" cellpadding="0" cellspacing="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->fbs < 70 || optional($admission->exam_bloodsero)->fbs > 110 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;">70-110
                                                    mg/dL</td>
                                            </tr>
                                            <tr>
                                                <td align="center">2hrs PPBG</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->ppbg > 200 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->hba1c < 4 || optional($admission->exam_bloodsero)->hba1c > 6.5 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->bun < 5 || optional($admission->exam_bloodsero)->bun > 20 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 5 - 20
                                                    mg/dL</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Creatinine</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->creatinine < 0.8 || optional($admission->exam_bloodsero)->creatinine > 1.2 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->creatinine }}
                                                    @if (optional($admission->exam_bloodsero)->creatinine < 0.8 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->creatinine))
                                                        L
                                                    @endif
                                                    @if (optional($admission->exam_bloodsero)->creatinine > 1.2 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->creatinine))
                                                        H
                                                    @endif
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 0.8-1.2
                                                    mg/dL</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Uric Acid</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->uricacid < 140 || optional($admission->exam_bloodsero)->uricacid > 430 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 140-430
                                                    umol/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Cholesterol</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->cholesterol < 125 || optional($admission->exam_bloodsero)->cholesterol > 200 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->cholesterol }}
                                                    @if (optional($admission->exam_bloodsero)->cholesterol < 125 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->cholesterol))
                                                        L
                                                    @endif
                                                    @if (optional($admission->exam_bloodsero)->cholesterol > 200 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->cholesterol))
                                                        H
                                                    @endif
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 125-200
                                                    mg/dL</td>
                                            </tr>
                                            <tr>
                                                <td align="center">HDL Chole</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->hdl < 40 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->hdl }}
                                                    {{ optional($admission->exam_bloodsero)->hdl < 40 && is_numeric(optional($admission->exam_bloodsero)->hdl) ? 'L' : null }}
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> > 40
                                                    mg/dL</td>
                                            </tr>
                                            <tr>
                                                <td align="center">LDL Chole</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->ldl > 100 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->ldl }}
                                                    {{ optional($admission->exam_bloodsero)->ldl > 100 && is_numeric(optional($admission->exam_bloodsero)->ldl) ? 'H' : null }}
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;">
                                                    < 100 mg/dL</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->vldl < 7 || optional($admission->exam_bloodsero)->vldl > 32 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> M-8-32
                                                    F:7-26 mg</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Triglycerides</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->triglycerides < 35 || optional($admission->exam_bloodsero)->triglycerides > 160 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->triglycerides }}
                                                    @if (optional($admission->exam_bloodsero)->triglycerides < 35 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->triglycerides))
                                                        L
                                                    @endif
                                                    @if (optional($admission->exam_bloodsero)->triglycerides > 160 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->triglycerides))
                                                        H
                                                    @endif
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;">
                                                    M:40-160 F:35-130</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->sgot < 0 || optional($admission->exam_bloodsero)->sgot > 40 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;">0-40 u/L
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">SGPT</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->sgpt < 0 || optional($admission->exam_bloodsero)->sgpt > 41 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 0-41
                                                    u/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Alk. Phosphatase</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->alkphos < 35 || optional($admission->exam_bloodsero)->alkphos > 129 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 35-129
                                                    u/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">GGT</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->ggt < 0 || optional($admission->exam_bloodsero)->ggt > 55 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 0-55u/L
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">Total Protein</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->ttlprotein < 66 || optional($admission->exam_bloodsero)->ttlprotein > 87 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->ttlprotein }}
                                                    @if (optional($admission->exam_bloodsero)->ttlprotein < 66 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->ttlprotein))
                                                        L
                                                    @endif
                                                    @if (optional($admission->exam_bloodsero)->ttlprotein > 87 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->ttlprotein))
                                                        H
                                                    @endif
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 66-87
                                                    g/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Albumin</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->albumin < 35 || optional($admission->exam_bloodsero)->albumin > 52 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 35-52
                                                    g/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Globulin</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->globulin < 31 || optional($admission->exam_bloodsero)->globulin > 35 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 31-35
                                                    g/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">A/G Ratio</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->ag_ratio < 0.6 || optional($admission->exam_bloodsero)->ag_ratio > 1.7 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                ...
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;">1:
                                                    0.6-1.7</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Total Bilirubin</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->ttlbilirubin < 5 || optional($admission->exam_bloodsero)->ttlbilirubin > 21 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->ttlbilirubin }}
                                                    @if (optional($admission->exam_bloodsero)->ttlbilirubin < 5 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->ttlbilirubin))
                                                        L
                                                    @endif
                                                    @if (optional($admission->exam_bloodsero)->ttlbilirubin > 21 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->ttlbilirubin))
                                                        H
                                                    @endif
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 5-21
                                                    umol/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Direct Bilirubin</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->dirbilirubin < 0 || optional($admission->exam_bloodsero)->dirbilirubin > 5.1 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->dirbilirubin }}
                                                    @if (optional($admission->exam_bloodsero)->dirbilirubin < 0 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->dirbilirubin))
                                                        L
                                                    @endif
                                                    @if (optional($admission->exam_bloodsero)->dirbilirubin > 5.1 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->dirbilirubin))
                                                        H
                                                    @endif
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 0-5.1
                                                    umol/L</td>
                                            </tr>
                                            <tr>
                                                <td align="center">Indirect Bilirubin</td>
                                                <td class="fntBldLrg {{ optional($admission->exam_bloodsero)->indbilirubin < 0 || optional($admission->exam_bloodsero)->indbilirubin > 16 ? 'red-text' : null }}"
                                                    style="border-bottom: 1px solid black;">
                                                    {{ optional($admission->exam_bloodsero)->indbilirubin }}
                                                    @if (optional($admission->exam_bloodsero)->indbilirubin < 0 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->indbilirubin))
                                                        L
                                                    @endif
                                                    @if (optional($admission->exam_bloodsero)->indbilirubin > 16 &&
                                                            is_numeric(optional($admission->exam_bloodsero)->indbilirubin))
                                                        H
                                                    @endif
                                                </td>
                                                <td class="fntBldLrg" style="border-bottom: 1px solid black;"> 0-16
                                                    umol/L</td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <tr>
                <td>
                    <table width="100%" cellpadding="0" cellspacing="2" class="brdAll">
                        <tbody>
                            <tr>
                                <td colspan="6" style="text-transform: uppercase; font-weight: 600;">DRUG & ALCOHOL
                                    TEST</td>
                            </tr>
                            <tr>
                                <td width="10%">Metaphetamine / Amphetamines</td>
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->methamphetamine == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->alcohol == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                                ...
                                <td width="20%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->metaqualone == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->tetrahydrocannabinol == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                                ...
                                <td width="20%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->propoxyphene == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                                ...
                                <td width="20%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->opium == 'Positive' ? 'red-text' : null }}"
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->cocaine == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->benzodiazepine == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->morphine == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                            ...
                            <tr>
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->phencyclidine == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                                ...
                                <td width="15%"
                                    class="fntBldLrg {{ optional($admission->exam_drug)->methadone == 'Positive' ? 'red-text' : null }}"
                                    style="border-bottom: 1px solid black;">
                                    @if ($admission->exam_drug)
                    ...
                    <table width="100%" cellpadding="0" cellspacing="2" class="brdAll">
                        <tbody>
                            <tr>
                                ...
                                <td class="fntBldLrg" style="border-bottom: 1px solid black;" width="85%">
                                    {{ $additional }}</td>
                                <td width="3%"></td>
                            </tr>
                        </tbody>
