      ...
      <table class="brdAll" width="800" style="margin-bottom: 20px;">
        <tbody>
          <tr>
            ...
            <td width="7%">
              <img src="{{ URL::asset('app-assets/images/logo/vanuatu-logo-sm.png') }}" width="100%" alt="">
            </td>
            <td width="46%">
              <div style="text-align: center; font-weight: bold;">
        ...
        <tbody>
          <tr>
            <td>
              ...
              <input type="checkbox" {{ $admission->exam_drug->tetrahydrocannabinol ? 'checked' : null }}>
              THC
              <input type="checkbox" {{ $admission->exam_drug->cocaine ? 'checked' : null }} />
              Cocaine
              <input type="checkbox" {{ $admission->exam_drug->phencyclidine ? 'checked' : null }}> PCP
              <input type="checkbox" {{ $admission->exam_drug->morphine ? 'checked' : null }}>
              Oplates
              <input type="checkbox" {{ $admission->exam_drug->amphetamines ? 'checked' : null }}>
              Amphetamines
            @else
            ...
            @endphp
                ...
                <td class="brdRight">
                  <input type="checkbox" name="{{ strtolower($test) }}" value="1" {{ optional($admission->exam_drug)->{strtolower($test)} ? 'checked' : '' }}>
                  {{ $test }}
                </td>
                <td class="brdRight">
                  <input type="checkbox" {{ $result === 'Negative' ? 'checked' : '' }}>
                </td>
                <td>
                  <input type="checkbox" {{ $result === 'Positive' ? 'checked' : '' }}>
                </td>
                @else
              ...
              @endforeach
                          ...
                          <tr>
                            ...
                            <td class="brdRight">
                              <input type="checkbox" {{ $admission->exam_drug->tetrahydrocannabinol == 'Negative' ?
                              'checked' : null }}>
                            </td>
        ...
        <tbody>
          <tr>
            <td>
              ...
              <input type="checkbox" {{ $admission->exam_physical->fit == 'Fit' ? 'checked' : null }} />
              FIT
              <span>/</span>
              <input type="checkbox" {{ $admission->exam_physical->fit == 'Unfit' ? 'checked' : null }} />
              NOT FIT
            @else
              <input type="checkbox" />
              FIT
