                    ...
                    <td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Surname (Family Name) <br> <span
                                            class="fontBoldLrg">{{$admission->lastname}}</span></td>
                                    <td>First Name <br> <span class="fontBoldLrg">{{$admission->firstname}}</span></td>
                                    <td>Second Name <br> <span class="fontBoldLrg">{{$admission->middlename}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Date of Birth<br> <span class="fontBoldLrg">{{date_format(new DateTime($patientInfo->birthdate), "d F Y")}}</span>
                                    </td>
                                    <td>Country of Birth<br> <span
                                            class="fontBoldLrg">{{$patientInfo->birthplace}}</span></td>
                                    <td>Nationality <br> <span class="fontBoldLrg">{{$patientInfo->nationality}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Gender <br>
                                        <span>{{strtoupper($admission->gender)}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="2" style="margin-top: 1rem;">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if($exam_physical)
                                                                        @if($exam_physical->sick33 == "Yes" || $exam_physical->sick33 == "1")
                                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                                        @else
                                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if($exam_physical)
                                                                        @if($exam_physical->sick33 == "No" || $exam_physical->sick33 == "0")
                                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                                        @else
                                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                                        @endif
                            ...
                            <tbody>
                                <tr>
                                    <td height="70" valign="top">
                                        ...
                                        <br>
                                         @if($exam_physical) @php echo nl2br($exam_physical->specify) @endphp @endif
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="3">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question1 == "Yes" || $exam_physical->question1 == "1")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question1 == "No" || $exam_physical->question1 == "0")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question2 == "Yes" || $exam_physical->question2 == "1")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question2 == "No" || $exam_physical->question2 == "0")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question3 == "Yes" || $exam_physical->question3 == "1")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question3 == "No" || $exam_physical->question3 == "0")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question4 == "Yes" || $exam_physical->question4 == "1")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question4 == "No" || $exam_physical->question4 == "0")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question5 == "Yes" || $exam_physical->question5 == "1")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question5 == "No" || $exam_physical->question5 == "0")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question6 == "Yes" || $exam_physical->question6 == "1")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question6 == "No" || $exam_physical->question6 == "0")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question7 == "Yes" || $exam_physical->question7 == "1")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if($exam_physical)
                                                        @if($exam_physical->question7 == "No" || $exam_physical->question7 == "0")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                            ...
                            <tbody>
                                <tr>
                                    <td height="50" valign="top">Comments: <br>
                                        @if($exam_physical){{$exam_physical->comments}}@endif
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="5" class="brdAll" style="margin-top: 0.5rem;">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        @if($exam_physical)
                                        @if($exam_physical->question8 == "Yes" || $exam_physical->question8 == "1")
                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                        @else
                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                        @endif
                                    ...
                                    <td>
                                        @if($exam_physical)
                                        @if($exam_physical->question8 == "No" || $exam_physical->question8 == "0")
                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                        @else
                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                        @endif
                            ...
                            <tbody>
                                <tr>
                                    <td height="50" valign="top">If yes, please list the medications taken, and the
                                        ...
                                        @if($exam_physical){{$exam_physical->purpose}}@endif
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                    ...
                                    <td height="80" valign="top" > <span style="font: bold 12px sans-serif;">Applicant
                                        ...
                                        <div style="display: flex; align-items: flex-end; justify-content: space-around; height: 80px;">
                                                ...
                                                <span>
                                                    @if($admission->agency_id != 19)
                                                        @if($admission->patient_signature)
                                                            <img src="@php echo base64_decode($admission->patient_signature) @endphp" width="150" class="signature-taken" />
                                                        @elseif ($admission->signature)
                                                            <img src="data:image/jpeg;base64,{{$admission->signature}}" width="150" class="signature-taken"/>
                                                        @else 
                                            ...
                                            <div style="font: normal sans-serif;">
                                                Date: 
                                                @if($exam_physical)
                                                    {{$exam_ishihara ? date_format(new DateTime($exam_physical->date_examination), "d F Y") : null}}
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="2" class="brdTable" style="margin-top: 1rem;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($exam_physical)
                                        {{$exam_physical->height}} (cm)
                                        @endif
                                    </td>
                                    <td>Weight</td>
                                    <td>
                                        @if($exam_physical)
                                        {{$exam_physical->weight}} (kg)
                                        @endif
                                    </td>
                                    <td>Pulse Rate</td>
                                    <td colspan="2">
                                        @if($exam_physical)
                                        {{$exam_physical->pulse}} (/minute)
                                        @endif
                                    </td>
                                    <td>Rhythm</td>
                                    <td colspan="2">
                                        @if($exam_physical)
                                        {{$exam_physical->rhythm}}
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($exam_physical)
                                        {{$exam_physical->systollic}}
                                        @endif
                                    </td>
                                    <td>Diastolic</td>
                                    <td>
                                        @if($exam_physical)
                                        {{$exam_physical->diastollic}}
                                        @endif
                                    </td>
                                    <td>Glucose</td>
                                    <td>Normal</td>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <span style="margin: 0 1rem;">YES
                                                <span style="font-size: 15px;">
                                                    @if($exam_physical)
                                                        @if($exam_physical->visual_required != "")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                        ...
                        <table width="100%" cellspacing="0" cellpadding="3" class="brdTable">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_right4}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_right5}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_right6}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_right7}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_right8}}
                                        @endif
                                    </td>
                                    <td align="center">Right ear</td>
                                    <td align="center">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_left2}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_left4}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_left5}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_left6}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_left7}}
                                        @endif
                                    </td>
                                    <td align="center">
                                        @if($exam_audio)
                                            {{$exam_audio->air_left8}}
                                        @endif
                                    </td>
                                    <td align="center">Left ear</td>
                                    <td align="center">
                        ...
                        <table style="margin-top: 10px;" width="100%" cellspacing="0" cellpadding="3" class="brdTable">
                            <tbody>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <span style="margin: 0 1rem;">Performed on: 
                                                    @if($exam_xray)
                                                        {{$exam_physical ? date_format(new DateTime($exam_xray->trans_date), "d F Y") : null}}
                                                    @endif
                                                <span style="font-size: 15px;">
                                                    @if($exam_xray)
                                                        <img src="../../../app-assets/images/icoCheck.gif" width="13">
                                ...
                                <tr>
                                    <td>Results: <span>
                                        @if($exam_physical)
                                            {{$exam_physical->chest == 'normal' ? 'NORMAL' : $exam_physical->xray_findings}}
                                        @endif
                                    </span></td>
                                </tr>
                                <tr>
                                    <td>Other diagnostic test/s and results: <br>
                                        {{$exam_ecg ? $exam_ecg->ecg : null}}
                                ...
                                <tr>
                                    <td valign="top">Medical practitioner`s comments and assessment for fitness, with reasons for any
                                        limitations: <br> 
                                        @if($exam_ecg)
                                            @php echo nl2br($exam_ecg->remarks) @endphp
                                        @endif
                                        <br>
                                        <div>
                        ...
                        <table style="margin-top: 10px;" width="100%" cellspacing="0" cellpadding="5" class="brdTable">
                            <tbody>
                                ...
                                <tr>
                                    <td>Surname (Family Name) <br> <span class="fontBoldLrg">{{$admission->lastname}}</span></td>
                                    <td>First Name <br> <span class="fontBoldLrg">{{$admission->firstname}}</span></td>
                                    <td>Second Name <br> <span class="fontBoldLrg">{{$admission->middlename}}</span></td>
                                </tr>
                                <tr>
                                    <td>Date of Birth<br> <span class="fontBoldLrg">{{date_format(new DateTime($patientInfo->birthdate), "d F Y")}}</span></td>
                                    <td>Country of Birth<br> <span class="fontBoldLrg">{{$patientInfo->birthplace}}</span></td>
                                    <td>Nationality <br> <span class="fontBoldLrg">{{$patientInfo->nationality}}</span></td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        Department <br>
                                ...
                                <tr>
                                    <td colspan="2">
                                        Passport No. / Discharge Book No. / Identity Card No. <br>
                                        <span class="fontBoldLrg">{{$patientInfo->passportno}}</span>
                                    </td>
                                    <td>
                                        Gender <br>
                                        <span class="fontBoldLrg">{{strtoupper($admission->gender)}}</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table width="100%" cellspacing="0" cellpadding="5" class="brdTable">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($exam_physical)
                                            @if($exam_physical->duty == "Fit" || $exam_physical->duty == "Fit Restriction")
                                                <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                            @else
                                                <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                            @endif
                                    ...
                                    <td colspan="3">
                                        ...
                                        <div style="height: 20px;">
                                            ...
                                            <span style="margin: 0 1rem;">**Fit with limitations or restrictions
                                                <span style="font-size: 15px;">
                                                    @if($exam_physical)
                                                        @if($exam_physical->duty == "Fit Restriction")
                                                            <img src="../../../app-assets/images/icoCheck.gif" width="10">
                                                        @else
                                                            <img src="../../../app-assets/images/icoUncheck.gif" width="10">
                                                        @endif
                        ...
                        <table width="100%" cellspacing="0" cellpadding="5" class="brdTable">
                            <tbody>
                                <tr>
                                    ...
                                    <td height="80" valign="bottom" align="center">
                                        <span>
                                            @if($admission->agency_id != 19)
                                                @if($admission->patient_signature)
                                                    <img src="@php echo base64_decode($admission->patient_signature) @endphp" width="130" class="signature-taken" />
                                                @elseif ($admission->signature)
                                                    <img src="data:image/jpeg;base64,{{$admission->signature}}" width="130" class="signature-taken"/>
                                                @else 
                                                    <div style="width: 150px;height: 40px;"></div>
                                                @endif 
                                            @endif
                                ...
                                <tr>
                                    ...
                                    <td height="50" valign="bottom" align="center">
                                        <span>{{$exam_physical ? date_format(new DateTime($exam_physical->date_examination), "d F Y") : null}}</span> <br>
                                        Date of Examination <br>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <b>Validity:</b> <span>{{$exam_physical ? date_format(new DateTime($exam_physical->date_expiration), "d F Y") : null}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <b>Date of Issue:</b> <span>{{$exam_physical ? date_format(new DateTime($exam_physical->peme_date), "d F Y") : null}}</span>
                                    </td>
                                </tr>
                                <tr>
