                            ...
                            <tbody>
                                <tr>
                                    <td width="20" rowspan="3" align="center">
                                        <img src="../../../app-assets/images/logo/logo.jpg" width="90"
                                            height="90" alt="">
                                    </td>
                                ...
                                <table width="680" border="0" cellpadding="3" cellspacing="0" class="brdMLC">
                                    ...
                                    <tr>
                                        ...
                                        <td width="193" valign="top">
                                            PLACE OF BIRTH:<br>
                                            <span
                                                class="fontMed">{{ $admission->patient->patientinfo->birthplace }}</span>
                                        </td>
                                        <td valign="top">
                                            NATIONALITY:<br>
                                            <span
                                                class="fontMed">{{ $admission->patient->patientinfo->nationality }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" valign="top">
                                            ...
                                            <table width="678" border="0" cellpadding="3" cellspacing="0">
                                                <tr>
                                                    <td width="178" align="center" valign="middle" class="brdBtm"
                                                        ...
                                                        <br>
                                                        <span
                                                            class="fontMed">{{ $admission->patient->patientcode }}</span>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">THIS IS TO CERTIFY THAT A MEDICAL
                                                                    ...
                                                                    <span class="fontMed"><span
                                                                            style="margin-right: 2rem;">RESULT:</span>
                                                                        @if ($admission->exam_physical)
                                                            ...
                                                            <tr>
                                                                <td colspan="2" valign="bottom" class="">
                                                                    @if ($admission->exam_physical && $admission->agency_id != 19)
                                                                        <img src="{{ $admission->exam_physical->first_tech->signature }}"
                                                                            width="120"
                                                                    ...
                                                                    @if ($admission->exam_physical)
                                                                        <span
                                                                            style="font-size: 10px;">{{ $admission->exam_physical->first_tech->firstname }}
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="15%" style="border-bottom:solid 1px black">
                                                        <input type="text"
                                                            style="border: none; font-family: serif;"
