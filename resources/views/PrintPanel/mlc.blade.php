...
<body>
  <center>
        ...
        <td>
          ...
          <tbody>
            ...
            <td width="396" rowspan="3" align="center" valign="center">
              <span class="lblCompName"
              style="font-size: 30px; font-weight: 800;font-family: serif; color: #156f29">MERITA
              ...
              Tel Nos.: (632) 8404-3411 / (633) 7003-0403 * Cell No.: +63917 857-6942 /
              +63908 890-8850<br>
              Email: meritaclinic@gmail.com / meritadiagnosticclinic@yahoo.com<br>
              Accredited: DOH (RLS 13-026-2123-MF-2) &#8226; POEA &#8226; MARINA Global
              Group ISO 9001:2015<br>Skuld
              P&amp;I &#8226; West of England P&amp;I &#8226; Oil &amp; Gas UK &#8226;
              Panama Maritime Authority</div>
            </td>
            </tr>
          </tbody>
          </table>
    ...
    @endif
        ...
        <td colspan="3" valign="top">
          <table width="680" border="0" cellspacing="1" cellpadding="0">
              ...
              <td align="center">
                <table width="680" border="0" cellpadding="3" cellspacing="0" class="brdMLC">
                  ...
                  <tr>
                    ...
                    <td colspan="2" valign="top">
                      CIVIL
                      STATUS:&nbsp;&nbsp;{{ strtoupper($admission->patient->patientinfo->maritalstatus) }}
                    </td>
                    <td valign="top">
                      RELIGION:&nbsp;&nbsp;{{ $admission->patient->patientinfo->religion == 'OTHERS' ? $admission->patient->patientinfo->religion_other : $admission->patient->patientinfo->religion }}
                    </td>
                  </tr>
                  <tr>
                    <td colspan="5" valign="top">
                      ADDRESS:<br>
                      <span class="fontMed"
                        style="font-weight: 800; font-size: 13px;">{{ $admission->patient->patientinfo->address }}</span>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="4" valign="top">
                      PASSPORT NO.:<br>
                      <span class="fontMed"
                        style="font-weight: 800; font-size: 13px;">{{ $admission->patient->patientinfo->passportno }}</span>
                    </td>
            ...
            @endif
                  ...
                  <tr>
                    <td colspan="5">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblNoneRightNew">
                        <tr>
              ...
              @endif
                  ...
                  <tr>
                    <td colspan="5">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblNoneRightNew">
                        <tr>
                          <td width="87%" valign="middle">VISUAL ACUITY MEETS STANDARDS
                            IN
              ...
              @endif
                  ...
                  <tr>
                    <td colspan="5" valign="top">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblNoneRightNew">
                        <tr>
                          <td width="87%" valign="middle">COLOUR VISION MEETS STANDARDS
                            IN
              ...
              @endif
                  ...
                  <tr>
                    <td colspan="5">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblNoneRightNew">
                        <tr>
                          <td width="32%" valign="middle">VISUAL AIDS (tick if worn)
                          </td>
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblNoneRightNew">
                        <tr>
                          <td width="87%" valign="middle">NO LIMITATIONS OR RESTRICTIONS
                            ...
                            <textarea name="co" type="text" id="co" value="" class="brdNone"
                              style="width:400px;height: 25px;font-size: 10px;text-align:left;border: none;">{{ $admission->exam_physical ? $admission->exam_physical->describe_restriction : null }}</textarea>
                          </td>
                          <td width="4%" valign="middle">YES</td>
                          <td width="3%" valign="middle">
                            @if ($admission->exam_physical)
                  ...
                  <tr>
                    <td>
                      <table width="678" border="0" cellpadding="3" cellspacing="0">
                        <tr>
                          <td width="178" align="center" valign="middle" class="brdBtm" style="padding-top:20px;">
                            @if ($admission->patient->patient_image)
                <img
                  src="../../../app-assets/images/profiles/{{ $admission->patient->patient_image . '?' . $admission->updated_date }}"
                  alt="Patient Picture" width="140" height="140" class="brdAll">
              @else
                <img src="../../../app-assets/images/profiles/profilepic.jpg" alt="Patient Picture"
                  width="140" height="140" class="brdAll">
              @endif
                            <br>
                            <span class="fontMed">{{ $admission->patient->patientcode }}</span>
                          </td>
                          <td width="500" class="brdLeftBtm">
                            <table width="500" border="0" cellpadding="0" cellspacing="0" class="size10">
                              <tr>
                                <td colspan="2">THIS IS TO CERTIFY THAT A MEDICAL
                                  AND
                  ...
                  @endif
                    ...
                    <img src="{{ $admission->exam_physical->first_tech->signature }}" width="120"
                  ...
                  @endif
                                  @if ($admission->exam_physical)
                    <span style="font-size: 10px;">{{ $admission->exam_physical->first_tech->firstname }}
                    {{ $admission->exam_physical->first_tech->middlename[0] }}.
                    {{ $admission->exam_physical->first_tech->lastname }},
                    {{ $admission->exam_physical->first_tech->title }}</span>
                  @endif <br>
                    ...
                    <img src="../../../app-assets/images/signatures/md_gonzales_sig.png" width="200"
                    height="50"
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td valign="top">NAME OF ISSUING AUTHORITY: TERESITA
                                  ...
                                  PHYSICIAN’S LICENSE NUMBER: 0055997
                                </td>
                              </tr>
                            </table>
                          </td>
              ...
              <td>
                ...
                @endif
                        ...
                        <tr>
                          ...
                          <td width="48%" align="center" style="border-bottom:solid 1px black">
                          ...
                          <td width="15%" style="border-bottom:solid 1px black">
                            <input type="text" style="border: none; font-family: serif;"
                              value="{{ $admission->exam_physical ? date_format(new DateTime($admission->exam_physical->peme_date), 'd F Y') : null }}" />
                          </td>
                        </tr>
                        <tr>
                ...
                <table width="100%" cellpadding="2" cellspacing="0" class="brdMLC" style="margin-top:1px">
                  <tr>
      ...
      <tr>
        <td colspan="3" valign="top"> <span class="lblForm" style="font-size:8px">FORM NO.41 / REV. 01/
            15-06-2022</span> </td>
      </tr>
    </table>
  </center>
