                                ...
                                <tr>
                                    <td>
                                        <span>Name (last, first, middle):
                                            <span
                                                style="margin-left: 0.5rem; border-bottom: 1px solid black;">{{ optional($admission->patient)->lastname }},
                                                {{ optional($admission->patient)->firstname }}
                                                {{ optional($admission->patient)->middlename }}</span></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>Identity document No.: <span
                                            style="margin-left: 0.5rem; border-bottom: 1px solid black;"><span
                                                style="margin-left: 0.5rem; border-bottom: 1px solid black;">{{ $admission->patient->patientcode }}</span></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Type of ship (e.g. container, tanker, passenger, fishing): <span
                                            style="margin-left: 0.5rem; border-bottom: 1px solid black;">PASSENGER</span>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="10">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="../../../app-assets/images/icoCheck.gif"
                                                            width="10">
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <tr>
                    <td>
                        <div
                            ...
                            <span></span> <br>
                            @if ($admission->exam_physical)
                                @php echo nl2br($admission->exam_physical->specify) @endphp
                            @endif
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="12">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" height="80">I hereby certify that the personal declaration
                                        above is
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="15%"
                                                        style="border-bottom: 1px solid black; padding: 0 1.5rem; position: relative;">
                                                        @if ($admission->agency_id != 19)
                                                            @if (optional($admission->patient)->patient_signature)
                                                                <img src="@php echo base64_decode(optional($admission->patient)->patient_signature) @endphp"
                                                                    width="170%" />
                                                            ...
                                                            @else
                                                                <div
                                                                    style="width: 150%;height: 40px; position: absolute; top: -30px; left: 0px;">
                                                                </div>
                                                            @endif
                                                        @endif
                                                    </td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="15%"
                                                        style="border-bottom: 1px solid black; padding: 0 1.5rem;">
                                                        {{-- @if ($admission->agency_id == 3 || $admission->agency_id == 55 || $admission->agency_id == 57 || $admission->agency_id == 58) --}}
                                                        <img src="../../../app-assets/images/signatures/rex-signature.png"
                                                            width="80" height="60"
                                                    ...
                                                    <td width="23%" valign="bottom"
                                                        style="border-bottom: 1px solid black; padding: 0 1.5rem;">REX
                                                        A. GAID</td>
                                                    <td width="10%"></td>
                                                </tr>
                                            </tbody>
                                ...
                                <tr>
                                    <td colspan="4" height="80">I hereby authorize the release of all my
                                        previous
                                        ...
                                        <span style="margin-left: 0.5rem; border-bottom: 1px solid black;">
                                            <img src="../../../app-assets/images/signatures/md_gonzales_bahamas_sig.png"
                                                width="120" height="60"
                                                style="object-fit: cover; object-position: center; transform: translateY(14px);" />
                                        </span>(the
                                ...
                                <tr>
                                    <td colspan="4">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2"
                                            height="40" style="margin-bottom: 18rem;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="23%" style="border-bottom: 1px solid black;"
                                                        valign="bottom">
                                                        @if ($medical_director)
                                                            {{ $medical_director->firstname }}
                                                            {{ $medical_director->middlename[0] }}
                                                            {{ $medical_director->lastname }}
                                                        @endif
                                                    </td>
                                                    <td width="10%">
                                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td height="50">Urinalysis:
                                        ...
                                        Glucose: <span
                                            style="margin-left: 0.5rem; border-bottom: 1px solid black;">Normal</span>
                    ...
                    <td>
                        <table width="100%" cellpadding="5" cellspacing="10">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2" height="50"><b>Assessment of fitness for service at sea</b>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <td>
                        <table width="100%" cellpadding="5" cellspacing="10">
                            <tbody>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="5" class="brdTop"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        SEAFARER MEDICAL EXAMINATION AND CERTIFICATE <br>
                                                        <span style="color: blue;">stcw@bahamasmaritime.com</span>
                                                        <br>
                                                        <span style="color: blue;">mlc@bahamasmaritime.com</span>
                                                    </td>
                                                    <td>
                                ...
                                <tr>
                                    <td height="50" colspan="5">
                                        Place of examination: <span
                                            style="margin-left: 0.5rem; border-bottom: 1px solid black;">MERITA
                                            DIAGNOSTIC CLINIC INC.</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="50" colspan="5">
                                        ...
                                        <span style="margin-left: 0.5rem; border-bottom: 1px solid black; ">
                                            <input type="text"
                                                style="border: none; font-family: serif; border-bottom: 1px solid black;"
                                                value="{{ $admission->exam_physical ? date_format(new DateTime($admission->exam_physical->date_examination), 'd F Y') : null }}" />
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="50" colspan="5">
                                        ...
                                        <span style="margin-left: 0.5rem; border-bottom: 1px solid black;">
                                            <input type="text"
                                                style="border: none; font-family: serif; border-bottom: 1px solid black;"
                                                value="{{ $admission->exam_physical ? date_format(new DateTime($admission->exam_physical->date_expiration), 'd F Y') : null }}" />
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td height="50" colspan="5">Signature of medical practitioner: <span
                                ...
                                <tr>
                                    <td height="50" colspan="5">Name of medical practitioner: (Typed or
                                        printed)
                                        <span style="margin-left: 0.5rem; border-bottom: 1px solid black;">
                                            @if ($medical_director)
                                ...
                                <tr>
                                    <td height="50" colspan="5">Authorized by: <b>PROFESSIONAL REGULATION
                                            COMMISSION</b></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tbody>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="5" class="brdTable"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="2">Given Name(s):
                                                        <span>{{ $admission->patient->firstname }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Date of Birth (dd/mm/yyyy):
                                                        <span>{{ date_format(new DateTime($admission->patient->patientinfo->birthdate), 'd F Y') }}</span>
                                                    </td>
                                                    <td>Nationality:
                                                        <span>{{ $admission->patient->patientinfo->nationality }}</span>
                                                        <br>
                                                        ID Document no: <span
                                                            style="border-bottom: 1px solid black;">{{ $admission->patientcode }}</span>
                                                    </td>
                                                    <td>Gender: <br>
                                                        <span
                                                            style="text-decoration: {{ $admission->patient->gender == 'Male' ? 'underline' : 'none' }}">MALE</span>
                                                        / <span
                                                            style="text-decoration: {{ $admission->patient->gender == 'Female' ? 'underline' : 'none' }}">FEMALE</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3">
                                                        ...
                                                        <span></span> <br> <br>
                                                        <span class="duty_as"
                                                            style="margin-left: 1rem;  {{ $admission->category == 'DECK SERVICES' ? 'text-decoration: underline; font-weight: 600;' : 'text-decoration: none' }}">Deck</span>
                                                        <span class="duty_as"
                                                            style="margin-left: 1rem;  {{ $admission->category == 'ENGINE SERVICES' ? 'text-decoration: underline; font-weight: 600;' : 'text-decoration: none' }}">Engine</span>
                                                        <span class="duty_as"
                                                            style="margin-left: 1rem;">GMDSS</span>
                                                        <span class="duty_as"
                                                            style="margin-left: 1rem;">Rating</span>
                                                        <span class="duty_as"
                                                            style="margin-left: 1rem; {{ $admission->category == 'CATERING SERVICES' ? 'text-decoration: underline; font-weight: 600;' : 'text-decoration: none' }}">Catering</span>
                                                        <span class="duty_as"
                                                            style="margin-left: 1rem; {{ $admission->category == 'OTHER SERVICES' ? 'text-decoration: underline; font-weight: 600;' : 'text-decoration: none' }}">Other</span>
                                                        <span
                                                            style="border-bottom: 1px solid black; margin-left: 1rem;">{{ $admission->position }}</span>
                                                    </td />
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    <td align="center"><b><u>DECLARATION OF APPROVED** MEDICAL PRACTITIONER</u></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>I confirm that identification documents were checked:
                                                        <span class="duty_as">Yes</span> / <span
                                                            class="duty_as">No</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Does the seafarers hearing meet medical standards*?
                                                        @if ($admission->exam_audio)
                                                            <span
                                                                style="text-decoration: {{ $admission->exam_audio->remarks_status == 'normal' ? 'underline' : 'none' }}">Yes</span>
                                                        @else
                                                            <span style="">Yes</span>
                                                        @endif
                                                        /
                                                        @if ($admission->exam_audio)
                                                            <span
                                                                style="text-decoration: {{ $admission->exam_audio->remarks_status == 'findings' ? 'underline' : 'none' }}">No</span>
                                                        @else
                                                            <span style="">No</span>
                                                        @endif
                                                        <br> <br>
                                                        ...
                                                        @if ($admission->exam_audio)
                                                            <span
                                                                style="text-decoration: {{ $admission->exam_audio->hearing == 'unaided' ? 'underline' : 'none' }}">Yes</span>
                                                        @else
                                                            <span style="">Yes</span>
                                                        @endif
                                                        /
                                                        @if ($admission->exam_audio)
                                                            <span
                                                                style="text-decoration: {{ $admission->exam_audio->hearing == 'aided' ? 'underline' : 'none' }}">No</span>
                                                        @else
                                                            <span style="">No</span>
                                                        @endif
                                                        <br> <br>
                                                        ...
                                                        @if ($admission->exam_ishihara)
                                                            <span
                                                                style="text-decoration: {{ $admission->exam_ishihara->remarks_status == 'normal' ? 'underline' : 'none' }}">Yes</span>
                                                        @else
                                                            <span style="">Yes</span>
                                                        @endif
                                                        /
                                                        @if ($admission->exam_ishihara)
                                                            <span
                                                                style="text-decoration: {{ $admission->exam_ishihara->remarks_status == 'findings' ? 'underline' : 'none' }}">No</span>
                                                        @else
                                                            <span style="">No</span>
                                                        @endif
                                                        <br> <br>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" cellspacing="5" style="margin-top: 1rem;"
                                            cellpadding="0" class="brdAll">
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td height="40">Signature of Approved** Medical Practitioner:
                                                        <span
                                                            style="margin-left: 0.5rem; border-bottom: 1px solid black;">
                                                            @if ($medical_director)
                                                                <img src="../../../app-assets/images/signatures/md_gonzales_bahamas_sig.png"
                                                ...
                                                <tr>
                                                    <td>I Name of seafarer confirm that I have been informed of the
                                                        ...
                                                        <div
                                                            ...
                                                            <div style="width: 50%">Date: (dd/mm/yyyy):
                                                                <span>{{ $admission->exam_physical ? date_format(new DateTime($admission->exam_physical->date_examination), 'd/F/Y') : null }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        <table width="100%" cellspacing="5" cellpadding="5">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            height="100%" style="margin-top: 1rem;">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="33%">
                                                ...
                                                <tr colspan="10">
                                                    <td>
                                                        <table width="100%" cellspacing="0" cellpadding="5"
                                                            class="brdTop" style="margin: 4rem 0 2rem 0;">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        B103 Rev.03 <br>
                                                                    ...
                                                                    <td align="center">
                                                                        SEAFARER MEDICAL EXAMINATION AND CERTIFICATE
                                                                        <br>
                                                                        <span
                                                                            style="color: blue;">stcw@bahamasmaritime.com</span>
                                                                        <br>
                                                                        <span
                                                                            style="color: blue;">mlc@bahamasmaritime.com</span>
                                                                    </td>
                                                                    <td>
                                                                        <div style="text-align: center;">Page 21 of 22
                                                                        </div>
                                                                        +44 20 7562 1300
                                                                    </td>
                                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" cellspacing="0" cellpadding="5"
                                                            class="brdTop" style="margin: 19rem 0 0rem 0;">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        B103 Rev.03 <br>
                                                                    ...
                                                                    <td>
                                                                        <div style="text-align: center;">Page 22 of 22
                                                                        </div>
                                                                        +44 20 7562 1300
                                                                    </td>
                                                                </tr>
