...
<body>
    <center>
        <table width="735" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <img src="../../../app-assets/images/logo/marine-med-logo.png" width="70" height="70"
                        alt="">
                </td>
                <td>
                        ...
                        <tbody>
                            <tr>
                                <td width="10" rowspan="3" align="center">
                                    <img src="../../../app-assets/images/logo/logo.jpg" width="65" height="65"
                                        alt="">
                                </td>
                                <td width="525" rowspan="3" align="center" valign="center">
                                    <span class="lblCompName"
                                        style="font-size: 26px; font-weight: 800;font-family: serif; color: #156f29">MERITA
                                        DIAGNOSTIC CLINIC INC.</span><br style="margin-bottom: 10px">
                                    <div style="color: #156f29; font-size: 10.5px;">
                                        ...
                                        Tel Nos.: (632) 8404-3411 / (633) 7003-0403 * Cell No.: +63917 857-6942 / +63908
                                        890-8850<br>
                                        Email: meritaclinic@gmail.com / meritadiagnosticclinic@yahoo.com<br>
                                        Accredited: DOH (RLS 13-026-2123-MF-2) &#8226; POEA &#8226; MARINA Global Group
                                        ISO 9001:2015<br>Skuld
                                        P&amp;I &#8226; West of England P&amp;I &#8226; Oil &amp; Gas UK &#8226; Panama
                                        Maritime Authority</div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                ...
                                <table width="735" border="0" cellpadding="3" cellspacing="0" class="brdMLC">
                                    ...
                                    <tr>
                                        <td colspan="5" valign="top">
                                            ADDRESS:<br>
                                            <span
                                                class="fontMed">{{ $admission->patient->patientinfo->address }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" valign="top">
                                            PASSPORT NO.:<br>
                                            <span
                                                class="fontMed">{{ $admission->patient->patientinfo->passportno }}</span>
                                        </td>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td width="87%" valign="middle">FIT BUT AT RISK? <br>
                                                        ...
                                                        <input name="co"
                                                            value="{{ $admission->exam_physical ? $admission->exam_physical->describe_restriction : null }}"
                                                            class="brdNone"
                                                            style="width:450px;height: 15px;font-size: 10px;text-align:left;border: none;" />
                                                    </td>
                                                    <td width="4%" valign="middle">YES</td>
                                                    <td width="3%" valign="middle">
                                                        @if ($admission->exam_physical)
                                                        ...
                                                        <table width="500" border="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td colspan="2">THIS IS TO CERTIFY THAT A MEDICAL
                                                                    AND PHYSICAL EXAMINATION IN ACCORDANCE WITH THE <br>
                                                                    STANDARD CLUB PART OF NORTHSTANDARD RECOMMENDED
                                                                    PROTOCOLS HAS BEEN CARRIED OUT <br>
                                                                    ...
                                                                    <span style="margin-left:20px">NAME OF
                                                                        SEAFARER</span><br>
                                                                    <span class="fontMed"><span>RESULT:</span> <span
                                                                        ...
                                                                        <span style="margin-left: 20px;">FIT BUT AT
                                                                            RISK
                                                                            @if ($admission->exam_physical)
                                                                                @if ($admission->exam_physical->seastatus == 'seafit with restriction')
                                                                                    <img src="../../../app-assets/images/icoCheck.gif"
                                                                ...
                                                                <td valign="bottom" class="">
                                                                    ...
                                                                    @if ($admission->exam_physical)
                                                                        <span
                                                                            ...
                                                                            {{ $admission->exam_physical->first_tech->lastname }}</span>
                                                                    @endif <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" class="brdLeft">
                                                        <table width="100%" border="0" cellspacing="0"
                                                            cellpadding="0">
                                                            <tr>
                                                                <td valign="top">NAME OF CLINIC: MERITA DIAGNOSTIC
                                                                    CLINIC INC.<br>
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="100%" cellpadding="2" cellspacing="0" class="brdMLC"
                                    ...
                                    <tr>
                                        <td colspan="6" style="font-size:12px"> <b>DATE OF ISSUANCE:
                                            </b>{{ $admission->exam_physical ? date_format(new DateTime($admission->exam_physical->peme_date), 'd F Y') : null }}
                                        </td>
