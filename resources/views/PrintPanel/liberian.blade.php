...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            ...
            <tr>
                <td width="100%">
                    <table cellspacing="0" cellpadding="10" width="100%" class="brdAll">
                        <tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="brdRight" width="50%">
                                    ...
                                    <table cellpadding="10" style="font-size: 12px" width='100%'>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="25%">MATE</td>
                                                <td width="25%"><img style="margin-left: 2rem; margin-right: 1rem;" src="../../../app-assets/images/icoUncheck.gif" width="20" height='15' class="checkbox"></td>
                                                <td width="25%">MOU DECK</td>
                                                <td width="25%"><img style="margin-left: 2rem; margin-right: 1rem;" src="../../../app-assets/images/icoUncheck.gif" width="20" height='15' class="checkbox"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="25%">MOU ENGINE</td>
                                                <td width="25%"><img style="margin-left: 2rem; margin-right: 1rem;" src="../../../app-assets/images/icoUncheck.gif" width="20" height='15' class="checkbox"></td>
                                            </tr>
                                            <tr>
                                                <td width="25%">RADIO OFF</td>
                                                <td width="25%"><img style="margin-left: 2rem; margin-right: 1rem;" src="../../../app-assets/images/icoUncheck.gif" width="20" height='15' class="checkbox"></td>
                                                <td width="25%">SUPERNUMERARY</td>
                                                <td width="25%"><img style="margin-left: 2rem; margin-right: 1rem;" src="../../../app-assets/images/icoUncheck.gif" width="20" height='15' class="checkbox"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <table cellspacing="0" cellpadding="5" width="100%">
                        <tbody>
                            <tr style="height:65pt">
                                <td style="width:100%;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt" colspan="7">
                                    <table class="brdNone" style="font-size: 11px; width: 40%;">
                                        <tbody>
                                            <tr>
                                                <td width="45%"><b>VISION</b></td>
                                                <td align="center" width="25%"><b>RIGHT EYE</b></td>
                                                <td align="center" width="5%"></td>
                                                <td align="center" width="25%"><b>LEFT EYE</b></td>
                                            </tr>
                                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr style="height:22pt">
                                <td style="width:561pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt" colspan="7">
                                    ...
                                    <p class="s3" style="padding-left: 79pt;text-indent: 0pt;line-height: 10pt;text-align: left;">RIGHT EAR <span class="s17" style="margin-right: 13rem; margin-left: 1rem; text-decoration: underline;">NORMAL</span>LEFT EAR <span class="s18" style="margin-right: 3rem; margin-left: 3rem; text-decoration: underline;">NORMAL</span></p>
                                </td>
                            </tr>
                            <tr style="height:22pt">
                                <td class="brdTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    ...
                                                    <div style="display: flex; align-items: center; justify-content: center; width: 100%; padding: 1rem;">
                                                        <div style="width: 50%;">
                                                            <div class="s3" style="padding-left: 5pt;text-indent: 0pt;line-height: 9pt;text-align: left; width: 50%;">UPPER <span class="brdBtm">NORMAL</span></div>
                                                        </div>
                                                        <div style="width: 30%;">
                                                            <p class="s3" style="padding-left: 5pt;text-indent: 0pt;line-height: 9pt;text-align: left;">LOWER <span class="brdBtm">NORMAL</span></p>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <tr style="height:112pt">
                <td style="width:561pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt" colspan="7">
                    <div style="width: 100%; display: flex; align-items: flex-end; justify-content: space-around; margin-bottom: 1rem;">
                        <div>
            ...
            <tr style="height:95pt">
                <td style="width:561pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt" colspan="7">
                    ...
                    <u style="margin-right: 1rem;"> <img src="../../../app-assets/images/signatures/md_gonzales_sig.png" width="310" height="65" style="object-fit: cover; transform: translate(-30px, 19px); margin-top: -25px;" /></u>
            ...
            <tr style="height:84pt">
                <td style="width:561pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;" colspan="7">
                    <p class="s8" style="padding-left: 59pt;padding-right: 41pt;text-indent: -49pt;text-align: left; font-size: 11px;">This certificate is issued by authority of the Deputy Commissioner of Maritime Affairs, R.L. and in compliance with the requirements of the Maritime Labour Convention, 2006 for the Medical Examination of Seafarers.</p>
                    <p class="s8" style="padding-top: 1pt;padding-left: 59pt;padding-right: 41pt;text-indent: -43pt;text-align: left; font-size: 11px;">The Medical Certificate shall be valid for no more than two (2) years from the date of the Examination for those over 18 years of age and for no more than one (1) year for those under 18 years of age.</p>
                    <p class="s8" style="padding-top: 3pt;padding-left: 9pt;text-indent: 0pt;text-align: left; font-size: 11px;">RLM-l05M (REV. 06/16) <span class="s25">1</span></p>
                </td>
            </tr>
        </tbody>
    </table>
    <div style="height: 80px"></div>
    <div style="border: 1px solid black; padding: 1rem 1rem 3rem 1rem;">
            ...
            <ol id="l1">
                <li data-list-text="(a)">
                    <p style="text-align: justify;">All applicants must have hearing unimpaired for normal sounds and be capable of hearing a whispered voice in the better ear at 15 feet and in the poorer ear at 5 feet.</p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                </li>
                <li data-list-text="(b)">
                    <p style="text-align: justify;">Deck officer applicants must have (either with or without glasses) at least 20/20 vision in one eye and at least 20/40 in the other. If the applicant wears glasses, he must have vision without glasses of at least 20/160 in both eyes. Deck
                ...
                <li data-list-text="(c)">
                    <p style="text-align: justify;">Engineer and radio officer applicants must have (either with or without glasses) at least 20/30 vision in one eye and at least 20/50 in the other. If the applicant wears glasses, he must have vision without glasses of at least 20/200 in both
                        eyes. Engineer and radio officer applicants must also be able to perceive the colors red, yellow and green.</p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                </li>
                <li data-list-text="(d)">
                    <p style="text-align: left;">An applicant's blood pressure must fall within an average range, taking age into consideration.</p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                </li>
                <li data-list-text="(e)">
                    <p style="text-align: justify;">Applicants afflicted with any of the following diseases or conditions shall be disqualified: epilepsy, insanity, senility, alcoholism, tuberculosis, acute venereal disease or neurosyphilis, AIDS and/or the use of narcotics.</p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                </li>
                <li data-list-text="(f)">
                    <p style="text-align: justify;">Deck/Navigational officer applicants and Radio officer applicants must have speech which is unimpaired for normal voice communication.</p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                </li>
                <li data-list-text="(g)">
                    <p style="text-align: justify;">Applicants for able seaman, bosun, GP-1, ordinary seaman and junior ordinary seaman must meet the physical requirements for a deck/navigational officer's certificate.</p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                </li>
                <li data-list-text="(h)">
                    <p style="text-align: justify;">Applicants for fireman/watertender, oiler/motorman, pumpman, electrician ,wiper, tankerman and survival craft/rescue boat crewman must meet the physical requirements for an engineer officer's certificate.</p>
                </li>
            </ol>
            <p style="text-indent: 0pt;text-align: left;"><br><br><br></p>
            <p style="text-indent: 0pt;text-align: center;">DETAILS OF MEDICAL EXAMINATION</p>
            <p class="s26" style="text-indent: 0pt;text-align: center;">(To be completed by examining physician)</p>
