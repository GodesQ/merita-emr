                ...
                @if(count($yellow_card_records) > 0)
                    ...
                    <table class="table table-bordered">
                        <tbody id="repeating_yellow_form">
                            ...
                            <tr class="entry">
                                <td class="d-none">
                                    <input type="hidden" name="count[]" value="{{$yellow_card_record->count}}" id="count" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="vaccine[]" readonly value="{{$yellow_card_record->vaccine}}" class="form-control">
                                </td>
                                <td>
                                    <input type="date" name="date[]" max="2050-12-31" value="{{$yellow_card_record->date}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="manufacturer[]"  value="{{$yellow_card_record->manufacturer}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="cert_valid[]" value="{{$yellow_card_record->cert_valid}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="official_stamp[]" value="{{$yellow_card_record->official_stamp}}" class="form-control">
                                </td>
                                <!-- <td>
