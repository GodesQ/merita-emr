                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>Aware of any disease / illness <br>
                                <br><input name="illness_other" type="input" id="illness_other" value="{{ $medicalHistory->illness_other }}"></th>
                            </th>
                            <td>
                                <fieldset>
                                    <div
            ...
            <div class="col-md-12">
                <table
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>Smoking <br><input name="smoking_other" type="input" id="smoking_other" value="{{ $medicalHistory->smoking_other }}"></th>
                            <td>
                                <fieldset>
                                    <div
                                        class="custom-control custom-radio">
