                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="tab-content px-1 pt-1">
                                                        <div class="tab-pane main-content @php echo session()->get('dept_id') == " 1" ? "active" : "" @endphp"
                                                            ...
                                                            <fieldset class="my-2">
                                                                <form action="#" id="update_patient_basic"
                                                                    method="POST">
                                                                    @csrf
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select required class="form-control"
                                                                                    ...
                                                                                    <option value="">Select
                                                                                        Occupation</option>
                                                                                    <option
                                                                                        {{ $patientInfo->occupation == 'SEAMAN' ? 'selected' : null }}
                                                                                        value="SEAMAN">SEAMAN</option>
                                                                                    <option
                                                                                        {{ $patientInfo->occupation == 'SEAWOMAN' ? 'selected' : null }}
                                                                                        value="SEAWOMAN">SEAWOMAN</option>
                                                                                    <option
                                                                                        {{ $patientInfo->occupation == 'OTHER' ? 'selected' : null }}
                                                                                ...
                                                                                <div class="form-group occupation_other_container"
                                                                                    ...
                                                                                    <label for="">Please
                                                                                        Specify</label>
                                                                                    <input type="text"
                                                                                        placeholder="Plese Specify"
                                                                                        name="occupation_other"
                                                                                        id="occupation_other"
                                                                                        class="form-control"
                                                                                        value="{{ $patientInfo->occupation_other }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="form-control"
                                                                                    name="gender">
                                                                                    <option value="Male"
                                                                                        {{ $patient->gender == 'Male' ? 'selected' : null }}>
                                                                                        MALE</option>
                                                                                    <option value="Female"
                                                                                        {{ $patient->gender == 'Female' ? 'selected' : null }}>
                                                                                        FEMALE</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="religion" id="religion"
                                                                                    class="form-control"
                                                                                    onchange="selectReligion(this)">
                                                                                    <option
                                                                                        {{ $patientInfo->religion == 'ROMAN CATHOLIC' ? 'selected' : null }}
                                                                                        value="ROMAN CATHOLIC">ROMAN
                                                                                        CATHOLIC</option>
                                                                                    <option
                                                                                        {{ $patientInfo->religion == 'IGLESIA NI CRISTO' ? 'selected' : null }}
                                                                                        value="IGLESIA NI CRISTO">IGLESIA
                                                                                        NI CRISTO</option>
                                                                                    <option
                                                                                        {{ $patientInfo->religion == 'EVANGELICALS' ? 'selected' : null }}
                                                                                        value="EVANGELICALS">EVANGELICALS
                                                                                    </option>
                                                                                    <option
                                                                                        {{ $patientInfo->religion == 'SEVENTH DAY ADVENTIST' ? 'selected' : null }}
                                                                                        value="SEVENTH DAY ADVENTIST">
                                                                                        SEVENTH DAY ADVENTIST</option>
                                                                                    <option
                                                                                        {{ $patientInfo->religion == 'ISLAM' ? 'selected' : null }}
                                                                                        value="ISLAM">ISLAM</option>
                                                                                    <option
                                                                                        {{ $patientInfo->religion == 'UECFI' ? 'selected' : null }}
                                                                                        value="UECFI">UECFI</option>
                                                                                    <option
                                                                                        {{ $patientInfo->religion == 'OTHERS' ? 'selected' : null }}
                                                                                ...
                                                                                <div class="form-group religion_other_container"
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        id="religion_other"
                                                                                        class="form-control"
                                                                                        value="{{ $patientInfo->religion_other }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select onchange="getPackages(this)"
                                                                                    id="agency"
                                                                                    class="form-control select2"
                                                                                    name="agency_id">
                                                                                    @if ($patient_agency)
                                                                                        <option
                                                                                            value="{{ $patient_agency->id }}">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="medicalPackage"
                                                                                    id="packages"
                                                                                    class="form-control select2">
                                                                                    @if ($patient_package)
                                                                                        <option
                                                                                            value="{{ $patient_package->id }}"
                                                                                            selected>
...
echo $patientInfo->category ==
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div
                                                                                class="form-group hartmann-principal remove">
                                                                                <label for="">
                                                                                    Hartmann Principal :
                                                                                    <span class="primary h6">(If not
                                                                                        applicable, please write N/A)</span>
                                                        ...
                                                        <div class="tab-pane main-content" id="tabIcon34" role="tabpanel"
                                                            ...
                                                            @else
                                                                <fieldset>
                                                                    <form id="update_patient_declaration_form"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="main_id"
                                                                            value="{{ $patient->id }}">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12 travel isTravel">
                                                                                <div class="form-group">
                                                                                    <label for="">Name of the
                                                                                        area(s) visited
                                                                                        <span class="danger">*</span>
                                                                                    </label>
                                                                                    <fieldset>
                                                                                        <input name="area_visited"
                                                                                            type="text" id=""
                                                                            ...
                                                                            <div
                                                                                class="col-md-12 mt-2 show-if-contact hide">
                                                                                <div class="form-group">
                                                                                    <label for="">Your relationship
                                                                                        with the people and your
                                                                            ...
                                                                            <div class="col-md-12 mt-2">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <table
                                                                                            class="table table-striped ml-1">
                                                                                            <tr>
                                                                                                <th>Fever</th>
                                                                                                <td>
                                                                                                    <fieldset>
...
echo
                                                        ...
                                                        <div class="tab-pane main-content" id="tabIcon36"
                                                            role="tabpanel" aria-labelledby="baseIcon-tab36">
                                                            <div class="col-md-12">
                                                                @if ($patientCode == null)
                                                                    <div
                                                                        class="container d-flex justify-content-center align-items-center flex-column">
                                                                        ...
                                                                        @if (session()->get('dept_id') == '3' || session()->get('dept_id') == '1' || session()->get('dept_id') == '8')
                                                                            ...
                                                                            <div class="tab-content px-1">
                                                                                <div class="tab-pane"
                                                                                    ...
                                                                                    @else
                                                                                        @include(
                                                                                            'Blood_Serology.view-bloodserology',
                                                                                            [$exam_xray]
                                                                                        )
                                                                                    @endif
                                                                                </div>
                                                                                <div class="tab-pane child-lab-content"
                                                                                    id="tabVerticalLeft22"
                                                                                    role="tabpanel"
                                    ...
                                    <div class="card-body">
                                        @if ($latest_schedule)
                                            <form action='/update_schedule' method="POST">
                                                @csrf
                                                <h4 class="form-section"><i class="feather icon-user"></i>Re Schedule
                                                </h4>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                            ...
                                            <div class="tab-content px-1 pt-1">
                                                @forelse($followup_records as $key => $followup_record)
                                                    <div class="tab-pane" id="fl{{ $key }}" role="tabpanel"
                                                        ...
                                                        <div class="my-1">
                                                            <button type="button"
                                                                class="btn btn-danger delete-followup"
                            ...
                            @endif
                            @if ($patientCode)
                                <div class="tab-     fade" id="account-vertical-social" role="tabpanel"
                                                ...
                                                <div class="col-lg-4 col-xl-3 col-sm-6 ">
                                                    <div class="print-con">
                                                        ...
                                                        <div class="print-btn-div">
                                                            <button type="button" onclick="window.open('/mlc_print?id={{ $patientCode->id }}','wp','width=1000,height=800').print();"
                        ...
                        <div class="row p-50 rounded" style="background: #091a3b">
                                        ...
                                        <button class="btn btn-solid p-0 open-camera" onclick="openCamera()">
                                            @if (
                                                ...
                                                <img src="../../../app-assets/images/profiles/profilepic.jpg"
                                                    ...
                                                    data-target="#defaultSize" class="users-avatar-shadow rounded"
                                            ...
                                            @else
                                                <img src="../../../app-assets/images/profiles/{{ $patient->patient_image . '?' . $patient->updated_date }}"
                                                    ...
                                                    alt="Profile Picture" class="users-avatar-shadow" height="110"
                                                    width="110">
                                            @endif
                                        </button>
                                    </div>
                                        ...
                                        <div class="pt-25">
                                            <div class="d-flex justify-content-start align-items-end my-25">
                                                @if ($patient->patient_signature)
                                                    <img src="@php echo base64_decode($patient->patient_signature) @endphp" class="signature-taken"
                                            ...
                                            <div class="mb-50">
                                                <a href="/patient_edit/crop_signature?patient_id={{ $patient->id }}" class="btn btn-primary btn-sm">
                                            ...
                                            <div class="users-view-id text-white">PATIENT ID:
                                                {{ $patient->patientcode }}
                                            </div>
                                            <div class="text-white">
                                                ADMISSION ID: {{ $patientCode ? $patientCode->id : "N/A" }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if ($patientCode)
                                <div class="col-lg-5 col-md-4 col-xl-12 my-1">
                                    ...
                                    <div class="my-1">
                                        <button type="button"
                                            class="btn btn-sm p-75 m-25 text-white btn-outline-primary {{ $patientCode->lab_status == 1 ? 'active' : null }}"
                                            data-toggle="modal" data-target="#pendingModal">
                                            PENDING
                                        </button>
                                        <button data-toggle="modal" data-target="#fitModal" type="button"
                                            class="btn btn-sm p-75 m-25 text-white btn-outline-success {{ $patientCode->lab_status == 2 ? 'active' : null }}"
                                            id="done-btn">FIT</button>
                                        <button type="button"
                                            class="btn btn-sm p-75 m-25 text-white btn-outline-primary {{ $patientCode->lab_status == 3 ? 'active' : null }}"
                                            data-toggle="modal" data-target="#unfitModal">
                                            UNFIT
                                        </button>
                                        <button data-toggle="modal" data-target="#unfitTempModal" type="button"
                                            class="btn btn-sm p-75 text-white m-25 btn-outline-info {{ $patientCode->lab_status == 4 ? 'active' : null }}"
