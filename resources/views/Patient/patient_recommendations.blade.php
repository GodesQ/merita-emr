            ...
            @if ($exam_xray)
                @if($exam_xray->chest_remarks_status == 'findings')
                    <div class="col-md-6 my-50">
                        ...
                        <span style="font-size: 12px;">@php echo nl2br($exam_xray->chest_recommendations) @endphp</span>
                    </div>
                @endif
            @endif
            ...
            @if ($exam_xray)
                @if($exam_xray->lumbosacral_remarks_status == 'findings')
                    <div class="col-md-6 my-50">
                        ...
                        <span style="font-size: 12px;">@php echo nl2br($exam_xray->lumbosacral_recommendations) @endphp</span>
                    </div>
                @endif
            @endif
            ...
            @if ($exam_xray)
                @if($exam_xray->knees_remarks_status == 'findings')
                    <div class="col-md-6 my-50">
                        ...
                        <span style="font-size: 12px;">@php echo nl2br($exam_xray->knees_recommendations) @endphp</span>
                    </div>
                @endif
            @endif
