                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-primary" id="return_signature_btn" type="btn">Return to Default Signature</button>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Patient Code</label>
                                    <input type="text" value="{{ $patient->patientcode}}" name="patientcode" readonly class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Patient Code</label>
                                    <input type="text" value="{{ $patient->firstname . " " . $patient->lastname }}" name="patientcode" readonly class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row my-2">
                            <div class="col-md-6">
                                @if($patient->patient_signature)
                                    <img class="crop-image" src="@php echo base64_decode($patient->patient_signature) @endphp" style="width: 100%;"/>
