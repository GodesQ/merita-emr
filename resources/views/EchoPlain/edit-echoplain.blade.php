                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button
                                            onclick='window.open("/exam_echoplain_print?id={{ $exam->admission_id }}", "width=800,height=650").print()'
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="7" align="left"><input name="clinical_diagnostic"
                                                    type="text" id="clinical_diagnostic"
                                                    value="{{ $exam->clinical_diagnostic }}" class="form-control"></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><b>Height (cm) </b></td>
                                            <td width="8%" align="left"><input name="height" type="text"
                                                    id="height" value="{{ $exam->height }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            <td width="17%" align="right"><b>Weight
                                                    (kg) </b></td>
                                            <td width="8%" align="left"><input name="weight" type="text"
                                                    id="weight" value="{{ $exam->weight }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            <td width="12%" align="right"><b>BP</b></td>
                                            <td width="8%" align="left"><input name="bp" type="text"
                                                    id="bp" value="{{ $exam->bp }}" size="15"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left"><input name="study_no" type="text" id="study_no"
                                                    value="{{ $exam->study_no }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            ...
                                            <td align="left"><input name="hr" type="text" id="hr"
                                                    value="{{ $exam->hr }}" class="form-control" style="width:50px">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="sv" type="text" id="sv"
                                                    value="{{ $exam->sv }}" class="form-control" style="width:50px">
                                            </td>
                                            <td colspan="2" align="center"><input name="sv_simp" type="text"
                                                    id="sv_simp" value="{{ $exam->sv_simp }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            <td colspan="3" align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="co" type="text" id="co"
                                                    value="{{ $exam->co }}" class="form-control" style="width:50px">
                                            </td>
                                            <td colspan="2" align="center"><input name="co_simp" type="text"
                                                    id="co_simp" value="{{ $exam->co_simp }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            <td colspan="3" align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="ef" type="text" id="ef"
                                                    value="{{ $exam->ef }}" class="form-control" style="width:50px">
                                            </td>
                                            <td colspan="2" align="center"><input name="ef_simp" type="text"
                                                    id="ef_simp" value="{{ $exam->ef_simp }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="fs" type="text" id="fs"
                                                    value="{{ $exam->fs }}" class="form-control" style="width:50px">
                                            </td>
                                            <td colspan="2" align="center"><input name="fs_simp" type="text"
                                                    id="fs_simp" value="{{ $exam->fs_simp }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="vcf" type="text" id="vcf"
                                                    value="{{ $exam->vcf }}" class="form-control" style="width:50px">
                                            </td>
                                            <td colspan="2" align="center"><input name="vcf_simp" type="text"
                                                    id="vcf_simp" value="{{ $exam->vcf_simp }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="lmv" type="text" id="lmv"
                                                    value="{{ $exam->lmv }}" class="form-control" style="width:50px">
                                            </td>
                                            <td colspan="2" align="center"><input name="lmv_simp" type="text"
                                                    id="lmv_simp" value="{{ $exam->lmv_simp }}" class="form-control"
                                                    style="width:50px">
                                            </td>
                                            <td colspan="3" align="center">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="mpa" type="text" id="mpa"
                                                    value="{{ $exam->mpa }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center">&nbsp;</td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="dt" type="text" id="dt"
                                                    value="{{ $exam->dt }}" class="form-control" style="width:50px">
                                            </td>
                                            <td width="12%">L1</td>
                                            <td align="center"><input name="l1" type="text" id="l1"
                                                    value="{{ $exam->l1 }}" class="form-control" style="width:50px">
                                            </td>
                                            <td width="8%">LVMI</td>
                                            <td align="center"><input name="lvmi" type="text" id="lvmi"
                                                    value="{{ $exam->lvmi }}" class="form-control" style="width:50px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="l2" type="text" id="l2"
                                                    value="{{ $exam->l2 }}" class="form-control" style="width:50px">
                                            </td>
                                            <td>RWT</td>
                                            <td align="center"><input name="rwt" type="text" id="rwt"
                                                    value="{{ $exam->rwt }}" class="form-control" style="width:50px">
                                            </td>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="rv" type="text" id="rv"
                                                    value="{{ $exam->rv }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center">(2.2 - 4.0)</td>
                                            <td>PV Flow</td>
                                            <td align="center"><input name="pvf" type="text" id="pvf"
                                                    value="{{ $exam->pvf }}" class="form-control" style="width:50px">
                                            </td>
                                            <td>A1</td>
                                            <td><input name="a1" type="text" id="a1"
                                                    value="{{ $exam->a1 }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center"></td>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="ra" type="text" id="ra"
                                                    value="{{ $exam->ra }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center">(3.5 - 4.5)</td>
                                            <td>PV E</td>
                                            <td align="center"><input name="pve" type="text" id="pve"
                                                    value="{{ $exam->pve }}" class="form-control" style="width:50px">
                                            </td>
                                            <td>A2</td>
                                            <td><input name="a2" type="text" id="a2"
                                                    value="{{ $exam->a2 }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center"></td>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="mva" type="text" id="mva"
                                                    value="{{ $exam->mva }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center">&nbsp;</td>
                                            <td>PV A</td>
                                            <td align="center"><input name="pva" type="text" id="pva"
                                                    value="{{ $exam->pva }}" class="form-control" style="width:50px">
                                            </td>
                                            <td>LA Vol.</td>
                                            <td><input name="lav" type="text" id="lav"
                                                    value="{{ $exam->lav }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center"></td>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="tva" type="text" id="tva"
                                                    value="{{ $exam->tva }}" class="form-control" style="width:50px">
                                            </td>
                                            <td align="center">&nbsp;</td>
                                            <td>PV AR</td>
                                            ...
                                            <td>Tapse</td>
                                            <td>
                                                <input name="tapse" type="text" id="tapse"
                                                    value="{{ $exam->tapse }}" class="form-control" style="width:50px">
                                            </td>
                                            <td>&nbsp;</td>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="interpretation" id="interpretation" cols="50" rows="7" class="form-control">{{ $exam->interpretation }}</textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="conclusion" id="conclusion" cols="50" rows="7" class="form-control">{{ $exam->conclusion }}</textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select required name="technician_id"
                                                                        ...
                                                                        @foreach ($cardiologists as $cardiologist)
                                                                            <option value={{ $cardiologist->id }}
                                                                                {{ $cardiologist->id == $exam->technician_id ? 'selected' : null }}>
                                                                                {{ $cardiologist->firstname }}
                                                                                {{ $cardiologist->lastname }}
                                                                                {{ $cardiologist->title }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </td>
