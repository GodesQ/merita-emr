                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="12%" align="left"><input name="bp" type="text"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input name="pve" type="text" id="pve"
                                                    value="" class="form-control" style="width:50px"></td>
                                            <td>A2</td>
                                            <td><input name="a2" type="text" id="a2" value=""
                                                    class="form-control" style="width:50px"></td>
                                            <td align="center"></td>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="center"><input name="pva" type="text" id="pva"
                                                    value="" class="form-control" style="width:50px"></td>
                                            <td>LA Vol.</td>
                                            <td><input name="lav" type="text" id="lav" value=""
                                                    class="form-control" style="width:50px"></td>
                                            <td align="center"></td>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="interpretation" id="interpretation" cols="50" rows="7" class="form-control">
                                                ...
                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="85%">
                                                                <textarea name="conclusion" id="conclusion" cols="50" rows="7" class="form-control">Normal pulmonary arterial pressure</textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                            ...
                                                            <td colspan="4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="remarks_status" type="radio"
                                                                        ...
                                                                        value="findings">With Findings <br>
