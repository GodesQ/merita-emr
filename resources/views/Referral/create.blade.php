        ...
        <div class="container my-4">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Add Referral Slip</div>
                </div>
                <div class="card-body">
                    <form action="">
                        <div class="row">
                            <div class="col-md-12 my-1">
                                <div class="card">
                                    <div class="alert alert-danger alert-dismissible mb-2 d-none" id="error"
                                        role="alert">
                                        ...
                                        <div class="card-body">
                                            <form class="form" method="POST" id="referrals/store">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="lastname"
                                                                class="form-control lastname" placeholder="Lastname"
                                                                name="lastname">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger danger"
                                                                error-name="email_employee"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="passport">Passport No. <span
                                                                    class="danger">*</span></label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="passport_expdate">Passport Expiry Date <span
                                                                    class="danger">*</span></label>
                                                            <input type="date" name="passport_expdate"
                                                                id="passport_expdate" class="form-control" />
                                                            <span class="text-danger danger"
                                                                error-name="passport_expdate"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="ssrb">SIRB No <span
                                                                    class="danger">*</span></label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="agency_address">Address of Agency <span
                                                                    class="danger">*</span></label>
                                                            <input type="text" id="agency_address"
                                                                class="form-control" placeholder="Address of Agency"
                                                                name="agency_address" readonly
                                                                value="{{ session()->get('address') }}">
                                                            <span class="text-danger danger"
                                                                error-name="agency_address"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="country_destination">Country of Destination <span
                                                                    class="danger">*</span></label>
                                                            <input type="text" id="country_destination"
                                                                class="form-control" placeholder="Country of Destination"
                                                                name="country_destination" value="WORLDWIDE">
                                                            <span class="text-danger danger"
                                                                error-name="country_destination"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="position_applied">Position Applied For <span
                                                                    class="danger">*</span></label>
                                                            <input type="text" id="position_applied"
                                                                class="form-control" placeholder="Position Applied"
                                                                name="position_applied">
                                                            <span class="text-danger danger"
                                                                error-name="position_applied"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="vessel">Vessel <span
                                                                    class="danger">*</span></label>
                                                            {{-- @if (count($vessels) > 0)
                                                            ...
                                                            <div class="container-fluid ">
                                                                <div
                                                                    ...
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="admission_type1" name="admission_type"
                                                                        value="Normal" checked>
                                                                    <label class="custom-control-label"
                                                                        for="admission_type1">Regular
                                                                        Patient</label>
                                                                </div>
                                                                <div
                                                                    class="d-inline-block custom-control custom-radio mr-1">
                                                                    <input type="radio" class="custom-control-input"
                                                                        id="admission_type2" name="admission_type"
                                                                        value="Rush">
                                                                    <label class="custom-control-label"
                                                                        for="admission_type2">Rush
                                                                        Patient</label>
                                                                </div>
                                                            </div>
                                                            <span class="text-danger danger"
                                                                error-name="admission_type"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger danger"
                                                                error-name="custom_request"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group d-none">
                                                            ...
                                                            <input required type="text" id="agencyname"
                                                                class="form-control" placeholder="Agency / Company"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="row">
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="SKULD"
                                                                        id="skuld">
                                                                    <label class="custom-control-label"
                                                                        for="skuld">SKULD</label>
                                                                </div>
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="WEST OF ENGLAND"
                                                                        id="woe">
                                                                    <label class="custom-control-label"
                                                                        for="woe">WEST OF
                                                                        ENGLAND</label>
                                                                ...
                                                                <div class="input-group mt-50 d-none" id="woe_qty">
                                                                    <input type="number" min="1" max="5"
                                                                        class="form-control"
                                                                        placeholder="West of England Quantity"
                                                                        name="woe_qty">
                                                                </div>
                                                            </fieldset>
                                                            </fieldset>
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="LIBERIAN"
                                                                        id="liberian">
                                                                    <label class="custom-control-label"
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="CROATIAN"
                                                                        id="croatian">
                                                                    <label class="custom-control-label"
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="DANISH"
                                                                        id="danish">
                                                                    <label class="custom-control-label"
                                                                        for="danish">Danish</label>
                                                                </div>
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="DIAMLEMOS"
                                                                        id="diamlemos">
                                                                    <label class="custom-control-label"
                                                                ...
                                                                <div class="input-group mt-50 d-none" id="diamlemos_qty">
                                                                    <input type="number" min="1" max="5"
                                                                        class="form-control"
                                                                        placeholder="Diamlemos Quantity"
                                                                        name="diamlemos_qty">
                                                                </div>
                                                            </fieldset>
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="MARSHALL"
                                                                        id="marshall">
                                                                    <label class="custom-control-label"
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="MALTA"
                                                                        id="malta">
                                                                    <label class="custom-control-label"
                                                                        for="malta">Malta</label>
                                                                </div>
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="DOMINICAN"
                                                                        id="dominican">
                                                                    <label class="custom-control-label"
                                                                ...
                                                                <div class="input-group mt-50 d-none" id="dominican_qty">
                                                                    <input type="number" min="1" max="5"
                                                                        class="form-control"
                                                                        placeholder="Dominican Quantity"
                                                                        name="dominican_qty">
                                                                </div>
                                                            </fieldset>
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="BAHAMAS"
                                                                        id="bahamas">
                                                                    <label class="custom-control-label"
                                                                        for="bahamas">Bahamas</label>
                                                                </div>
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="BERMUDA"
                                                                        id="bermuda">
                                                                    <label class="custom-control-label"
                                                                        for="bermuda">Bermuda</label>
                                                                </div>
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="BAHIA"
                                                                        id="bahia">
                                                                    <label class="custom-control-label"
                                                                        for="bahia">BAHIA</label>
                                                                </div>
                                                            ...
                                                            <fieldset class="col-md-6 my-50">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        name="certificate[]" value="PANAMA"
                                                                        id="panama">
                                                                    <label class="custom-control-label"
                                                                        for="panama">PANAMA</label>
                                                                </div>
                                                ...
                                                <div class="form-actions">
                                                    <a href="/agency_dashboard" type="reset"
