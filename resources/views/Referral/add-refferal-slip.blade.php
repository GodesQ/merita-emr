...
<div class="app-content content">
    ...
    <div class="container">
        <button type="button" class="btn btn-outline-success block btn-lg d-none" id="open-instruction" data-toggle="modal"
            data-target="#large">Announcement</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container border p-1 my-1">
                            ...
                            <br><br>
                            We're excited to announce that our system now includes new input fields in the form, making it easier than ever to collect the information you need. These new fields have been added based on your feedback, and we hope they'll improve your experience with our system.
                            <br><br>
                            ...
                            If you have any questions or feedback about these new input fields, please don't hesitate to reach out to our support team. We're always here to help.
                            <br><br>
                            Best regards,
                            <br><br>
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" id="store_refferal">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Address of Employee <span class="danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Passport Expiry Date <span class="danger">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">SSRB Expiry Date <span class="danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="employer" class="form-control" placeholder="Name of Employer" name="employer" readonly value="@php echo session()->get('agencyName') @endphp">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="agency_address">Address of Agency <span class="danger">*</span></label>
                                            <input type="text" id="agency_address" class="form-control" placeholder="Address of Agency" name="agency_address" readonly value="@php echo session()->get('address') @endphp">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput4">Medical Package <span class="danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput2">Country of Destination <span class="danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="container-fluid ">
                                                <div class="d-inline-block custom-control custom-radio mr-1">
                                                    <input type="radio" class="custom-control-input" id="admission_type1" name="admission_type" value="Normal" checked>
                                                    <label class="custom-control-label" for="admission_type1">Regular Patient</label>
                                                </div>
                                                <div class="d-inline-block custom-control custom-radio mr-1">
                                                    <input type="radio" class="custom-control-input" id="admission_type2" name="admission_type" value="Rush">
                                                    <label class="custom-control-label" for="admission_type2">Rush Patient</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="container-fluid ">
                                                ...
                                                <div class="d-inline-block custom-control custom-radio mr-1">
                                                    <input type="radio" class="custom-control-input" id="payment_type2" name="payment_type" value="Billed" checked>
