...
<fieldset class="text-secondary">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" id="lastname" class="form-control lastname" placeholder="Lastname" name="lastname">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label class="text-uppercase" for="middlename">Middlename: <span class="italic">(Optional)</span></label>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="address" id="address" class="form-control" placeholder="Ex: 123 St. Sampaloc, Manila" />
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-uppercase" for="passport_expdate">Passport Expiry Date: <span class="danger">*</span></label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-uppercase" for="ssrb_expdate">SIRB Expiry Date: <span class="danger">*</span></label>
    ...
    <div class="row d-none">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-uppercase" for="agency_address">Address of Agency <span class="danger">*</span></label>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-uppercase" for="country_destination">Country of Destination <span class="danger">*</span></label>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label class="text-uppercase" for="position_applied">Position Applied For <span class="danger">*</span></label>
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label class="text-uppercase" for="principal" class="form-label">Principal <span class="text-danger danger">*</span></label>
                ...
                @else
                    <input type="text" id="projectinput4" class="form-control" placeholder="Principal"
                        name="principal">
                @endif
                <input type="text" class="form-control my-1 d-none" name="other_principal" id="other-principal"
                    placeholder="Principal">
            </div>
        </div>
    </div>
    <h4 class="form-section text-secondary text-bold-600"><i class="feather icon-user"></i> Additional Information</h4>
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <div class="form-group my-1">
                    <label class="text-uppercase" for="requestor">Name of Requestor <span class="danger">*</span></label><br>
                    <input type="text" class="form-control" name="requestor" id="requestor">
                    <span class="text-danger danger" error-name="requestor"></span>
                </div>
            </div>
            <div class="form-group">
                <label class="text-uppercase" for="projectinput4">Signature of Requestor <span class="danger">*</span></label><br>
                <div>
                    <canvas class="signature" width="320" height="95"></canvas>
                    <br>
                    <button type='button' style="width: 320px !important;" class="btn btn-solid btn-primary btn-block clear-signature">Clear</button>
                </div>
