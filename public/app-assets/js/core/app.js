                            ...
                            var $startList = "",
                                ...
                                response[0].forEach(element => {
                                    ...
                                    $startList +=  `<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer">
                                                        <a class="d-flex align-items-center justify-content-between w-100" href="/patient_edit?id=${element.id}&patientcode=${element.patientcode}">
                                                            <div class="d-flex justify-content-start">
                                                                <span class="mr-75"></span><span>${element.firstname} ${element.lastname}</span>
                                                            </div>
                                                        </a>
                                                    </li>`;
                                    a++
