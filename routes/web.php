...
Route::group(['middleware' => ['AuthCheck']], function () {
    ...
    Route::get('/schedule_appointment', [
        PatientController::class,
        'schedule_appointment',
    ]);

    Route::post('/store_schedule', [
        PatientController::class,
        'store_schedule',
    ]);

    Route::get('/edit_schedule', [
        PatientController::class,
        'edit_schedule',
    ]);

    Route::post('/update_schedule', [
        PatientController::class,
        'update_schedule',
    ]);

    Route::get('/laboratory_result', [
        PatientController::class,
        'view_laboratory',
    ]);
    ...
    Route::get('/agency_patient_table', [
        AgencyController::class,
        'agency_patient_table',
    ])->name('agency_patient_table');
    ...
    Route::get('/patients', [PatientController::class, 'view_patients'])->name(
        'patients.index'
    );
 ...
 //------------------------------- CRUD OF PATIENT IN ADMIN ACCESS ---------------------------------------- //
    ...
    Route::get('/patient_edit', [
        PatientController::class,
        'edit_patient',
    ])->name('patient_edit');

    Route::get('/patient_edit/crop_signature', [
        PatientController::class,
        'crop_signature',
    ])->name('patient.crop');
    
    Route::post('/patient_edit/return_default_signature', [
        PatientController::class,
        'return_default_signature',
    ])->name('patient.return_default_signature');

    Route::post('/patient_edit/crop_signature', [
        PatientController::class,
        'save_crop_signature',
    ])->name('patient.crop.save');

    Route::group(['middleware' => ['Patient']], function () {

        Route::get('/add_patient', [
            PatientController::class,
            'add_patient',
        ])->name('patients.add');

        Route::post('/store_patient', [
            PatientController::class,
            'store_patient',
        ])->name('patients.store');

        Route::post('/update_patient_basic', [
            PatientController::class,
            'update_patient_basic',
        ])->name('update_patient_basic');

        Route::post('/update_patient_agency', [
            PatientController::class,
            'update_patient_agency',
        ])->name('update_patient_agency');

        Route::post('/update_patient_medical_history', [
            PatientController::class,
            'update_patient_medical_history',
        ])->name('update_patient_medical_history');

        Route::post('/update_patient_declaration_form', [
            PatientController::class,
            'update_patient_declaration_form',
        ])->name('update_patient_declaration_form');

        Route::post('/store_patient_files', [
            PatientController::class,
            'store_patient_files',
        ])->name('store_patient_files');

        Route::delete('/patient_delete', [
            PatientController::class,
            'delete_patient',
        ])->name('patientsDelete');
    ...
    // -------------------------------- CRUD OF ALL RELATED IN ADMISSION -------------------------------------------//
     Route::get('/admission_print', [
        PrintController::class,
        'admission_print',
    ]);

    Route::get('/select_admission', [
    ...
    Route::get('/admission_selects', [
        AdmissionController::class,
        'admission_selects',
    ])
        ->name('admission_selects');

    Route::get('/create_admission', [
        AdmissionController::class,
        'create_admission',
    ])
    ...
    Route::post('/update_lab_result', [
        AdmissionController::class,
        'update_lab_result',
    ])->name('update_lab_result')
    ->middleware([Transaction::class]);

    Route::post('create_followup', [
        AdmissionController::class,
        'create_followup',
    ]);

    Route::post('destroy_followup', [
        AdmissionController::class,
        'destroy_followup',
    ]);
    ...
    Route::get('/agencies', [
            AgencyController::class,
            'view_agencies',
        ])->name('agencies.index')->middleware([Agency::class]);

        Route::get('/get_agencies', [
            AgencyController::class,
            'get_agencies',
        ])->name('agencies.get')->middleware([Agency::class]);

        Route::get('/add_agency', [
            AgencyController::class,
            'add_agency',
        ])->name('agency.add')->middleware([Agency::class]);

        Route::post('/store_agency', [
            AgencyController::class,
            'store_agency',
        ])->name('agency.store')->middleware([Agency::class]);

        Route::get('/edit_agency', [
            AgencyController::class,
            'edit_agency',
        ])->name('agency.edit')->middleware([Agency::class]);

        Route::post('/update_agency', [
            AgencyController::class,
            'update_agency',
        ])->name('agency.update')->middleware([Agency::class]);

        Route::delete('/agency_delete', [
            AgencyController::class,
            'delete_agency',
        ])->name('agency.delete')->middleware([Agency::class]);
    ...
    // -------------------------------- START CRUD OF ALL RECEPTION ADMIN---------------------------//
     Route::group(['middleware' => ['ReceptionAdmin']], function () {
        ...
        Route::get('/list_package', [
            PackageController::class,
            'view_list_package',
        ])->name('package.index');

        Route::get('/get_list_package', [
            PackageController::class,
            'get_list_package',
        ])->name('package.get');
        ...
        Route::post('/store_package', [
            PackageController::class,
            'store_package',
        ])->name('package.store');

        Route::get('/edit_package', [
            PackageController::class,
            'edit_package',
        ])->name('package.edit');

        Route::post('/update_package', [
            PackageController::class,
            'update_package',
        ])->name('package.update');

        Route::delete('/list_package_delete', [
            PackageController::class,
            'delete_list_package',
        ])->name('package.delete');
    });
    ...
    Route::get('/get_list_exam', [
        ExamController::class,
        'get_list_exam',
    ])->name('exam.get');

    Route::get('/add_exam', [ExamController::class, 'add_exam'])->name(
        'exam.add'
    );

    Route::post('/store_exam', [ExamController::class, 'store_exam'])->name(
        'exam.store'
    );

    Route::get('/edit_exam', [ExamController::class, 'edit_exam'])->name(
        'exam.edit'
    );

    Route::post('/update_exam', [
        ExamController::class,
        'update_exam',
    ])->name('exam.update');

    Route::delete('/list_exam_delete', [
        ExamController::class,
        'delete_list_exam',
    ])->name('exam.delete');
    ...
    Route::group(['middleware' => ['AdminAccess']], function () {
        ...
        Route::get('/actgmast_coa', [
            ChartAccountController::class,
            'view_chart_accounts',
        ])->name('coa.index');

        Route::get('/actgmast_coa_get', [
            ChartAccountController::class,
            'view_chart_accounts',
        ])->name('coa.get');

        Route::get('/create_coa', [
            ChartAccountController::class,
            'create_coa',
        ])->name('coa.create');

        Route::post('/store_coa', [
            ChartAccountController::class,
            'store_coa',
        ])->name('coa.store');
        ...
        Route::delete('/chart_account_delete', [
            ChartAccountController::class,
        ...
        Route::get('/add_employees', [
            AdminController::class,
            'add_employees',
        ])->name('employee.add');

        Route::post('/store_employees', [
            AdminController::class,
            'store_employees',
        ])->name('employee.store');

        Route::get('/edit_employees', [
            AdminController::class,
            'edit_employees',
        ])->name('employee.edit');

        Route::post('/update_employees', [
            AdminController::class,
            'update_employees',
        ])->name('employee.update');

        Route::delete('/employee_delete', [
            AdminController::class,
            'delete_employee',
        ])->name('employee.delete');

        Route::get('/list_section', [
            SectionController::class,
            'view_list_section',
        ])->name('section.index');

        Route::get('/get_list_section', [
            SectionController::class,
            'get_list_section',
        ])->name('section.get');

        Route::get('/add_section', [
            SectionController::class,
            'add_section',
        ])->name('section.add');

        Route::post('/store_section', [
            SectionController::class,
            'store_section',
        ])->name('section.store');

        Route::get('edit_section', [
            SectionController::class,
            'edit_section',
        ])->name('section.edit');

        Route::post('update_section', [
            SectionController::class,
            'update_section',
        ])->name('section.update');

        Route::delete('/list_section_delete', [
            SectionController::class,
            'delete_list_section',
        ])->name('section.delete');

        Route::get('/list_department', [
            AdminController::class,
            'view_departments',
        ])->name('department.index');

        Route::get('/department_tables', [
            AdminController::class,
            'department_tables',
        ])->name('department_tables');

        Route::get('/add_department', [
            AdminController::class,
            'add_department',
        ])->name('department.add');

        Route::post('/store_department', [
            AdminController::class,
            'store_department',
        ])->name('department.add');

        Route::get('/edit_department', [
            AdminController::class,
            'edit_department',
        ])->name('department.edit');

        Route::post('/update_department', [
            AdminController::class,
            'update_department',
        ])->name('department.update');

        Route::delete('/delete_department', [
            AdminController::class,
            'delete_department',
    ...
    Route::get('/add_request', [
            RequestController::class,
            'add_request',
        ])->name('request.add');

        Route::post('/store_request', [
            RequestController::class,
            'store_request',
        ])->name('request.store');

        Route::get('/edit_request', [
            RequestController::class,
            'edit_request',
        ])->name('request.edit');

        Route::post('/update_request', [
            RequestController::class,
            'update_request',
        ])->name('request.update');

        Route::delete('/delete_request', [
            RequestController::class,
            'delete_request',
        ])->name('request.delete');
    ...
    Route::get('/skuld_print', [PrintPanelController::class, 'skuld_print']);
        ...
        Route::get('/west_england_print', [
            PrintPanelController::class,
            'west_england_print',
        ]);

        Route::get('/north_england_print', [
            PrintPanelController::class,
            'north_england_print',
        ]);

        Route::get('/bermuda_print', [
            PrintPanelController::class,
            'bermuda_print',
        ]);
        Route::get('/cayman_print', [PrintPanelController::class, 'cayman_print']);
        Route::get('/croatian_print', [
            PrintPanelController::class,
            'croatian_print',
        ]);
        Route::get('/danish_print', [PrintPanelController::class, 'danish_print']);
        Route::get('/bahamas_print', [
            PrintPanelController::class,
            'bahamas_print',
        ]);
        Route::get('/liberian_print', [
            PrintPanelController::class,
            'liberian_print',
        ]);
    ...
    Route::get('/cashier_or_print', [PrintController::class, 'cashier_or_print'])
        ->name('cashier_or.print');
    ...
    Route::delete('/cashier_or_delete', [
        AdminController::class,
        'delete_cashier_or',
    ])
    ...
    Route::get('/add_audiometry', [
        AudiometryController::class,
        'add_audiometry',
    ]);

    Route::post('/store_audiometry', [
        AudiometryController::class,
        'store_audiometry',
    ]);

    Route::get('/edit_audiometry', [
        AudiometryController::class,
        'edit_audiometry',
    ]);

    Route::post('/update_audiometry', [
        AudiometryController::class,
        'update_audiometry',
    ]);

    Route::get('/exam_audiometry_print', [
        PrintController::class,
        'exam_audiometry',
    ]);

    Route::get('/exam_audio_graphright', [
        PrintController::class,
        'exam_audio_graphright',
    ]);

    Route::get('/exam_audio_graphleft', [
        PrintController::class,
        'exam_audio_graphleft',
    ]);
    ...
    Route::post('/update_crf', [
        CardioRiskFactorController::class,
        'update_crf',
    ]);
    ...
    Route::get('/exam_cardiovascular_print', [
        PrintController::class,
        'exam_cardiovascular',
    ]);

    Route::get('/edit_cardiovascular', [
        CardioVascularController::class,
        'edit_cardiovascular',
    ]);

    Route::post('/update_cardiovascular', [
        CardioVascularController::class,
        'update_cardiovascular',
    ]);

    Route::get('/add_cardiovascular', [
        CardioVascularController::class,
        'add_cardiovascular',
    ]);
    Route::post('/store_cardiovascular', [
        CardioVascularController::class,
        'store_cardiovascular',
    ]);
    // END OF CRUD CARDIOVASCULAR

    // START OF CRUD ECG
    Route::get('/exam_ecg_print', [
        PrintController::class,
        'exam_ecg',
    ]);
    ...
    Route::get('/exam_echodoppler_print', [
        PrintController::class,
        'exam_echodoppler',
    ]);

    Route::get('/edit_echodoppler', [
        EchoDopplerController::class,
        'edit_echodoppler',
    ]);

    Route::post('/update_echodoppler', [
        EchoDopplerController::class,
        'update_echodoppler',
    ]);

    Route::get('/add_echodoppler', [
        EchoDopplerController::class,
        'add_echodoppler',
    ]);

    Route::post('/store_echodoppler', [
        EchoDopplerController::class,
        'store_echodoppler',
    ]);
    ...
    Route::get('/exam_echoplain_print', [
        PrintController::class,
        'exam_echoplain',
    ]);

    Route::get('/edit_echoplain', [
        EchoPlainController::class,
        'edit_echoplain',
    ]);

    Route::post('/update_echoplain', [
        EchoPlainController::class,
        'update_echoplain',
    ]);

    Route::get('/add_echoplain', [
        EchoPlainController::class,
        'add_echoplain',
    ]);

    Route::post('/store_echoplain', [
        EchoPlainController::class,
        'store_echoplain',
    ]);
    ...
    Route::get('/exam_ishihara_print', [
        PrintController::class,
        'exam_ishihara',
    ])->middleware(Ophthalmology::class);

    Route::get('/edit_ishihara', [
        IshiharaController::class,
        'edit_ishihara'
    ])->middleware(Ophthalmology::class);

    Route::post('/update_ishihara', [
        IshiharaController::class,
        'update_ishihara',
    ])->middleware(Ophthalmology::class);

    Route::get('/add_ishihara', [
        IshiharaController::class,
        'add_ishihara',
    ])->middleware(Ophthalmology::class);

    Route::post('/store_ishihara', [
        IshiharaController::class,
        'store_ishihara',
    ])->middleware(Ophthalmology::class);
    ...
    Route::get('/exam_physical_print', [
        PrintController::class,
        'exam_physical',
    ])->middleware(Physicians::class);

    Route::get('/edit_physical', [
        PhysicalController::class,
        'edit_physical',
    ])->middleware(Physicians::class);

    Route::post('/update_physical', [
        PhysicalController::class,
        'update_physical',
    ])->middleware(Physicians::class);

    Route::get('/add_physical', [
        PhysicalController::class,
        'add_physical',
    ])->middleware(Physicians::class);

    Route::post('/store_physical', [
        PhysicalController::class,
        'store_physical',
    ])->middleware(Physicians::class);
    ...
    Route::get('/exam_psycho_print', [
        PrintController::class,
        'exam_psycho',
    ])->middleware(Psychology::class);

    Route::get('/edit_psycho', [
        PsychologicalController::class,
        'edit_psycho',
    ])->middleware(Psychology::class);

    Route::post('/update_psycho', [
        PsychologicalController::class,
        'update_psycho',
    ])->middleware(Psychology::class);

    Route::get('/add_psycho', [
        PsychologicalController::class,
        'add_psycho',
    ])->middleware(Psychology::class);

    Route::post('/store_psycho', [
        PsychologicalController::class,
        'store_psycho',
    ])->middleware(Psychology::class);
    ...
    Route::get('/exam_psychobpi_print', [
        PrintController::class,
        'exam_psychobpi',
    ])->middleware(Psychology::class);

    Route::get('/edit_psychobpi', [
        PsychoBPIController::class,
        'edit_psychobpi',
    ])->middleware(Psychology::class);

    Route::post('/update_psychobpi', [
        PsychoBPIController::class,
        'update_psychobpi',
    ])->middleware(Psychology::class);

    Route::get('/add_psychobpi', [
        PsychoBPIController::class,
        'add_psychobpi',
    ])->middleware(Psychology::class);

    Route::post('/store_psychobpi', [
        PsychoBPIController::class,
        'store_psychobpi',
    ])->middleware(Psychology::class);
    ...
    Route::get('/exam_stress_echo_print', [
        PrintController::class,
        'exam_stress_echo',
    ]);

    Route::get('/edit_stressecho', [
        StressEchoController::class,
        'edit_stressecho',
    ]);

    Route::post('/update_stressecho', [
        StressEchoController::class,
        'update_stressecho',
    ]);

    Route::get('/add_stressecho', [
        StressEchoController::class,
        'add_stressecho',
    ]);

    Route::post('/store_stressecho', [
        StressEchoController::class,
        'store_stressecho',
    ]);
    ...
    Route::get('/exam_stresstest_print', [
        PrintController::class,
        'exam_stresstest',
    ]);

    Route::get('/edit_stresstest', [
        StressTestController::class,
        'edit_stresstest',
    ]);

    Route::post('/update_stresstest', [
        StressTestController::class,
        'update_stresstest',
    ]);
    Route::get('/add_stresstest', [
        StressTestController::class,
        'add_stresstest',
    ]);

    Route::post('/store_stresstest', [
        StressTestController::class,
        'store_stresstest',
    ]);
    ...
    Route::get('/exam_ultrasound_print', [
        PrintController::class,
        'exam_ultrasound',
    ])->middleware(Radiology::class);

    Route::get('/add_ultrasound', [
        UltrasoundController::class,
        'add_ultrasound',
    ])->middleware(Radiology::class);

    Route::post('/store_ultrasound', [
        UltrasoundController::class,
        'store_ultrasound',
    ])->middleware(Radiology::class);

    Route::get('/edit_ultrasound', [
        UltrasoundController::class,
        'edit_ultrasound',
    ])->middleware(Radiology::class);

    Route::post('/update_ultrasound', [
        UltrasoundController::class,
        'update_ultrasound',
    ])->middleware(Radiology::class);
    ...
    Route::get('/exam_visacuity_print', [
        PrintController::class,
        'exam_visacuity',
    ])->middleware(Ophthalmology::class);

    Route::get('/edit_visacuity', [
        VisacuityController::class,
        'edit_visacuity',
    ])->middleware(Ophthalmology::class);

    Route::post('/update_visacuity', [
        VisacuityController::class,
        'update_visacuity',
    ])->middleware(Ophthalmology::class);
    ...
    // START OF CRUD XRAY
    Route::get('/exam_xray_print', [
        PrintController::class,
        'exam_xray',
    ])->middleware(Radiology::class);

    Route::get('/edit_xray', [XRayController::class, 'edit_xray'])->middleware(
        Radiology::class
    );
    Route::post('/update_xray', [
        XRayController::class,
        'update_xray',
    ])->middleware(Radiology::class);

    Route::get('/add_xray', [XRayController::class, 'add_xray'])->middleware(
        Radiology::class
    );
    Route::post('/store_xray', [
        XRayController::class,
        'store_xray',
    ])->middleware(Radiology::class);
    // END OF CRUD XRAY
    ...
    Route::get('/exam_dental_print', [
        PrintController::class,
        'exam_dental',
    ])->middleware(Dental::class);

    Route::get('/edit_dental', [
        DentalController::class,
        'edit_dental',
    ])->middleware(Dental::class);

    Route::post('/update_dental', [
        DentalController::class,
        'update_dental',
    ])->middleware(Dental::class);

    Route::get('/add_dental', [
        DentalController::class,
        'add_dental',
    ])->middleware(Dental::class);

    Route::post('/store_dental', [
        DentalController::class,
        'store_dental',
    ])->middleware(Dental::class);

    Route::post('/upload_dental', [
        DentalController::class,
        'upload_dental',
    ])->middleware(Dental::class);
    // END OF CRUD DENTAL
    ...
    Route::get('/examlab_bloodsero_print', [
        PrintController::class,
        'exam_bloodsero',
    ])->middleware(
        Laboratory::class
    ...
    Route::get('/add_bloodsero', [
        BloodSerologyController::class,
        'add_bloodsero',
    ])->middleware(
        Laboratory::class
    );

    Route::post('/store_bloodsero', [
        BloodSerologyController::class,
        'store_bloodsero',
    ])->middleware(
        Laboratory::class
    ...
    // START OF CRUD DRUG
    Route::get('/examlab_drug_print', [
        PrintController::class,
        'exam_drug',
    ])->middleware(Laboratory::class);
    Route::get('/edit_drug', [DrugController::class, 'edit_drug'])->middleware(
        Laboratory::class
    );
    Route::post('/update_drug', [
        DrugController::class,
        'update_drug',
    ])->middleware(Laboratory::class);
    Route::get('/add_drug', [DrugController::class, 'add_drug'])->middleware(
        Laboratory::class
    );
    Route::post('/store_drug', [
        DrugController::class,
        'store_drug',
    ])->middleware(Laboratory::class);
    // END OF CRUD DRUG
    ...
    Route::get('/examlab_fecalysis_print', [
        PrintController::class,
        'exam_fecalysis',
    ])->middleware(Laboratory::class);
    Route::get('/edit_fecalysis', [
        FecalysisController::class,
        'edit_fecalysis',
    ])->middleware(Laboratory::class);

    Route::post('/update_fecalysis', [
        FecalysisController::class,
        'update_fecalysis',
    ])->middleware(Laboratory::class);
    ...
    Route::get('/examlab_hematology_print', [
        PrintController::class,
        'exam_hematology',
    ])->middleware(Laboratory::class);

    Route::get('/edit_hematology', [
        HematologyController::class,
        'edit_hematology',
    ])->middleware(Laboratory::class);

    Route::post('/update_hematology', [
        HematologyController::class,
        'update_hematology',
    ])->middleware(Laboratory::class);

    Route::get('/add_hematology', [
        HematologyController::class,
        'add_hematology',
    ])->middleware(Laboratory::class);

    Route::post('/store_hematology', [
        HematologyController::class,
        'store_hematology',
    ])->middleware(Laboratory::class);
    ...
    Route::get('/examlab_hepatitis_print', [
        PrintController::class,
        'exam_hepatitis',
    ]);

    Route::get('/edit_hepatitis', [
        HepatitisController::class,
        'edit_hepatitis',
    ]);

    Route::post('/update_hepatitis', [
        HepatitisController::class,
        'update_hepatitis',
    ]);
    ...
    Route::get('/examlab_pregnancy_print', [
        PrintController::class,
        'exam_pregnancy',
    ]);
    Route::get('/edit_pregnancy', [
        PregnancyController::class,
        'edit_pregnancy',
    ]);
    Route::post('/update_pregnancy', [
        PregnancyController::class,
        'update_pregnancy',
    ]);
    Route::get('/add_pregnancy', [PregnancyController::class, 'add_pregnancy']);

    Route::post('/store_pregnancy', [
        PregnancyController::class,
        'store_pregnancy',
    ]);
    ...
    Route::get('/examlab_urinalysis_print', [
        PrintController::class,
        'exam_urinalysis',
    ])->middleware(Laboratory::class);

    Route::get('/edit_urinalysis', [
        UrinalysisController::class,
        'edit_urinalysis',
    ])->middleware(Laboratory::class);

    Route::post('/update_urinalysis', [
        UrinalysisController::class,
        'update_urinalysis',
    ])->middleware(Laboratory::class);

    Route::get('/add_urinalysis', [
        UrinalysisController::class,
        'add_urinalysis',
    ])->middleware(Laboratory::class);

    Route::post('/store_urinalysis', [
        UrinalysisController::class,
        'store_urinalysis',
    ])->middleware(Laboratory::class);
