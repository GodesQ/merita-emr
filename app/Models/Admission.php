...
class Admission extends Model
{
    ...
    {
        return $this->hasOne(Patient::class, 'admission_id')->latest('id');
    }
    ...
    {
        return $this->hasMany(ReassessmentFindings::class, 'admission_id', 'id');
    }
        ...
        if ($exams) {
            ...
            if ($this && ! $status) {
                if ($this->lab_status == 2) {
                    ...
                    $status = '<div class="badge mx-1 fs-12 bg-primary bg-darken-3">NEED REASSESSMENT</div>';
                } else if ($this->lab_status == 3) {
                    $status = '<div class="badge mx-1 fs-12 bg-primary bg-darken-5">UNFIT TO WORK</div>';
                } else if ($this->lab_status == 4) {
                    $status = '<div class="badge mx-1 fs-12 bg-info bg-darken-2">UNFIT TEMPORARILY</div>';
                }
            }
