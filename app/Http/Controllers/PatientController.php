...
class PatientController extends Controller
{
    ...
    public function check(Request $request)
    {
        ...
        $patientInfo = Patient::where('email', '=', $request->username)
            ->latest('id')
            ->first();
            ...
            if (Hash::check($request->password, $patientInfo->password)) {
                if ($patientInfo->isVerify) {
                    ...
                    $request->session()->put([
                        ...
                        'admissionId' => $patientInfo->admission_id,
                        'patient_image' => $patientInfo->patient_image,
                        'created_date' => $patientInfo->created_date,
