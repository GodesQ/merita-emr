...
class PatientController extends Controller
{
    ...
    {
        try {
            // $srb_expdate = $request->srb_expdate ? Carbon::parse($request->srb_expdate)->format('Y-m-d') : date('Y-m-d');
            // $passport_expdate = $request->passport_expdate ? Carbon::parse($request->passport_expdate)->format('Y-m-d') : date('Y-m-d');
            // $birthdate = $request->passport_expdate ? Carbon::parse($request->birthdate)->format('Y-m-d') : date('Y-m-d');
